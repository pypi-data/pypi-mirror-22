...
def initialize_connection(identifier, config_handler):  # pragma: no cover
    u"""
...
def initialize_logging(quiet, verbose, debug,
                       config_handler, connection_name):
    u"""
    ...
    logfile = os.path.join(config_handler.logfile_directory, connection_name + u".log")
...
def parse_args():  # pragma: no cover
    ...
    parser.add_argument(u"-q", u"--quiet", action=u"store_true", help=u"Disables all text output")
