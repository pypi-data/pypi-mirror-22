...
class brocade_pim_operational(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__pim_global_state','__pim_anycast_state','__pim_ecmp_state','__pim_mcache_state',)
  ...
  _pyangbind_elements = {'pim_global_state': pim_global_state, 'pim_anycast_state': pim_anycast_state, 'pim_ecmp_state': pim_ecmp_state, 'pim_mcache_state': pim_mcache_state, }
