...
class grpc_channel(object):
    ...
    def __init__(self,
        ...
        root_certs = str(requests.get('https://api.1qb.it/ca.pem').text)
...
class client(grpc_channel):
    ...
    def ms_compare(self, smiles, solver_type, should_visualize):
        return self.msStub.Compare(
            qbit_pb2.CompareRequest(
                smiles=smiles,
    ...
    def hobo2qubo(self, binary_polynomials):
        """
...
class quadprog(grpc_channel):
    ...
    def __init__(self,
        ...
        super(quadprog, self).__init__(license, client_id, client_secret, url)
