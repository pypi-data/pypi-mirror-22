...
_LISTOPERATIONSREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='qbit.services.ListOperationsRequest.name', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='filter', full_name='qbit.services.ListOperationsRequest.filter', index=1,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='page_size', full_name='qbit.services.ListOperationsRequest.page_size', index=2,
      number=2, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='page_token', full_name='qbit.services.ListOperationsRequest.page_token', index=3,
...
try:
  ...
  class BetaQuboStub(object):
    ...
    file not marked beta) for all further purposes. This class was generated
    only to ease transition from grpcio<0.15.0 to grpcio>=0.15.0."""
    def SQA(self, request_iterator, timeout, metadata=None, with_call=False, protocol_options=None):
  ...
  def beta_create_Qubo_server(servicer, pool=None, pool_size=None, default_timeout=None, maximum_timeout=None):
    ...
    request_deserializers = {
      ('qbit.services.Qubo', 'SQA'): QuadraticRequest.FromString,
    ...
    method_implementations = {
      ('qbit.services.Qubo', 'SQA'): face_utilities.stream_unary_inline(servicer.SQA),
  ...
  def beta_create_Qubo_stub(channel, host=None, metadata_transformer=None, pool=None, pool_size=None):
    ...
    generated only to ease transition from grpcio<0.15.0 to grpcio>=0.15.0"""
    request_serializers = {
      ('qbit.services.Qubo', 'SQA'): QuadraticRequest.SerializeToString,
    ...
    cardinalities = {
      'SQA': cardinality.Cardinality.STREAM_UNARY,
