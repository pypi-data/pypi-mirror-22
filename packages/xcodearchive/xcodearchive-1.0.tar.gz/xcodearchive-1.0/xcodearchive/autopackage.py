...
class AutoArhive (object):
    ...
    def config_base(self):
        ...
        # archivePath
        archivePath = os.path.join (basePath, 'xcodearchive')
        ...
        xcodebuild_archive = 'xcodebuild xcodearchive ' + archivePathOption + baseCommand

        print ('xcodearchive %s' % (xcodebuild_archive))
...
title = 'please choose xcodearchive method:'
