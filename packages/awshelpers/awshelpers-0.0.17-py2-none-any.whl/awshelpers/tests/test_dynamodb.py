...
def test():
    ...
    :rtype: None
    """
    primary_key = {'Hour': '0000-0007', 'Date': datetime.datetime.utcnow().isoformat(';').split(';')[0]}
    dynamodb_result = dd_item.upsert('awshelpers_composite_key_test', primary_key, 'Test', data)
