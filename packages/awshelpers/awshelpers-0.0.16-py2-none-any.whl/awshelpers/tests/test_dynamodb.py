...
def test():
    ...
    :rtype: None
    """
    primary_key = {'Item': '0000-0005', 'ItemDate': datetime.datetime.utcnow().isoformat(';').split(';')[0]}
    dynamodb_result = dd_item.upsert('awshelpers_composite_key_test', primary_key, 'Wow', data)
