...
def Client(username=None, password=None, url=None, port=80, version='xclarity_1.2.2'):
    ...
    return c(version=version, username=username, password=password, url=url, port=port)
