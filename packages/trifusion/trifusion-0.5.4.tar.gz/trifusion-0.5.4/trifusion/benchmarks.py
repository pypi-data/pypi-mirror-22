...
# Filter data
flist = [["Postia_placenta"], ["Postia_placenta"], ["Postia_placenta"],
         ["Postia_placenta"], ["535_12"], ["Ang_30"], ["Ang_30"], ["Ang_30"]]
...
def filter_contain_taxa(aln, tx_lsit):
    aln.filter_by_taxa("Contain", tx_lsit)
