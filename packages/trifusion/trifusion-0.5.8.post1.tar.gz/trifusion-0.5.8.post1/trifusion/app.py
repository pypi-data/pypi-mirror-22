...
try:
    ...
    from appdata.process import ProcessApp
    from appdata.statistics import StatisticsApp
    from appdata.orthology import OrthologyApp
    from appdata.general import SidepanelApp, GeneralApp, FilechoosersApp
    ...
    from trifusion.appdata.process import ProcessApp
    from trifusion.appdata.statistics import StatisticsApp
    from trifusion.appdata.orthology import OrthologyApp
    from trifusion.appdata.general import SidepanelApp, GeneralApp, \
        FilechoosersApp
...
class TriFusionApp(App, OrthologyApp, ProcessApp, StatisticsApp,
                   GeneralApp, SidepanelApp, FilechoosersApp):
