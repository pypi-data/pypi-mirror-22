opensource_cat = {
  "fake": "Fake News - Sources that entirely fabricate information, disseminate deceptive content, or grossly distort actual news reports",
  ...
  "rumor": "Rumor Mill - Sources that traffic in rumors, gossip, innuendo, and unverified claims.",
  ...
  "hate": "Hate News - Sources that actively promote racism, misogyny, homophobia, and other forms of discrimination.",
...
manually_added_cat = {
  "fake news": "Fake News - Sources that entirely fabricate information, disseminate deceptive content, or grossly distort actual news reports",
  "satire": "Satire - Sources that use humor, irony, exaggeration, ridicule, and false information to comment on current events.",
  "bias": "Extreme Bias - Sources that come from a particular point of view and may rely on propaganda, decontextualized information, and opinions distorted as facts.",
  "conspiracy": "Conspiracy Theory - Sources that are well-known promoters of kooky conspiracy theories.",
  "rumor": "Rumor Mill - Sources that traffic in rumors, gossip, innuendo, and unverified claims.",
