    ...
    def eventFilter(self, obj_focused, event):
        if event.type() == QEvent.KeyPress:
            ...
            if event.key() == Qt.Key_F12:
                # TODO figure out correct indexes
                self.w_moldb.combobox_select_molecule.setCurrentIndex(301234)
                self.w_moldb.combobox_select_pfantmol.setCurrentIndex(301234)
                self.w_moldb.combobox_select_state.setCurrentIndex(301234)
                self.w_moldb.combobox_select_system.setCurrentIndex(301234)
    ...
    def convert_clicked(self):
        ...
        try:
            ...
            if self.w_moldb.id_molecule is None:
                ...
                errors.append("There are empty molecular constants")
            ...
            if len(errors) == 0:
                ...
                f, log = cm.make_file_molecules(mol_consts, lines, cm.calc_qgbd_tio_like,
                                                sols_calculator)
                ne = len(log.errors)
                if ne > 0:
