...
#
#  UPDATE: I have decided it is safer anbd "better" to just put the raw bytes and specifically decode it with the utf-16 codec
#   instead of relying on the syntax parser to handle it properly
...
class TestIRUnicodeField(object):
    ...
    def setup_class(self):
        ...
        self.utf16Data = b'\xff\xfe\x01\xd8\x0f\xdc\x01\xd8-\xdc\x01\xd8;\xdc\x01\xd8+\xdc'.decode('utf-16')
        self.utf16Data2 = b'\xff\xfe\x01\xd8\x88\xdc\x01\xd8\x9d\xdc\x01\xd8\x91\xdc\x01\xd8\x9b\xdc\x01\xd8\x90\xdc\x01\xd8\x98\xdc\x01\xd8\x95\xdc\x01\xd8\x96\xdc'.decode('utf-16')
    ...
    def test_utf16(self):
        ...
        otherObj.name = 'two'
        otherObj.value = self.utf16Data2
