...
*separator character*.  This character is the vertical bar (``|``) by default,
but that may be problematic on some file or operating systems (e.g. Windows).
You can change this character.  There are some restrictions:
