"""
Copied from plotly.utils to speed up the startup of the app.
A few lines were removed from the script to speed up
the import process by a fator of 10.
Slimmed down and removed some superflous importing.
"""

import json
from numpy.ma.core import masked as npMasked
from pandas import NaT as pdNaT
from pytz import utc as tzUCT
