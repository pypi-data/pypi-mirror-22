...
from crate_anon.preprocess.rio_constants import ONSPD_TABLE_POSTCODE
...
VIEW_PT_DETAIL_W_GEOG_NHSNUM = "PatientDetailsCRATE"
...
ddgen_table_blacklist = #
    ...
    PatientDetails  # replaced by {VIEW_PT_DETAIL_W_GEOG_NHSNUM}
...
ddgen_table_require_field_conditional = #
    ...
    {PCMIS_COL_PATIENT_ID_COL}, {CRATE_COL_PCMIS_NUMBER}

ddgen_field_blacklist = #
    {PCMIS_COL_PATIENT_ID_COL}  # replaced by {CRATE_COL_PCMIS_NUMBER} (which is then pseudonymised)
...
ddgen_pid_defining_fieldnames = {VIEW_PT_DETAIL_W_GEOG_NHSNUM}.{CRATE_COL_PCMIS_NUMBER}
...
ddgen_scrubsrc_patient_fields = # several of these:
    ...
    # Views
    # ----------------------------------------------------------------------
    {VIEW_PT_DETAIL_W_GEOG_NHSNUM}.PatientID
    {VIEW_PT_DETAIL_W_GEOG_NHSNUM}.FirstName
    {VIEW_PT_DETAIL_W_GEOG_NHSNUM}.MiddleName
    {VIEW_PT_DETAIL_W_GEOG_NHSNUM}.LastName
    {VIEW_PT_DETAIL_W_GEOG_NHSNUM}.DOB
    {VIEW_PT_DETAIL_W_GEOG_NHSNUM}.Address*  # Address1, Address2, Address3
    {VIEW_PT_DETAIL_W_GEOG_NHSNUM}.TownCity
    {VIEW_PT_DETAIL_W_GEOG_NHSNUM}.County
    {VIEW_PT_DETAIL_W_GEOG_NHSNUM}.PostCode
    {VIEW_PT_DETAIL_W_GEOG_NHSNUM}.Tel*  # TelHome, TelMobile, TelWork
    {VIEW_PT_DETAIL_W_GEOG_NHSNUM}.NHSNumber
    {VIEW_PT_DETAIL_W_GEOG_NHSNUM}.FamilyName
    {VIEW_PT_DETAIL_W_GEOG_NHSNUM}.PreviousName
    {VIEW_PT_DETAIL_W_GEOG_NHSNUM}.PreviousAddress*
    {VIEW_PT_DETAIL_W_GEOG_NHSNUM}.PreviousTownCity
    {VIEW_PT_DETAIL_W_GEOG_NHSNUM}.PreviousCounty
    {VIEW_PT_DETAIL_W_GEOG_NHSNUM}.PreviousPostCode
    {VIEW_PT_DETAIL_W_GEOG_NHSNUM}.Email
    {VIEW_PT_DETAIL_W_GEOG_NHSNUM}.DependantChildren  # is VARCHAR(100)
    {VIEW_PT_DETAIL_W_GEOG_NHSNUM}.LastNameAlias
    {VIEW_PT_DETAIL_W_GEOG_NHSNUM}.FirstNameAlias
    {VIEW_PT_DETAIL_W_GEOG_NHSNUM}.DisplayName
...
def add_pt_detail_geography_nhsnum_view(engine: Engine,
                                        progargs: Any,
    ...
    orig_column_names = get_column_names(
        engine, tablename=PCMIS_TABLE_MASTER_PATIENT, sort=True)

    # Remove any original column names being overridden by new ones.
    # (Could also do this the other way around!)
    newcols_lowercase = [x.lower() for x in progargs.geogcols]
    newcols_lowercase.append(CRATE_COL_NHS_NUMBER)
    ...
    """.format(
        ...
        rio_postcodecol=PCMIS_COL_POSTCODE,
    )
