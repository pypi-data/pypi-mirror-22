    ...
    def create_extension_unaccent(self, database_name):
        ...
        try:
            ...
            if 'extension "unaccent" already exists' in error_msg:
                ...
                return
            elif "permission denied to create extension" in error_msg:
                logger.error('Unable to create the extension, postgres user in the'
                             ' deployv.conf file is not superuser')
                return
            raise
