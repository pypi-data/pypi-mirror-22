...
from libracmp.TypeStrictComparator import TypeStrictComparator


class TestDiffTypeStrictComparator(TestCase):
    # test_diff
    # ---------------------------------------------------------
    def test_diff_none_eq(self):
        a, b = None, None
        comp = TypeStrictComparator(a, b)
    ...
    def test_diff_true_int1_neq(self):
        a, b = True, 1
        comp = TypeStrictComparator(a, b)
        self.assertEquals(comp.diff, (a, b))
    ...
    def test_diff_true_float1_neq(self):
        a, b = True, 1.0
        comp = TypeStrictComparator(a, b)
        self.assertEquals(comp.diff, (a, b))
    ...
    def test_diff_false_int0_neq(self):
        a, b = False, 0
        comp = TypeStrictComparator(a, b)
        self.assertEquals(comp.diff, (a, b))
    ...
    def test_diff_false_float0_neq(self):
        a, b = False, 0.0
        comp = TypeStrictComparator(a, b)
        self.assertEquals(comp.diff, (a, b))
    ...
    def test_diff_int0_float0_neq(self):
        a, b = 0, 0.0
        comp = TypeStrictComparator(a, b)
        self.assertEquals(comp.diff, (a, b))
    ...
    def test_diff_int1_float1_neq(self):
        a, b = 1, 1.0
        comp = TypeStrictComparator(a, b)
        self.assertEquals(comp.diff, (a, b))

    def test_diff_intn1_floatn1_neq(self):
        a, b = -1, -1.0
        comp = TypeStrictComparator(a, b)
        self.assertEquals(comp.diff, (a, b))
    ...
    def test_diff_int0_false_neq(self):
        a, b = 0, False
        comp = TypeStrictComparator(a, b)
        self.assertEquals(comp.diff, (a, b))

    def test_diff_int1_true_neq(self):
        a, b = 1, True
        comp = TypeStrictComparator(a, b)
        self.assertEquals(comp.diff, (a, b))
    ...
    def test_diff_float0_int0_neq(self):
        a, b = 0.0, 0
        comp = TypeStrictComparator(a, b)
        self.assertEquals(comp.diff, (a, b))

    def test_diff_float1_int1_neq(self):
        a, b = 1.0, 1
        comp = TypeStrictComparator(a, b)
        self.assertEquals(comp.diff, (a, b))

    def test_diff_floatn1_intn1_neq(self):
        a, b = -1.0, -1
        comp = TypeStrictComparator(a, b)
        self.assertEquals(comp.diff, (a, b))
    ...
    def test_diff_float1_true_neq(self):
        a, b = 1.0, True
        comp = TypeStrictComparator(a, b)
        self.assertEquals(comp.diff, (a, b))
    ...
    def test_diff_float0_false_neq(self):
        a, b = 0.0, False
        comp = TypeStrictComparator(a, b)
        self.assertEquals(comp.diff, (a, b))
    ...
    def test_diff_strEmpty_uniEmpty_neq(self):
        a, b = '', u''
        comp = TypeStrictComparator(a, b)
        self.assertEquals(comp.diff, (a, b))
    ...
    def test_diff_stra_unia_neq(self):
        a, b = 'a', u'a'
        comp = TypeStrictComparator(a, b)
        self.assertEquals(comp.diff, (a, b))
    ...
    def test_diff_uniEmpty_strEmpty_neq(self):
        a, b = u'', ''
        comp = TypeStrictComparator(a, b)
        self.assertEquals(comp.diff, (a, b))
    ...
    def test_diff_unia_stra_neq(self):
        a, b = u'a', 'a'
        comp = TypeStrictComparator(a, b)
        self.assertEquals(comp.diff, (a, b))
