...
class TestResultTypeStrictComparator(TestCase):
    # test result
    # ---------------------------------------------------------
    # None
    ...
    def test_result_strEmpty_uniEmpty_neq(self):
        a, b = '', u''
        comp = TypeStrictComparator(a, b)
        self.assertFalse(comp.result)
    ...
    def test_result_stra_unia_neq(self):
        a, b = 'a', u'a'
        comp = TypeStrictComparator(a, b)
        self.assertFalse(comp.result)
    ...
    def test_result_uniEmpty_strEmpty_neq(self):
        a, b = u'', ''
        comp = TypeStrictComparator(a, b)
        self.assertFalse(comp.result)
    ...
    def test_result_unia_stra_neq(self):
        a, b = u'a', 'a'
        comp = TypeStrictComparator(a, b)
        self.assertFalse(comp.result)
