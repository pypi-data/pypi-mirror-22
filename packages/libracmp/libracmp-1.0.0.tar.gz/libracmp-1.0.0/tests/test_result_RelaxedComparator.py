...
class TestResultRelaxedComparator(TestCase):
    # test result
    # ---------------------------------------------------------
    # None
    ...
    def test_result_none_int0_eq(self):
        a, b = None, 0
        comp = RelaxedComparator(a, b)
        self.assertTrue(comp.result)

    def test_result_none_int1_eq(self):
        a, b = None, 1
        comp = RelaxedComparator(a, b)
        self.assertTrue(comp.result)

    def test_result_none_intn1_eq(self):
        a, b = None, -1
        comp = RelaxedComparator(a, b)
        self.assertTrue(comp.result)

    def test_result_none_float0_eq(self):
        a, b = None, 0.0
        comp = RelaxedComparator(a, b)
        self.assertTrue(comp.result)

    def test_result_none_float1_eq(self):
        a, b = None, 1.0
        comp = RelaxedComparator(a, b)
        self.assertTrue(comp.result)

    def test_result_none_floatn1_eq(self):
        a, b = None, -1.0
        comp = RelaxedComparator(a, b)
        self.assertTrue(comp.result)
    ...
    def test_result_none_str_empty_eq(self):
        a, b = None, ''
        comp = RelaxedComparator(a, b)
        self.assertTrue(comp.result)
    ...
    def test_result_none_uni_empty_eq(self):
        a, b = None, u''
        comp = RelaxedComparator(a, b)
        self.assertTrue(comp.result)

    def test_result_none_true_eq(self):
        a, b = None, True
        comp = RelaxedComparator(a, b)
        self.assertTrue(comp.result)

    def test_result_none_false_eq(self):
        a, b = None, False
        comp = RelaxedComparator(a, b)
        self.assertTrue(comp.result)
    ...
    def test_result_int0_none_eq(self):
        a, b = 0, None
        comp = RelaxedComparator(a, b)
        self.assertTrue(comp.result)

    def test_result_int1_none_eq(self):
        a, b = 1, None
        comp = RelaxedComparator(a, b)
        self.assertTrue(comp.result)
    ...
    def test_result_float0_none_eq(self):
        a, b = 0.0, None
        comp = RelaxedComparator(a, b)
        self.assertTrue(comp.result)

    def test_result_float1_none_eq(self):
        a, b = 1.0, None
        comp = RelaxedComparator(a, b)
        self.assertTrue(comp.result)

    def test_result_floatn1_none_eq(self):
        a, b = -1.0, None
        comp = RelaxedComparator(a, b)
        self.assertTrue(comp.result)
    ...
    def test_result_str_empty_none_eq(self):
        a, b = '', None
        comp = RelaxedComparator(a, b)
        self.assertTrue(comp.result)
