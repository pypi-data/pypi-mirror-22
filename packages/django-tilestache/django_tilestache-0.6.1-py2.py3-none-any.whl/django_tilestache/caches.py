...
class ExternalCacheConfig(BaseConfiguration):
...
class TestCacheConfig(BaseConfiguration):
...
class DiskCacheConfig(BaseConfiguration):
...
class MultiCacheConfig(BaseConfiguration):
...
class MemcacheCacheConfig(BaseConfiguration):
...
class RedisCacheConfig(BaseConfiguration):
...
class S3CacheConfig(BaseConfiguration):
...
class CacheManager(object):
    ...
    def seed(self,
             ...
             padding=0,
             tile_format='PBF'):
        self._execute_action(action='seed',
                             layer=layer,
                             geometry=geometry,
                             min_zoom=min_zoom,
                             max_zoom=max_zoom,
    ...
    def purge(self,
        ...
        geometry provided
        """
        self._execute_action(action='purge',
                             layer=layer,
                             geometry=geometry,
                             min_zoom=min_zoom,
                             max_zoom=max_zoom,
