...
static int _cffi_e_enum_foo(PyObject *lib)
{
  if ((POINT_CONVERSION_COMPRESSED) < 0 || (unsigned long)(POINT_CONVERSION_COMPRESSED) != 2UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 ...
                 "foo", "POINT_CONVERSION_COMPRESSED", buf, "2");
    return -1;
  }
  if ((POINT_CONVERSION_UNCOMPRESSED) < 0 || (unsigned long)(POINT_CONVERSION_UNCOMPRESSED) != 4UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "enum %s: %s has the real value %s, not %s",
                 "foo", "POINT_CONVERSION_UNCOMPRESSED", buf, "4");
    return -1;
  }
  if ((POINT_CONVERSION_HYBRID) < 0 || (unsigned long)(POINT_CONVERSION_HYBRID) != 6UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "enum %s: %s has the real value %s, not %s",
                 "foo", "POINT_CONVERSION_HYBRID", buf, "6");
    return -1;
  }
  return 0;
}
...
static int _cffi_const_EVP_CTRL_AEAD_SET_MAC_KEY(PyObject *lib)
{
  PyObject *o;
  int res;
  if (LONG_MIN <= (EVP_CTRL_AEAD_SET_MAC_KEY) && (EVP_CTRL_AEAD_SET_MAC_KEY) <= LONG_MAX)
    o = PyInt_FromLong((long)(EVP_CTRL_AEAD_SET_MAC_KEY));
  else if ((EVP_CTRL_AEAD_SET_MAC_KEY) <= 0)
    o = PyLong_FromLongLong((long long)(EVP_CTRL_AEAD_SET_MAC_KEY));
  else
    o = PyLong_FromUnsignedLongLong((unsigned long long)(EVP_CTRL_AEAD_SET_MAC_KEY));
  if (o == NULL)
    return -1;
...
static int _cffi_const_EVP_CTRL_AEAD_TLS1_AAD(PyObject *lib)
{
  PyObject *o;
  int res;
  if (LONG_MIN <= (EVP_CTRL_AEAD_TLS1_AAD) && (EVP_CTRL_AEAD_TLS1_AAD) <= LONG_MAX)
    o = PyInt_FromLong((long)(EVP_CTRL_AEAD_TLS1_AAD));
  else if ((EVP_CTRL_AEAD_TLS1_AAD) <= 0)
    o = PyLong_FromLongLong((long long)(EVP_CTRL_AEAD_TLS1_AAD));
  else
    o = PyLong_FromUnsignedLongLong((unsigned long long)(EVP_CTRL_AEAD_TLS1_AAD));
  if (o == NULL)
    return -1;
...
static int _cffi_const_EVP_CTRL_CCM_GET_TAG(PyObject *lib)
{
  PyObject *o;
  int res;
  if (LONG_MIN <= (EVP_CTRL_CCM_GET_TAG) && (EVP_CTRL_CCM_GET_TAG) <= LONG_MAX)
    o = PyInt_FromLong((long)(EVP_CTRL_CCM_GET_TAG));
  else if ((EVP_CTRL_CCM_GET_TAG) <= 0)
    o = PyLong_FromLongLong((long long)(EVP_CTRL_CCM_GET_TAG));
  else
    o = PyLong_FromUnsignedLongLong((unsigned long long)(EVP_CTRL_CCM_GET_TAG));
  if (o == NULL)
    return -1;
...
static int _cffi_const_EVP_CTRL_CCM_SET_IVLEN(PyObject *lib)
{
  PyObject *o;
  int res;
  if (LONG_MIN <= (EVP_CTRL_CCM_SET_IVLEN) && (EVP_CTRL_CCM_SET_IVLEN) <= LONG_MAX)
    o = PyInt_FromLong((long)(EVP_CTRL_CCM_SET_IVLEN));
  else if ((EVP_CTRL_CCM_SET_IVLEN) <= 0)
    o = PyLong_FromLongLong((long long)(EVP_CTRL_CCM_SET_IVLEN));
  else
    o = PyLong_FromUnsignedLongLong((unsigned long long)(EVP_CTRL_CCM_SET_IVLEN));
  if (o == NULL)
    return -1;
...
static int _cffi_const_EVP_CTRL_CCM_SET_L(PyObject *lib)
{
  PyObject *o;
  int res;
  if (LONG_MIN <= (EVP_CTRL_CCM_SET_L) && (EVP_CTRL_CCM_SET_L) <= LONG_MAX)
    o = PyInt_FromLong((long)(EVP_CTRL_CCM_SET_L));
  else if ((EVP_CTRL_CCM_SET_L) <= 0)
    o = PyLong_FromLongLong((long long)(EVP_CTRL_CCM_SET_L));
  else
    o = PyLong_FromUnsignedLongLong((unsigned long long)(EVP_CTRL_CCM_SET_L));
  if (o == NULL)
    return -1;
...
static int _cffi_const_EVP_CTRL_CCM_SET_MSGLEN(PyObject *lib)
{
  PyObject *o;
  int res;
  if (LONG_MIN <= (EVP_CTRL_CCM_SET_MSGLEN) && (EVP_CTRL_CCM_SET_MSGLEN) <= LONG_MAX)
    o = PyInt_FromLong((long)(EVP_CTRL_CCM_SET_MSGLEN));
  else if ((EVP_CTRL_CCM_SET_MSGLEN) <= 0)
    o = PyLong_FromLongLong((long long)(EVP_CTRL_CCM_SET_MSGLEN));
  else
    o = PyLong_FromUnsignedLongLong((unsigned long long)(EVP_CTRL_CCM_SET_MSGLEN));
  if (o == NULL)
    return -1;
...
static int _cffi_const_EVP_CTRL_CCM_SET_TAG(PyObject *lib)
{
  PyObject *o;
  int res;
  if (LONG_MIN <= (EVP_CTRL_CCM_SET_TAG) && (EVP_CTRL_CCM_SET_TAG) <= LONG_MAX)
    o = PyInt_FromLong((long)(EVP_CTRL_CCM_SET_TAG));
  else if ((EVP_CTRL_CCM_SET_TAG) <= 0)
    o = PyLong_FromLongLong((long long)(EVP_CTRL_CCM_SET_TAG));
  else
    o = PyLong_FromUnsignedLongLong((unsigned long long)(EVP_CTRL_CCM_SET_TAG));
  if (o == NULL)
    return -1;
...
static int _cffi_const_EVP_CTRL_COPY(PyObject *lib)
{
  PyObject *o;
  int res;
  if (LONG_MIN <= (EVP_CTRL_COPY) && (EVP_CTRL_COPY) <= LONG_MAX)
    o = PyInt_FromLong((long)(EVP_CTRL_COPY));
  else if ((EVP_CTRL_COPY) <= 0)
    o = PyLong_FromLongLong((long long)(EVP_CTRL_COPY));
  else
    o = PyLong_FromUnsignedLongLong((unsigned long long)(EVP_CTRL_COPY));
  if (o == NULL)
    return -1;
...
static int _cffi_const_EVP_CTRL_GCM_IV_GEN(PyObject *lib)
{
  PyObject *o;
  int res;
  if (LONG_MIN <= (EVP_CTRL_GCM_IV_GEN) && (EVP_CTRL_GCM_IV_GEN) <= LONG_MAX)
    o = PyInt_FromLong((long)(EVP_CTRL_GCM_IV_GEN));
  else if ((EVP_CTRL_GCM_IV_GEN) <= 0)
    o = PyLong_FromLongLong((long long)(EVP_CTRL_GCM_IV_GEN));
  else
    o = PyLong_FromUnsignedLongLong((unsigned long long)(EVP_CTRL_GCM_IV_GEN));
  if (o == NULL)
    return -1;
...
static int _cffi_const_EVP_CTRL_GCM_SET_IV_FIXED(PyObject *lib)
{
  PyObject *o;
  int res;
  if (LONG_MIN <= (EVP_CTRL_GCM_SET_IV_FIXED) && (EVP_CTRL_GCM_SET_IV_FIXED) <= LONG_MAX)
    o = PyInt_FromLong((long)(EVP_CTRL_GCM_SET_IV_FIXED));
  else if ((EVP_CTRL_GCM_SET_IV_FIXED) <= 0)
    o = PyLong_FromLongLong((long long)(EVP_CTRL_GCM_SET_IV_FIXED));
  else
    o = PyLong_FromUnsignedLongLong((unsigned long long)(EVP_CTRL_GCM_SET_IV_FIXED));
  if (o == NULL)
    return -1;
...
static int _cffi_const_EVP_CTRL_GCM_SET_IV_INV(PyObject *lib)
{
  PyObject *o;
  int res;
  if (LONG_MIN <= (EVP_CTRL_GCM_SET_IV_INV) && (EVP_CTRL_GCM_SET_IV_INV) <= LONG_MAX)
    o = PyInt_FromLong((long)(EVP_CTRL_GCM_SET_IV_INV));
  else if ((EVP_CTRL_GCM_SET_IV_INV) <= 0)
    o = PyLong_FromLongLong((long long)(EVP_CTRL_GCM_SET_IV_INV));
  else
    o = PyLong_FromUnsignedLongLong((unsigned long long)(EVP_CTRL_GCM_SET_IV_INV));
  if (o == NULL)
    return -1;
...
static int _cffi_const_EVP_CTRL_GET_RC2_KEY_BITS(PyObject *lib)
{
  PyObject *o;
  int res;
  if (LONG_MIN <= (EVP_CTRL_GET_RC2_KEY_BITS) && (EVP_CTRL_GET_RC2_KEY_BITS) <= LONG_MAX)
    o = PyInt_FromLong((long)(EVP_CTRL_GET_RC2_KEY_BITS));
  else if ((EVP_CTRL_GET_RC2_KEY_BITS) <= 0)
    o = PyLong_FromLongLong((long long)(EVP_CTRL_GET_RC2_KEY_BITS));
  else
    o = PyLong_FromUnsignedLongLong((unsigned long long)(EVP_CTRL_GET_RC2_KEY_BITS));
  if (o == NULL)
    return -1;
...
static int _cffi_const_EVP_CTRL_GET_RC5_ROUNDS(PyObject *lib)
{
  PyObject *o;
  int res;
  if (LONG_MIN <= (EVP_CTRL_GET_RC5_ROUNDS) && (EVP_CTRL_GET_RC5_ROUNDS) <= LONG_MAX)
    o = PyInt_FromLong((long)(EVP_CTRL_GET_RC5_ROUNDS));
  else if ((EVP_CTRL_GET_RC5_ROUNDS) <= 0)
    o = PyLong_FromLongLong((long long)(EVP_CTRL_GET_RC5_ROUNDS));
  else
    o = PyLong_FromUnsignedLongLong((unsigned long long)(EVP_CTRL_GET_RC5_ROUNDS));
  if (o == NULL)
    return -1;
...
static int _cffi_const_EVP_CTRL_INIT(PyObject *lib)
{
  PyObject *o;
  int res;
  if (LONG_MIN <= (EVP_CTRL_INIT) && (EVP_CTRL_INIT) <= LONG_MAX)
    o = PyInt_FromLong((long)(EVP_CTRL_INIT));
  else if ((EVP_CTRL_INIT) <= 0)
    o = PyLong_FromLongLong((long long)(EVP_CTRL_INIT));
  else
    o = PyLong_FromUnsignedLongLong((unsigned long long)(EVP_CTRL_INIT));
  if (o == NULL)
    return -1;
...
static int _cffi_const_EVP_CTRL_PBE_PRF_NID(PyObject *lib)
{
  PyObject *o;
  int res;
  if (LONG_MIN <= (EVP_CTRL_PBE_PRF_NID) && (EVP_CTRL_PBE_PRF_NID) <= LONG_MAX)
    o = PyInt_FromLong((long)(EVP_CTRL_PBE_PRF_NID));
  else if ((EVP_CTRL_PBE_PRF_NID) <= 0)
    o = PyLong_FromLongLong((long long)(EVP_CTRL_PBE_PRF_NID));
  else
    o = PyLong_FromUnsignedLongLong((unsigned long long)(EVP_CTRL_PBE_PRF_NID));
  if (o == NULL)
    return -1;
...
static int _cffi_const_EVP_CTRL_RAND_KEY(PyObject *lib)
{
  PyObject *o;
  int res;
  if (LONG_MIN <= (EVP_CTRL_RAND_KEY) && (EVP_CTRL_RAND_KEY) <= LONG_MAX)
    o = PyInt_FromLong((long)(EVP_CTRL_RAND_KEY));
  else if ((EVP_CTRL_RAND_KEY) <= 0)
    o = PyLong_FromLongLong((long long)(EVP_CTRL_RAND_KEY));
  else
    o = PyLong_FromUnsignedLongLong((unsigned long long)(EVP_CTRL_RAND_KEY));
  if (o == NULL)
    return -1;
...
static int _cffi_const_EVP_CTRL_SET_KEY_LENGTH(PyObject *lib)
{
  PyObject *o;
  int res;
  if (LONG_MIN <= (EVP_CTRL_SET_KEY_LENGTH) && (EVP_CTRL_SET_KEY_LENGTH) <= LONG_MAX)
    o = PyInt_FromLong((long)(EVP_CTRL_SET_KEY_LENGTH));
  else if ((EVP_CTRL_SET_KEY_LENGTH) <= 0)
    o = PyLong_FromLongLong((long long)(EVP_CTRL_SET_KEY_LENGTH));
  else
    o = PyLong_FromUnsignedLongLong((unsigned long long)(EVP_CTRL_SET_KEY_LENGTH));
  if (o == NULL)
    return -1;
...
static int _cffi_const_EVP_CTRL_SET_RC2_KEY_BITS(PyObject *lib)
{
  PyObject *o;
  int res;
  if (LONG_MIN <= (EVP_CTRL_SET_RC2_KEY_BITS) && (EVP_CTRL_SET_RC2_KEY_BITS) <= LONG_MAX)
    o = PyInt_FromLong((long)(EVP_CTRL_SET_RC2_KEY_BITS));
  else if ((EVP_CTRL_SET_RC2_KEY_BITS) <= 0)
    o = PyLong_FromLongLong((long long)(EVP_CTRL_SET_RC2_KEY_BITS));
  else
    o = PyLong_FromUnsignedLongLong((unsigned long long)(EVP_CTRL_SET_RC2_KEY_BITS));
  if (o == NULL)
    return -1;
...
static int _cffi_const_EVP_CTRL_SET_RC5_ROUNDS(PyObject *lib)
{
  PyObject *o;
  int res;
  if (LONG_MIN <= (EVP_CTRL_SET_RC5_ROUNDS) && (EVP_CTRL_SET_RC5_ROUNDS) <= LONG_MAX)
    o = PyInt_FromLong((long)(EVP_CTRL_SET_RC5_ROUNDS));
  else if ((EVP_CTRL_SET_RC5_ROUNDS) <= 0)
    o = PyLong_FromLongLong((long long)(EVP_CTRL_SET_RC5_ROUNDS));
  else
    o = PyLong_FromUnsignedLongLong((unsigned long long)(EVP_CTRL_SET_RC5_ROUNDS));
  if (o == NULL)
    return -1;
...
static PyMethodDef _cffi_methods[] = {
  {"_cffi_layout__EC_builtin_curve", _cffi_layout__EC_builtin_curve, METH_NOARGS},
  {"_cffi_layout__HMAC_CTX", _cffi_layout__HMAC_CTX, METH_NOARGS},
  {"BN_CTX_free", _cffi_f_BN_CTX_free, METH_O},
  {"BN_CTX_new", _cffi_f_BN_CTX_new, METH_NOARGS},
  {"BN_add", _cffi_f_BN_add, METH_VARARGS},
  {"BN_bin2bn", _cffi_f_BN_bin2bn, METH_VARARGS},
  {"BN_bn2bin", _cffi_f_BN_bn2bin, METH_VARARGS},
  {"BN_bn2dec", _cffi_f_BN_bn2dec, METH_O},
  {"BN_bn2hex", _cffi_f_BN_bn2hex, METH_O},
  {"BN_clear_free", _cffi_f_BN_clear_free, METH_O},
  {"BN_cmp", _cffi_f_BN_cmp, METH_VARARGS},
  ...
  {"BN_generate_prime_ex", _cffi_f_BN_generate_prime_ex, METH_VARARGS},
  {"BN_hex2bn", _cffi_f_BN_hex2bn, METH_VARARGS},
  {"BN_init", _cffi_f_BN_init, METH_O},
  {"BN_is_bit_set", _cffi_f_BN_is_bit_set, METH_VARARGS},
  {"BN_is_prime_ex", _cffi_f_BN_is_prime_ex, METH_VARARGS},
  ...
  {"BN_rand_range", _cffi_f_BN_rand_range, METH_VARARGS},
  {"BN_set_negative", _cffi_f_BN_set_negative, METH_VARARGS},
  {"BN_set_word", _cffi_f_BN_set_word, METH_VARARGS},
  {"BN_sub", _cffi_f_BN_sub, METH_VARARGS},
  {"BN_swap", _cffi_f_BN_swap, METH_VARARGS},
  {"CRYPTO_memcmp", _cffi_f_CRYPTO_memcmp, METH_VARARGS},
  {"ECDSA_SIG_free", _cffi_f_ECDSA_SIG_free, METH_O},
  {"ECDSA_SIG_new", _cffi_f_ECDSA_SIG_new, METH_NOARGS},
  {"ECDSA_do_sign", _cffi_f_ECDSA_do_sign, METH_VARARGS},
  {"ECDSA_do_sign_ex", _cffi_f_ECDSA_do_sign_ex, METH_VARARGS},
  {"ECDSA_do_verify", _cffi_f_ECDSA_do_verify, METH_VARARGS},
  {"ECDSA_sign_setup", _cffi_f_ECDSA_sign_setup, METH_VARARGS},
  {"ECDSA_size", _cffi_f_ECDSA_size, METH_O},
  {"EC_GROUP_clear_free", _cffi_f_EC_GROUP_clear_free, METH_O},
  {"EC_GROUP_cmp", _cffi_f_EC_GROUP_cmp, METH_VARARGS},
  {"EC_GROUP_free", _cffi_f_EC_GROUP_free, METH_O},
  {"EC_GROUP_get0_generator", _cffi_f_EC_GROUP_get0_generator, METH_O},
  {"EC_GROUP_get_cofactor", _cffi_f_EC_GROUP_get_cofactor, METH_VARARGS},
  {"EC_GROUP_get_curve_GFp", _cffi_f_EC_GROUP_get_curve_GFp, METH_VARARGS},
  {"EC_GROUP_get_curve_name", _cffi_f_EC_GROUP_get_curve_name, METH_O},
  {"EC_GROUP_get_order", _cffi_f_EC_GROUP_get_order, METH_VARARGS},
  {"EC_GROUP_have_precompute_mult", _cffi_f_EC_GROUP_have_precompute_mult, METH_O},
  {"EC_GROUP_new_by_curve_name", _cffi_f_EC_GROUP_new_by_curve_name, METH_O},
  {"EC_GROUP_precompute_mult", _cffi_f_EC_GROUP_precompute_mult, METH_VARARGS},
  {"EC_KEY_free", _cffi_f_EC_KEY_free, METH_O},
  {"EC_KEY_new", _cffi_f_EC_KEY_new, METH_NOARGS},
  {"EC_KEY_precompute_mult", _cffi_f_EC_KEY_precompute_mult, METH_VARARGS},
  {"EC_KEY_set_group", _cffi_f_EC_KEY_set_group, METH_VARARGS},
  {"EC_KEY_set_private_key", _cffi_f_EC_KEY_set_private_key, METH_VARARGS},
  {"EC_KEY_set_public_key", _cffi_f_EC_KEY_set_public_key, METH_VARARGS},
  {"EC_POINT_add", _cffi_f_EC_POINT_add, METH_VARARGS},
  {"EC_POINT_clear_free", _cffi_f_EC_POINT_clear_free, METH_O},
  {"EC_POINT_cmp", _cffi_f_EC_POINT_cmp, METH_VARARGS},
  {"EC_POINT_copy", _cffi_f_EC_POINT_copy, METH_VARARGS},
  {"EC_POINT_dbl", _cffi_f_EC_POINT_dbl, METH_VARARGS},
  {"EC_POINT_dup", _cffi_f_EC_POINT_dup, METH_VARARGS},
  {"EC_POINT_free", _cffi_f_EC_POINT_free, METH_O},
  {"EC_POINT_get_affine_coordinates_GFp", _cffi_f_EC_POINT_get_affine_coordinates_GFp, METH_VARARGS},
  {"EC_POINT_invert", _cffi_f_EC_POINT_invert, METH_VARARGS},
  {"EC_POINT_is_at_infinity", _cffi_f_EC_POINT_is_at_infinity, METH_VARARGS},
  {"EC_POINT_is_on_curve", _cffi_f_EC_POINT_is_on_curve, METH_VARARGS},
  {"EC_POINT_make_affine", _cffi_f_EC_POINT_make_affine, METH_VARARGS},
  {"EC_POINT_mul", _cffi_f_EC_POINT_mul, METH_VARARGS},
  {"EC_POINT_new", _cffi_f_EC_POINT_new, METH_O},
  {"EC_POINT_oct2point", _cffi_f_EC_POINT_oct2point, METH_VARARGS},
  {"EC_POINT_point2oct", _cffi_f_EC_POINT_point2oct, METH_VARARGS},
  {"EC_POINT_set_compressed_coordinates_GFp", _cffi_f_EC_POINT_set_compressed_coordinates_GFp, METH_VARARGS},
  {"EC_POINT_set_to_infinity", _cffi_f_EC_POINT_set_to_infinity, METH_VARARGS},
  {"EC_POINTs_make_affine", _cffi_f_EC_POINTs_make_affine, METH_VARARGS},
  {"EC_POINTs_mul", _cffi_f_EC_POINTs_mul, METH_VARARGS},
  {"EC_get_builtin_curves", _cffi_f_EC_get_builtin_curves, METH_VARARGS},
  ...
  {"EVP_CIPHER_CTX_rand_key", _cffi_f_EVP_CIPHER_CTX_rand_key, METH_VARARGS},
  ...
  {"EVP_MD_block_size", _cffi_f_EVP_MD_block_size, METH_O},
  {"EVP_MD_size", _cffi_f_EVP_MD_size, METH_O},
  {"EVP_aes_128_gcm", _cffi_f_EVP_aes_128_gcm, METH_NOARGS},
  {"EVP_aes_192_gcm", _cffi_f_EVP_aes_192_gcm, METH_NOARGS},
  {"EVP_aes_256_gcm", _cffi_f_EVP_aes_256_gcm, METH_NOARGS},
  ...
  {"HMAC_Final", _cffi_f_HMAC_Final, METH_VARARGS},
  {"HMAC_Init_ex", _cffi_f_HMAC_Init_ex, METH_VARARGS},
  {"HMAC_Update", _cffi_f_HMAC_Update, METH_VARARGS},
  {"OPENSSL_free", _cffi_f_OPENSSL_free, METH_O},
  {"SSLeay_version", _cffi_f_SSLeay_version, METH_O},
  {"bn_is_odd", _cffi_f_bn_is_odd, METH_O},
  {"bn_num_bytes", _cffi_f_bn_num_bytes, METH_O},
  {"cleanup_ciphers", _cffi_f_cleanup_ciphers, METH_NOARGS},
  {"hmac_ctx_size", _cffi_f_hmac_ctx_size, METH_NOARGS},
  {"init_ciphers", _cffi_f_init_ciphers, METH_NOARGS},
  {"_cffi_layout_struct_ECDSA_SIG_st", _cffi_layout_struct_ECDSA_SIG_st, METH_NOARGS},
  {"_cffi_layout_struct_evp_cipher_ctx_st", _cffi_layout_struct_evp_cipher_ctx_st, METH_NOARGS},
  {"_cffi_layout_struct_evp_cipher_st", _cffi_layout_struct_evp_cipher_st, METH_NOARGS},
  {"_cffi_setup", _cffi_setup, METH_VARARGS},
  {NULL, NULL}    /* Sentinel */
};

PyMODINIT_FUNC
init_cffi__xe9757a2axe97e07eb(void)
{
  PyObject *lib;
  lib = Py_InitModule("_cffi__xe9757a2axe97e07eb", _cffi_methods);
  if (lib == NULL || 0 < 0)
    return;
  _cffi_init();
  return;
