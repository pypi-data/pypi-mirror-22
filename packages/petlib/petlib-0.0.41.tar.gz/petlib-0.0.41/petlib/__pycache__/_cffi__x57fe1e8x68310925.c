...
static int _cffi_e_enum_foo(PyObject *lib)
{
  if ((POINT_CONVERSION_COMPRESSED) <= 0 || (unsigned long)(POINT_CONVERSION_COMPRESSED) != 2UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 ...
                 "enum foo: ", "POINT_CONVERSION_COMPRESSED", buf, "2");
    return -1;
  }
  if ((POINT_CONVERSION_UNCOMPRESSED) <= 0 || (unsigned long)(POINT_CONVERSION_UNCOMPRESSED) != 4UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum foo: ", "POINT_CONVERSION_UNCOMPRESSED", buf, "4");
    return -1;
  }
  if ((POINT_CONVERSION_HYBRID) <= 0 || (unsigned long)(POINT_CONVERSION_HYBRID) != 6UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum foo: ", "POINT_CONVERSION_HYBRID", buf, "6");
    return -1;
  }
  return ((void)lib,0);
}
...
static PyMethodDef _cffi_methods[] = {
  ...
  {"ECDSA_do_sign_ex", _cffi_f_ECDSA_do_sign_ex, METH_VARARGS, NULL},
  {"ECDSA_do_verify", _cffi_f_ECDSA_do_verify, METH_VARARGS, NULL},
  {"ECDSA_sign_setup", _cffi_f_ECDSA_sign_setup, METH_VARARGS, NULL},
  ...
  {"EC_KEY_precompute_mult", _cffi_f_EC_KEY_precompute_mult, METH_VARARGS, NULL},
  ...
  {"ERR_get_error", _cffi_f_ERR_get_error, METH_NOARGS, NULL},
...
PyMODINIT_FUNC
PyInit__cffi__x57fe1e8x68310925(void)
{
  PyObject *lib;
...
PyMODINIT_FUNC
init_cffi__x57fe1e8x68310925(void)
{
  PyObject *lib;
  lib = Py_InitModule("_cffi__x57fe1e8x68310925", _cffi_methods);
  if (lib == NULL)
    return;
  if (((void)lib,0) < 0 || _cffi_init() < 0)
    return;
