...
setup(
    name             = light.__name__,
    version          = light.__version__,
    author           = light.__author__,
    author_email     = light.__email__,
    description      = light.__doc__.strip(),
    license          = light.__license__,
    url              = light.__contact__,
    keywords         = keywords,
