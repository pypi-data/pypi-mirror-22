...
~~~~~~~~~~~~~~~~~~~~~
An extension class to extend discord.py's colour class with crayon presets.
( From https://github.com/mwaskom/seaborn/blob/master/seaborn/crayons.py )
:license: GPL, see LICENSE for more details.
"""
from discord.colour import Colour


class CrayonColour(Colour):
