...
(function($){
    $.fn.extend({
        ...
        addDrill: function(drillColumns, callbackFunction){
            ...
            if (oTable['gridmethods'].rows().count()){
                ...
                manageDrill(grid_id, columns_positions, callbackFunction);
    ...
    var manageDrill = function(grid_id, columns_positions, callbackFunction){
        ...
        $('#'+grid_id+' > tbody > tr > td > img').on('click', function () {
            ...
            if (td.hasClass('shown')) {
                ...
                row.child(fnFormatDetails(subgrid_id), class_name).show();
    ...
    function fnFormatDetails(table_id) {
        var sOut = "<div class=\"slider\"><table id=\"" + table_id + "\">";
        sOut += "</table></div>";
        return sOut;
    }
