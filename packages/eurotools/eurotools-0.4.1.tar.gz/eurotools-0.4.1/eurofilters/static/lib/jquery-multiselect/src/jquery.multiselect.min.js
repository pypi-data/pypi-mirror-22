...
(function(d) {
    ...
    d.widget("ech.multiselect", {
        ...
        _create: function() {
            ...
            this._isOpen = !1;
            a = (this.button = d('<button type="button"><span class="ui-icon ui-icon-triangle-2-n-s"></span></button>')).addClass("ui-widget ui-state-default ui-corner-all col-xs-12 center-block").addClass(b.classes).attr({
                title: a.attr("title"),
                "aria-haspopup": !0,
