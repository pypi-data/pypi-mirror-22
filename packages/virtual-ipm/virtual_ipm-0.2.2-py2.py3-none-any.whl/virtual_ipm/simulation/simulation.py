...
class SimulationCycle(Component):
    ...
    def abort(self):
        ...
        StopIteration
        """
        self.log.info('Received stop command: Aborted simulation cycle')
        raise StopIteration
...
class Progress(object):
    ...
    def __init__(self, step, max_steps, time_delta):
        ...
        max_steps : int
            The number of simulation steps that need to be performed in order to
            complete the cycle.
        time_delta : float
    ...
    def time(self):
        ...
        -------
        time : float
            The simulation time corresponding to this progress,
            in units of [s].
        """
