 ...
 ::wxEventCategory sipwxPropertyGridEvent::GetEventCategory() const
{
    ...
    extern  ::wxEventCategory sipVH__propgrid_55(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);
 ...
 ::wxEvent* sipwxPropertyGridEvent::Clone() const
{
    ...
    extern  ::wxEvent* sipVH__propgrid_54(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);

    return sipVH__propgrid_54(sipGILState, 0, sipPySelf, sipMeth);
}
