...
static PyObject *meth_wxTextDataObject_GetDataSize(PyObject *, PyObject *)
{

    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(NULL, sipName_TextDataObject, sipName_GetDataSize, NULL);

    return NULL;
}


extern "C" {static PyObject *meth_wxTextDataObject_GetDataHere(PyObject *, PyObject *);}
static PyObject *meth_wxTextDataObject_GetDataHere(PyObject *, PyObject *)
{

    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(NULL, sipName_TextDataObject, sipName_GetDataHere, NULL);
...
static PyMethodDef methods_wxTextDataObject[] = {
    ...
    {SIP_MLNAME_CAST(sipName_GetDataHere), meth_wxTextDataObject_GetDataHere, METH_VARARGS, NULL},
    {SIP_MLNAME_CAST(sipName_GetDataSize), meth_wxTextDataObject_GetDataSize, METH_VARARGS, NULL},
