...
#include "sipAPI_core.h"
    ...
    void* _wxDC_GetCGContext(wxDC* self)
    {
        #ifdef __WXMAC__
    ...
    void* _wxDC_GetGdkDrawable(wxDC* self)
    {
        #ifdef __WXGTK__
            return self->GetHandle();
        #else
...
PyDoc_STRVAR(doc_wxDC_GetHandle, "GetHandle() -> void\n"
    "\n"
...
PyDoc_STRVAR(doc_wxDC_GetCGContext, "GetCGContext() -> void");
...
PyDoc_STRVAR(doc_wxDC_GetGdkDrawable, "GetGdkDrawable() -> void");
...
static sipEncodedTypeDef supers_wxDC[] = {{345, 255, 1}};
