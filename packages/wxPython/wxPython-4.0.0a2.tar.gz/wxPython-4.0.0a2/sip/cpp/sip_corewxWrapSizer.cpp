...
bool sipwxWrapSizer::IsSpaceItem( ::wxSizerItem*item) const
{
    ...
    extern bool sipVH__core_87(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxSizerItem*);

    return sipVH__core_87(sipGILState, 0, sipPySelf, sipMeth, item);
}
