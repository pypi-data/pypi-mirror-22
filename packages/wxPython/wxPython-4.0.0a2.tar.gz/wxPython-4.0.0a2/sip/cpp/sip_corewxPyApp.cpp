...
void sipwxPyApp::MacOpenFiles(const  ::wxArrayString& fileNames)
{
    ...
    extern void sipVH__core_101(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxArrayString&);

    sipVH__core_101(sipGILState, 0, sipPySelf, sipMeth, fileNames);
}
...
int sipwxPyApp::FilterEvent( ::wxEvent& event)
{
    ...
    extern int sipVH__core_89(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxEvent&);

    return sipVH__core_89(sipGILState, 0, sipPySelf, sipMeth, event);
}
...
void sipwxPyApp::OnEventLoopEnter( ::wxEventLoopBase*loop)
{
    ...
    extern void sipVH__core_100(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxEventLoopBase*);

    sipVH__core_100(sipGILState, 0, sipPySelf, sipMeth, loop);
}
