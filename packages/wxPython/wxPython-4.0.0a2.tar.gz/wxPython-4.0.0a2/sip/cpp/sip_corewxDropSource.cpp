...
bool sipwxDropSource::GiveFeedback( ::wxDragResult effect)
{
    ...
    extern bool sipVH__core_68(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxDragResult);

    return sipVH__core_68(sipGILState, 0, sipPySelf, sipMeth, effect);
}
 ...
 ::wxDragResult sipwxDropSource::DoDragDrop(int flags)
{
    ...
    extern  ::wxDragResult sipVH__core_67(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, int);

    return sipVH__core_67(sipGILState, 0, sipPySelf, sipMeth, flags);
}
