...
static PyObject *meth_wxFileDataObject_GetDataSize(PyObject *, PyObject *)
{

    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(NULL, sipName_FileDataObject, sipName_GetDataSize, NULL);

    return NULL;
}


extern "C" {static PyObject *meth_wxFileDataObject_GetDataHere(PyObject *, PyObject *);}
static PyObject *meth_wxFileDataObject_GetDataHere(PyObject *, PyObject *)
{

    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(NULL, sipName_FileDataObject, sipName_GetDataHere, NULL);
...
static PyMethodDef methods_wxFileDataObject[] = {
    ...
    {SIP_MLNAME_CAST(sipName_GetDataHere), meth_wxFileDataObject_GetDataHere, METH_VARARGS, NULL},
    {SIP_MLNAME_CAST(sipName_GetDataSize), meth_wxFileDataObject_GetDataSize, METH_VARARGS, NULL},
