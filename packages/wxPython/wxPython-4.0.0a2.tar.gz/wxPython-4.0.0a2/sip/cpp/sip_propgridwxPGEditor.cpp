...
bool sipwxPGEditor::GetValueFromControl( ::wxPGVariant& variant, ::wxPGProperty*property, ::wxWindow*ctrl) const
{
    sip_gilstate_t sipGILState;
    PyObject *sipMeth;
...
PyDoc_STRVAR(doc_wxPGEditor_GetValueFromControl, "GetValueFromControl(variant, property, ctrl) -> bool\n"
    "\n"
...
static PyObject *meth_wxPGEditor_GetValueFromControl(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1J8J8", &sipSelf, sipType_wxPGEditor, &sipCpp, sipType_wxPGVariant,&variant, &variantState, sipType_wxPGProperty, &property, sipType_wxWindow, &ctrl))
        {
            bool sipRes;
