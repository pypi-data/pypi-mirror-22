...
void sipwxPropertyGridPageState::DoSetSplitterPosition(int pos,int splitterColumn,int flags)
{
    ...
    extern void sipVH__propgrid_51(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, int,int,int);

    sipVH__propgrid_51(sipGILState, 0, sipPySelf, sipMeth, pos, splitterColumn, flags);
}
 ...
 ::wxPGProperty* sipwxPropertyGridPageState::DoInsert( ::wxPGProperty*parent,int index, ::wxPGProperty*property)
{
    ...
    extern  ::wxPGProperty* sipVH__propgrid_50(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxPGProperty*,int, ::wxPGProperty*);

    return sipVH__propgrid_50(sipGILState, 0, sipPySelf, sipMeth, parent, index, property);
}
...
void sipwxPropertyGridPageState::DoDelete( ::wxPGProperty*item,bool doDelete)
{
    ...
    extern void sipVH__propgrid_49(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxPGProperty*,bool);

    sipVH__propgrid_49(sipGILState, 0, sipPySelf, sipMeth, item, doDelete);
}
