...
bool sipwxTimer::Start(int milliseconds,bool oneShot)
{
    ...
    extern bool sipVH__core_102(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, int,bool);

    return sipVH__core_102(sipGILState, 0, sipPySelf, sipMeth, milliseconds, oneShot);
}
