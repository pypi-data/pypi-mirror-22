...
bool sipwxGUIEventLoop::YieldFor(long eventsToProcess)
{
    ...
    extern bool sipVH__core_94(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, long);

    return sipVH__core_94(sipGILState, 0, sipPySelf, sipMeth, eventsToProcess);
}
...
void sipwxGUIEventLoop::Exit(int rc)
{
    ...
    sipVH__core_91(sipGILState, 0, sipPySelf, sipMeth, rc);
}
...
int sipwxGUIEventLoop::DispatchTimeout(unsigned long timeout)
{
    ...
    extern int sipVH__core_92(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, unsigned long);

    return sipVH__core_92(sipGILState, 0, sipPySelf, sipMeth, timeout);
}
...
bool sipwxGUIEventLoop::IsEventAllowedInsideYield( ::wxEventCategory cat) const
{
    ...
    extern bool sipVH__core_93(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxEventCategory);

    return sipVH__core_93(sipGILState, 0, sipPySelf, sipMeth, cat);
}
