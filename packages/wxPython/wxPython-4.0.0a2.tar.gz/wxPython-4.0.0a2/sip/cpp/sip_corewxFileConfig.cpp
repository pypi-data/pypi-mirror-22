...
bool sipwxFileConfig::Save( ::wxOutputStream& os)
{
    ...
    extern bool sipVH__core_82(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxOutputStream&);

    return sipVH__core_82(sipGILState, 0, sipPySelf, sipMeth, os);
}
...
const  ::wxString& sipwxFileConfig::GetPath() const
{
    ...
    extern const  ::wxString& sipVH__core_77(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);

    return sipVH__core_77(sipGILState, 0, sipPySelf, sipMeth);
}
 ...
 ::size_t sipwxFileConfig::GetNumberOfEntries(bool bRecursive) const
{
    ...
    extern  ::size_t sipVH__core_78(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, bool);

    return sipVH__core_78(sipGILState, 0, sipPySelf, sipMeth, bRecursive);
}
 ...
 ::wxConfigBase::EntryType sipwxFileConfig::GetEntryType(const  ::wxString& name) const
{
    ...
    extern  ::wxConfigBase::EntryType sipVH__core_79(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxString&);

    return sipVH__core_79(sipGILState, 0, sipPySelf, sipMeth, name);
}
...
bool sipwxFileConfig::Flush(bool bCurrentOnly)
{
    ...
    extern bool sipVH__core_80(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, bool);

    return sipVH__core_80(sipGILState, 0, sipPySelf, sipMeth, bCurrentOnly);
}
...
bool sipwxFileConfig::DeleteEntry(const  ::wxString& key,bool bDeleteGroupIfEmpty)
{
    ...
    extern bool sipVH__core_81(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxString&,bool);

    return sipVH__core_81(sipGILState, 0, sipPySelf, sipMeth, key, bDeleteGroupIfEmpty);
}
