...
static PyObject *meth_wxBitmapDataObject_GetDataSize(PyObject *, PyObject *)
{

    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(NULL, sipName_BitmapDataObject, sipName_GetDataSize, NULL);

    return NULL;
}


extern "C" {static PyObject *meth_wxBitmapDataObject_GetDataHere(PyObject *, PyObject *);}
static PyObject *meth_wxBitmapDataObject_GetDataHere(PyObject *, PyObject *)
{

    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(NULL, sipName_BitmapDataObject, sipName_GetDataHere, NULL);
...
static PyMethodDef methods_wxBitmapDataObject[] = {
    ...
    {SIP_MLNAME_CAST(sipName_GetDataHere), meth_wxBitmapDataObject_GetDataHere, METH_VARARGS, NULL},
    {SIP_MLNAME_CAST(sipName_GetDataSize), meth_wxBitmapDataObject_GetDataSize, METH_VARARGS, NULL},
