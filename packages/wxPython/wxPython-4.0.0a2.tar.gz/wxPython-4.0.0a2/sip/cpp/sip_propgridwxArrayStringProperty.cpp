...
bool sipwxArrayStringProperty::StringToValue( ::wxPGVariant& variant,const  ::wxString& text,int argFlags) const
{
    ...
    extern bool sipVH__propgrid_56(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxPGVariant&,const  ::wxString&,int);

    return sipVH__propgrid_56(sipGILState, 0, sipPySelf, sipMeth, variant, text, argFlags);
}
