 ...
 ::wxString sipwxHtmlFilter::ReadFile(const  ::wxFSFile& file) const
{
    ...
    extern  ::wxString sipVH__html_14(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxFSFile&);
...
bool sipwxHtmlFilter::CanRead(const  ::wxFSFile& file) const
{
    ...
    extern bool sipVH__html_13(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxFSFile&);

    return sipVH__html_13(sipGILState, 0, sipPySelf, sipMeth, file);
}
