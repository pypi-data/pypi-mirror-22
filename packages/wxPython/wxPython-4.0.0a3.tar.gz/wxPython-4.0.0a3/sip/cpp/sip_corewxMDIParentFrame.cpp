 ...
 ::wxStatusBar* sipwxMDIParentFrame::OnCreateStatusBar(int number,long style, ::wxWindowID id,const  ::wxString& name)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[39],sipPySelf,NULL,sipName_OnCreateStatusBar);
 ...
 ::wxToolBar* sipwxMDIParentFrame::OnCreateToolBar(long style, ::wxWindowID id,const  ::wxString& name)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[40],sipPySelf,NULL,sipName_OnCreateToolBar);
...
sipVariableDef variables_wxMDIParentFrame[] = {
    {PropertyVariable, sipName_WindowMenu, &methods_wxMDIParentFrame[30], &methods_wxMDIParentFrame[42], NULL, NULL},
