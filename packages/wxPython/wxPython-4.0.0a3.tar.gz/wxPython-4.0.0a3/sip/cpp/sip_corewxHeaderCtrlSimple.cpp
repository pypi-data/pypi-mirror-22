...
const  ::wxHeaderColumn& sipwxHeaderCtrlSimple::GetColumn(uint idx) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[38]),sipPySelf,NULL,sipName_GetColumn);
...
void sipwxHeaderCtrlSimple::UpdateColumnVisibility(uint idx,bool show)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[39],sipPySelf,NULL,sipName_UpdateColumnVisibility);
...
void sipwxHeaderCtrlSimple::UpdateColumnsOrder(const  ::wxArrayInt& order)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[40],sipPySelf,NULL,sipName_UpdateColumnsOrder);
...
bool sipwxHeaderCtrlSimple::UpdateColumnWidthToFit(uint idx,int widthTitle)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[41],sipPySelf,NULL,sipName_UpdateColumnWidthToFit);
...
void sipwxHeaderCtrlSimple::OnColumnCountChanging(uint count)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[42],sipPySelf,NULL,sipName_OnColumnCountChanging);
...
static sipEncodedTypeDef supers_wxHeaderCtrlSimple[] = {{227, 255, 1}};
