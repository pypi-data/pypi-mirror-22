...
sipVariableDef variables_wxWebView[] = {
    {PropertyVariable, sipName_ZoomType, &methods_wxWebView[34], &methods_wxWebView[60], NULL, NULL},
    {PropertyVariable, sipName_Zoom, &methods_wxWebView[33], &methods_wxWebView[59], NULL, NULL},
    {PropertyVariable, sipName_SelectedText, &methods_wxWebView[32], NULL, NULL, NULL},
    {PropertyVariable, sipName_SelectedSource, &methods_wxWebView[31], NULL, NULL, NULL},
    {PropertyVariable, sipName_PageText, &methods_wxWebView[30], NULL, NULL, NULL},
    {PropertyVariable, sipName_PageSource, &methods_wxWebView[29], NULL, NULL, NULL},
    {PropertyVariable, sipName_NativeBackend, &methods_wxWebView[28], NULL, NULL, NULL},
    {PropertyVariable, sipName_ForwardHistory, &methods_wxWebView[26], NULL, NULL, NULL},
    {PropertyVariable, sipName_CurrentURL, &methods_wxWebView[25], NULL, NULL, NULL},
    {PropertyVariable, sipName_CurrentTitle, &methods_wxWebView[24], NULL, NULL, NULL},
