 ...
 ::wxEvent* sipwxRichTextEvent::Clone() const
{
    ...
    extern  ::wxEvent* sipVH__richtext_138(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);
 ...
 ::wxEventCategory sipwxRichTextEvent::GetEventCategory() const
{
    ...
    extern  ::wxEventCategory sipVH__richtext_137(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);

    return sipVH__richtext_137(sipGILState, 0, sipPySelf, sipMeth);
}
