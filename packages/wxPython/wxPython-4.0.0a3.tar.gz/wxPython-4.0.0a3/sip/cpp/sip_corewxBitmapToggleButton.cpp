...
static sipEncodedTypeDef supers_wxBitmapToggleButton[] = {{515, 255, 1}};
...
sipVariableDef variables_wxBitmapToggleButton[] = {
    {PropertyVariable, sipName_Value, &methods_wxBitmapToggleButton[24], &methods_wxBitmapToggleButton[34], NULL, NULL},
};
...
sipClassTypeDef sipTypeDef__core_wxBitmapToggleButton = {
    ...
    },
    {
        ...
        {0, 0, 1},
        41, methods_wxBitmapToggleButton,
        0, 0,
