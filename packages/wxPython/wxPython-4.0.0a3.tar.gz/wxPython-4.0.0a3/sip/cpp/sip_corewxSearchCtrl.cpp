...
sipVariableDef variables_wxSearchCtrl[] = {
    {PropertyVariable, sipName_Value, &methods_wxSearchCtrl[53], &methods_wxSearchCtrl[96], NULL, NULL},
    {PropertyVariable, sipName_StringSelection, &methods_wxSearchCtrl[51], NULL, NULL, NULL},
    {PropertyVariable, sipName_NumberOfLines, &methods_wxSearchCtrl[48], NULL, NULL, NULL},
    {PropertyVariable, sipName_Menu, &methods_wxSearchCtrl[47], &methods_wxSearchCtrl[90], NULL, NULL},
    {PropertyVariable, sipName_Margins, &methods_wxSearchCtrl[46], &methods_wxSearchCtrl[88], NULL, NULL},
    {PropertyVariable, sipName_LastPosition, &methods_wxSearchCtrl[42], NULL, NULL, NULL},
    {PropertyVariable, sipName_InsertionPoint, &methods_wxSearchCtrl[41], &methods_wxSearchCtrl[86], NULL, NULL},
    {PropertyVariable, sipName_Hint, &methods_wxSearchCtrl[40], &methods_wxSearchCtrl[85], NULL, NULL},
    {PropertyVariable, sipName_DescriptiveText, &methods_wxSearchCtrl[39], &methods_wxSearchCtrl[83], NULL, NULL},
    {PropertyVariable, sipName_DefaultStyle, &methods_wxSearchCtrl[38], &methods_wxSearchCtrl[82], NULL, NULL},
    {PropertyVariable, sipName_CancelButtonVisible, &methods_wxSearchCtrl[60], &methods_wxSearchCtrl[98], NULL, NULL},
    {PropertyVariable, sipName_SearchButtonVisible, &methods_wxSearchCtrl[65], &methods_wxSearchCtrl[100], NULL, NULL},
};
