 ...
 ::wxWindow* sipwxFileDialog::GetContentWindow() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[38]),sipPySelf,NULL,sipName_GetContentWindow);
...
sipVariableDef variables_wxFileDialog[] = {
    {PropertyVariable, sipName_Wildcard, &methods_wxFileDialog[32], &methods_wxFileDialog[47], NULL, NULL},
    {PropertyVariable, sipName_Paths, &methods_wxFileDialog[31], NULL, NULL, NULL},
    {PropertyVariable, sipName_Path, &methods_wxFileDialog[30], &methods_wxFileDialog[46], NULL, NULL},
    {PropertyVariable, sipName_Message, &methods_wxFileDialog[29], &methods_wxFileDialog[45], NULL, NULL},
    {PropertyVariable, sipName_FilterIndex, &methods_wxFileDialog[27], &methods_wxFileDialog[44], NULL, NULL},
    {PropertyVariable, sipName_Filenames, &methods_wxFileDialog[26], NULL, NULL, NULL},
    {PropertyVariable, sipName_Filename, &methods_wxFileDialog[25], &methods_wxFileDialog[43], NULL, NULL},
    {PropertyVariable, sipName_ExtraControl, &methods_wxFileDialog[24], NULL, NULL, NULL},
    {PropertyVariable, sipName_Directory, &methods_wxFileDialog[23], &methods_wxFileDialog[42], NULL, NULL},
