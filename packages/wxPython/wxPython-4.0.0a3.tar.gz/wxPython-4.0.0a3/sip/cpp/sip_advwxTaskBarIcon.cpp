 ...
 ::wxMenu* sipwxTaskBarIcon::CreatePopupMenu()
{
    ...
    extern  ::wxMenu* sipVH__adv_31(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);

    return sipVH__adv_31(sipGILState, 0, sipPySelf, sipMeth);
}
...
bool sipwxTaskBarIcon::SetIcon(const  ::wxIcon& icon,const  ::wxString& tooltip)
{
    ...
    extern bool sipVH__adv_30(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxIcon&,const  ::wxString&);

    return sipVH__adv_30(sipGILState, 0, sipPySelf, sipMeth, icon, tooltip);
}
...
bool sipwxTaskBarIcon::PopupMenu( ::wxMenu*menu)
{
    ...
    extern bool sipVH__adv_29(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxMenu*);

    return sipVH__adv_29(sipGILState, 0, sipPySelf, sipMeth, menu);
}
