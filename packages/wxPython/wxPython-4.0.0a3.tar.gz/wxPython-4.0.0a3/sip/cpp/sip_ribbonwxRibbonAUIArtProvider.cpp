 ...
 ::wxRect sipwxRibbonAUIArtProvider::GetRibbonHelpButtonArea(const  ::wxRect& rect)
{
    ...
    extern  ::wxRect sipVH__ribbon_51(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxRect&);

    return sipVH__ribbon_51(sipGILState, 0, sipPySelf, sipMeth, rect);
}
 ...
 ::wxSize sipwxRibbonAUIArtProvider::GetToolSize( ::wxDC& dc, ::wxWindow*wnd, ::wxSize bitmap_size, ::wxRibbonButtonKind kind,bool is_first,bool is_last, ::wxRect*dropdown_region)
{
    ...
    extern  ::wxSize sipVH__ribbon_50(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxDC&, ::wxWindow*, ::wxSize, ::wxRibbonButtonKind,bool,bool, ::wxRect*);

    return sipVH__ribbon_50(sipGILState, 0, sipPySelf, sipMeth, dc, wnd, bitmap_size, kind, is_first, is_last, dropdown_region);
}
 ...
 ::wxSize sipwxRibbonAUIArtProvider::GetMinimisedPanelMinimumSize( ::wxDC& dc,const  ::wxRibbonPanel*wnd, ::wxSize*desired_bitmap_size, ::wxDirection*expanded_panel_direction)
{
    ...
    extern  ::wxSize sipVH__ribbon_49(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxDC&,const  ::wxRibbonPanel*, ::wxSize*, ::wxDirection*);

    return sipVH__ribbon_49(sipGILState, 0, sipPySelf, sipMeth, dc, wnd, desired_bitmap_size, expanded_panel_direction);
}
...
bool sipwxRibbonAUIArtProvider::GetButtonBarButtonSize( ::wxDC& dc, ::wxWindow*wnd, ::wxRibbonButtonKind kind, ::wxRibbonButtonBarButtonState size,const  ::wxString& label, ::wxSize bitmap_size_large, ::wxSize bitmap_size_small, ::wxSize*button_size, ::wxRect*normal_region, ::wxRect*dropdown_region)
{
    ...
    extern bool sipVH__ribbon_48(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxDC&, ::wxWindow*, ::wxRibbonButtonKind, ::wxRibbonButtonBarButtonState,const  ::wxString&, ::wxSize, ::wxSize, ::wxSize*, ::wxRect*, ::wxRect*);

    return sipVH__ribbon_48(sipGILState, 0, sipPySelf, sipMeth, dc, wnd, kind, size, label, bitmap_size_large, bitmap_size_small, button_size, normal_region, dropdown_region);
}
 ...
 ::wxRect sipwxRibbonAUIArtProvider::GetPageBackgroundRedrawArea( ::wxDC& dc,const  ::wxRibbonPage*wnd, ::wxSize page_old_size, ::wxSize page_new_size)
{
    ...
    extern  ::wxRect sipVH__ribbon_47(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxDC&,const  ::wxRibbonPage*, ::wxSize, ::wxSize);

    return sipVH__ribbon_47(sipGILState, 0, sipPySelf, sipMeth, dc, wnd, page_old_size, page_new_size);
}
 ...
 ::wxSize sipwxRibbonAUIArtProvider::GetGalleryClientSize( ::wxDC& dc,const  ::wxRibbonGallery*wnd, ::wxSize size, ::wxPoint*client_offset, ::wxRect*scroll_up_button, ::wxRect*scroll_down_button, ::wxRect*extension_button)
{
    ...
    extern  ::wxSize sipVH__ribbon_46(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxDC&,const  ::wxRibbonGallery*, ::wxSize, ::wxPoint*, ::wxRect*, ::wxRect*, ::wxRect*);

    return sipVH__ribbon_46(sipGILState, 0, sipPySelf, sipMeth, dc, wnd, size, client_offset, scroll_up_button, scroll_down_button, extension_button);
}
 ...
 ::wxSize sipwxRibbonAUIArtProvider::GetGallerySize( ::wxDC& dc,const  ::wxRibbonGallery*wnd, ::wxSize client_size)
{
    ...
    extern  ::wxSize sipVH__ribbon_45(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxDC&,const  ::wxRibbonGallery*, ::wxSize);

    return sipVH__ribbon_45(sipGILState, 0, sipPySelf, sipMeth, dc, wnd, client_size);
}
 ...
 ::wxRect sipwxRibbonAUIArtProvider::GetPanelExtButtonArea( ::wxDC& dc,const  ::wxRibbonPanel*wnd, ::wxRect rect)
{
    ...
    extern  ::wxRect sipVH__ribbon_44(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxDC&,const  ::wxRibbonPanel*, ::wxRect);

    return sipVH__ribbon_44(sipGILState, 0, sipPySelf, sipMeth, dc, wnd, rect);
}
 ...
 ::wxSize sipwxRibbonAUIArtProvider::GetPanelClientSize( ::wxDC& dc,const  ::wxRibbonPanel*wnd, ::wxSize size, ::wxPoint*client_offset)
{
    ...
    extern  ::wxSize sipVH__ribbon_43(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxDC&,const  ::wxRibbonPanel*, ::wxSize, ::wxPoint*);

    return sipVH__ribbon_43(sipGILState, 0, sipPySelf, sipMeth, dc, wnd, size, client_offset);
}
 ...
 ::wxSize sipwxRibbonAUIArtProvider::GetPanelSize( ::wxDC& dc,const  ::wxRibbonPanel*wnd, ::wxSize client_size, ::wxPoint*client_offset)
{
    ...
    return sipVH__ribbon_43(sipGILState, 0, sipPySelf, sipMeth, dc, wnd, client_size, client_offset);
}
 ...
 ::wxSize sipwxRibbonAUIArtProvider::GetScrollButtonMinimumSize( ::wxDC& dc, ::wxWindow*wnd,long style)
{
    ...
    extern  ::wxSize sipVH__ribbon_42(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxDC&, ::wxWindow*,long);

    return sipVH__ribbon_42(sipGILState, 0, sipPySelf, sipMeth, dc, wnd, style);
}
...
int sipwxRibbonAUIArtProvider::GetTabCtrlHeight( ::wxDC& dc, ::wxWindow*wnd,const  ::wxRibbonPageTabInfoArray& pages)
{
    ...
    extern int sipVH__ribbon_41(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxDC&, ::wxWindow*,const  ::wxRibbonPageTabInfoArray&);

    return sipVH__ribbon_41(sipGILState, 0, sipPySelf, sipMeth, dc, wnd, pages);
}
...
void sipwxRibbonAUIArtProvider::GetBarTabWidth( ::wxDC& dc, ::wxWindow*wnd,const  ::wxString& label,const  ::wxBitmap& bitmap,int*ideal,int*small_begin_need_separator,int*small_must_have_separator,int*minimum)
{
    ...
    extern void sipVH__ribbon_40(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxDC&, ::wxWindow*,const  ::wxString&,const  ::wxBitmap&,int*,int*,int*,int*);

    sipVH__ribbon_40(sipGILState, 0, sipPySelf, sipMeth, dc, wnd, label, bitmap, ideal, small_begin_need_separator, small_must_have_separator, minimum);
}
...
void sipwxRibbonAUIArtProvider::DrawHelpButton( ::wxDC& dc, ::wxRibbonBar*wnd,const  ::wxRect& rect)
{
    ...
    extern void sipVH__ribbon_39(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxDC&, ::wxRibbonBar*,const  ::wxRect&);

    sipVH__ribbon_39(sipGILState, 0, sipPySelf, sipMeth, dc, wnd, rect);
}
...
void sipwxRibbonAUIArtProvider::DrawToggleButton( ::wxDC& dc, ::wxRibbonBar*wnd,const  ::wxRect& rect, ::wxRibbonDisplayMode mode)
{
    ...
    extern void sipVH__ribbon_38(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxDC&, ::wxRibbonBar*,const  ::wxRect&, ::wxRibbonDisplayMode);

    sipVH__ribbon_38(sipGILState, 0, sipPySelf, sipMeth, dc, wnd, rect, mode);
}
...
void sipwxRibbonAUIArtProvider::DrawTool( ::wxDC& dc, ::wxWindow*wnd,const  ::wxRect& rect,const  ::wxBitmap& bitmap, ::wxRibbonButtonKind kind,long state)
{
    ...
    extern void sipVH__ribbon_37(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxDC&, ::wxWindow*,const  ::wxRect&,const  ::wxBitmap&, ::wxRibbonButtonKind,long);

    sipVH__ribbon_37(sipGILState, 0, sipPySelf, sipMeth, dc, wnd, rect, bitmap, kind, state);
}
...
void sipwxRibbonAUIArtProvider::DrawToolGroupBackground( ::wxDC& dc, ::wxWindow*wnd,const  ::wxRect& rect)
{
    ...
    extern void sipVH__ribbon_28(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxDC&, ::wxWindow*,const  ::wxRect&);

    sipVH__ribbon_28(sipGILState, 0, sipPySelf, sipMeth, dc, wnd, rect);
}
...
void sipwxRibbonAUIArtProvider::DrawButtonBarButton( ::wxDC& dc, ::wxWindow*wnd,const  ::wxRect& rect, ::wxRibbonButtonKind kind,long state,const  ::wxString& label,const  ::wxBitmap& bitmap_large,const  ::wxBitmap& bitmap_small)
{
    ...
    extern void sipVH__ribbon_36(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxDC&, ::wxWindow*,const  ::wxRect&, ::wxRibbonButtonKind,long,const  ::wxString&,const  ::wxBitmap&,const  ::wxBitmap&);

    sipVH__ribbon_36(sipGILState, 0, sipPySelf, sipMeth, dc, wnd, rect, kind, state, label, bitmap_large, bitmap_small);
}
...
void sipwxRibbonAUIArtProvider::DrawMinimisedPanel( ::wxDC& dc, ::wxRibbonPanel*wnd,const  ::wxRect& rect, ::wxBitmap& bitmap)
{
    ...
    extern void sipVH__ribbon_35(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxDC&, ::wxRibbonPanel*,const  ::wxRect&, ::wxBitmap&);

    sipVH__ribbon_35(sipGILState, 0, sipPySelf, sipMeth, dc, wnd, rect, bitmap);
}
...
void sipwxRibbonAUIArtProvider::DrawGalleryItemBackground( ::wxDC& dc, ::wxRibbonGallery*wnd,const  ::wxRect& rect, ::wxRibbonGalleryItem*item)
{
    ...
    extern void sipVH__ribbon_34(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxDC&, ::wxRibbonGallery*,const  ::wxRect&, ::wxRibbonGalleryItem*);

    sipVH__ribbon_34(sipGILState, 0, sipPySelf, sipMeth, dc, wnd, rect, item);
}
...
void sipwxRibbonAUIArtProvider::DrawGalleryBackground( ::wxDC& dc, ::wxRibbonGallery*wnd,const  ::wxRect& rect)
{
    ...
    extern void sipVH__ribbon_33(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxDC&, ::wxRibbonGallery*,const  ::wxRect&);

    sipVH__ribbon_33(sipGILState, 0, sipPySelf, sipMeth, dc, wnd, rect);
}
...
void sipwxRibbonAUIArtProvider::DrawPanelBackground( ::wxDC& dc, ::wxRibbonPanel*wnd,const  ::wxRect& rect)
{
    ...
    extern void sipVH__ribbon_32(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxDC&, ::wxRibbonPanel*,const  ::wxRect&);

    sipVH__ribbon_32(sipGILState, 0, sipPySelf, sipMeth, dc, wnd, rect);
}
...
void sipwxRibbonAUIArtProvider::DrawScrollButton( ::wxDC& dc, ::wxWindow*wnd,const  ::wxRect& rect,long style)
{
    ...
    extern void sipVH__ribbon_31(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxDC&, ::wxWindow*,const  ::wxRect&,long);

    sipVH__ribbon_31(sipGILState, 0, sipPySelf, sipMeth, dc, wnd, rect, style);
}
...
void sipwxRibbonAUIArtProvider::DrawTabSeparator( ::wxDC& dc, ::wxWindow*wnd,const  ::wxRect& rect,double visibility)
{
    ...
    extern void sipVH__ribbon_30(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxDC&, ::wxWindow*,const  ::wxRect&,double);

    sipVH__ribbon_30(sipGILState, 0, sipPySelf, sipMeth, dc, wnd, rect, visibility);
}
...
void sipwxRibbonAUIArtProvider::DrawTab( ::wxDC& dc, ::wxWindow*wnd,const  ::wxRibbonPageTabInfo& tab)
{
    ...
    extern void sipVH__ribbon_29(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxDC&, ::wxWindow*,const  ::wxRibbonPageTabInfo&);

    sipVH__ribbon_29(sipGILState, 0, sipPySelf, sipMeth, dc, wnd, tab);
}
...
void sipwxRibbonAUIArtProvider::SetColourScheme(const  ::wxColour& primary,const  ::wxColour& secondary,const  ::wxColour& tertiary)
{
    ...
    extern void sipVH__ribbon_27(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxColour&,const  ::wxColour&,const  ::wxColour&);

    sipVH__ribbon_27(sipGILState, 0, sipPySelf, sipMeth, primary, secondary, tertiary);
}
...
void sipwxRibbonAUIArtProvider::GetColourScheme( ::wxColour*primary, ::wxColour*secondary, ::wxColour*tertiary) const
{
    ...
    extern void sipVH__ribbon_26(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxColour*, ::wxColour*, ::wxColour*);

    sipVH__ribbon_26(sipGILState, 0, sipPySelf, sipMeth, primary, secondary, tertiary);
}
...
void sipwxRibbonAUIArtProvider::SetColour(int id,const  ::wxColour& colour)
{
    ...
    extern void sipVH__ribbon_25(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, int,const  ::wxColour&);

    sipVH__ribbon_25(sipGILState, 0, sipPySelf, sipMeth, id, colour);
}
 ...
 ::wxColour sipwxRibbonAUIArtProvider::GetColour(int id) const
{
    ...
    extern  ::wxColour sipVH__ribbon_24(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, int);

    return sipVH__ribbon_24(sipGILState, 0, sipPySelf, sipMeth, id);
}
 ...
 ::wxFont sipwxRibbonAUIArtProvider::GetFont(int id) const
{
    ...
    extern  ::wxFont sipVH__ribbon_23(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, int);
...
void sipwxRibbonAUIArtProvider::SetFont(int id,const  ::wxFont& font)
{
    ...
    extern void sipVH__ribbon_22(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, int,const  ::wxFont&);

    sipVH__ribbon_22(sipGILState, 0, sipPySelf, sipMeth, id, font);
}
...
void sipwxRibbonAUIArtProvider::SetMetric(int id,int new_val)
{
    ...
    sipVH__ribbon_10(sipGILState, 0, sipPySelf, sipMeth, id, new_val);
}
...
int sipwxRibbonAUIArtProvider::GetMetric(int id) const
{
    ...
    extern int sipVH__ribbon_21(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, int);

    return sipVH__ribbon_21(sipGILState, 0, sipPySelf, sipMeth, id);
}
...
long sipwxRibbonAUIArtProvider::GetFlags() const
{
    ...
    extern long sipVH__ribbon_20(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);
...
void sipwxRibbonAUIArtProvider::SetFlags(long flags)
{
    ...
    extern void sipVH__ribbon_19(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, long);

    sipVH__ribbon_19(sipGILState, 0, sipPySelf, sipMeth, flags);
}
 ...
 ::wxRibbonArtProvider* sipwxRibbonAUIArtProvider::Clone() const
{
    ...
    extern  ::wxRibbonArtProvider* sipVH__ribbon_18(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);
