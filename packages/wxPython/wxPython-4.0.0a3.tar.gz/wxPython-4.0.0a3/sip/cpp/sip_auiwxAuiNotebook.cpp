...
sipVariableDef variables_wxAuiNotebook[] = {
    {PropertyVariable, sipName_TabCtrlHeight, &methods_wxAuiNotebook[40], &methods_wxAuiNotebook[62], NULL, NULL},
    {PropertyVariable, sipName_Selection, &methods_wxAuiNotebook[39], &methods_wxAuiNotebook[61], NULL, NULL},
    {PropertyVariable, sipName_PageCount, &methods_wxAuiNotebook[34], NULL, NULL, NULL},
    {PropertyVariable, sipName_CurrentPage, &methods_wxAuiNotebook[27], NULL, NULL, NULL},
    {PropertyVariable, sipName_ArtProvider, &methods_wxAuiNotebook[25], &methods_wxAuiNotebook[51], NULL, NULL},
};
