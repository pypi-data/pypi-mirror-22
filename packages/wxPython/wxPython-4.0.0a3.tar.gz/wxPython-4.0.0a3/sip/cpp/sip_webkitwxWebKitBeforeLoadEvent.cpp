 ...
 ::wxEventCategory sipwxWebKitBeforeLoadEvent::GetEventCategory() const
{
    ...
    extern  ::wxEventCategory sipVH__webkit_17(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);
 ...
 ::wxEvent* sipwxWebKitBeforeLoadEvent::Clone() const
{
    ...
    extern  ::wxEvent* sipVH__webkit_16(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);

    return sipVH__webkit_16(sipGILState, 0, sipPySelf, sipMeth);
}
