...
void sipwxRichTextPrintout::GetPageInfo(int*minPage,int*maxPage,int*selPageFrom,int*selPageTo)
{
    ...
    extern void sipVH__richtext_140(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, int*,int*,int*,int*);

    sipVH__richtext_140(sipGILState, 0, sipPySelf, sipMeth, minPage, maxPage, selPageFrom, selPageTo);
}
...
bool sipwxRichTextPrintout::HasPage(int page)
{
    ...
    return sipVH__richtext_139(sipGILState, 0, sipPySelf, sipMeth, page);
}
