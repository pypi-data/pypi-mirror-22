...
static PyObject *meth_wxToolBar_AddTool(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        const  ::wxBitmap* bmpDisabled;
         ::wxItemKind kind = wxITEM_NORMAL;
        const  ::wxString& shortHelpStringdef = wxEmptyString;
        const  ::wxString* shortHelpString = &shortHelpStringdef;
        int shortHelpStringState = 0;
        const  ::wxString& longHelpStringdef = wxEmptyString;
        const  ::wxString* longHelpString = &longHelpStringdef;
        int longHelpStringState = 0;
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BiJ1J9J9|EJ1J1J2", &sipSelf, sipType_wxToolBar, &sipCpp, &toolId, sipType_wxString,&label, &labelState, sipType_wxBitmap, &bitmap, sipType_wxBitmap, &bmpDisabled, sipType_wxItemKind, &kind, sipType_wxString,&shortHelpString, &shortHelpStringState, sipType_wxString,&longHelpString, &longHelpStringState, sipType_wxPyUserData,&clientData, &clientDataState))
        {
            ...
            Py_BEGIN_ALLOW_THREADS
            sipRes = sipCpp->AddTool(toolId,*label,*bitmap,*bmpDisabled,kind,*shortHelpString,*longHelpString,clientData);
            Py_END_ALLOW_THREADS
            sipReleaseType(const_cast< ::wxString *>(label),sipType_wxString,labelState);
            sipReleaseType(const_cast< ::wxString *>(shortHelpString),sipType_wxString,shortHelpStringState);
            sipReleaseType(const_cast< ::wxString *>(longHelpString),sipType_wxString,longHelpStringState);
...
sipVariableDef variables_wxToolBar[] = {
    {PropertyVariable, sipName_ToolsCount, &methods_wxToolBar[49], NULL, NULL, NULL},
    {PropertyVariable, sipName_ToolSize, &methods_wxToolBar[47], NULL, NULL, NULL},
    {PropertyVariable, sipName_ToolSeparation, &methods_wxToolBar[45], &methods_wxToolBar[73], NULL, NULL},
    {PropertyVariable, sipName_ToolPacking, &methods_wxToolBar[43], &methods_wxToolBar[72], NULL, NULL},
    {PropertyVariable, sipName_ToolBitmapSize, &methods_wxToolBar[38], &methods_wxToolBar[67], NULL, NULL},
    {PropertyVariable, sipName_Margins, &methods_wxToolBar[37], &methods_wxToolBar[66], NULL, NULL},
};
