...
#include "sipAPI_core.h"
    ...
    bool _wxTreeItemId___neq__(wxTreeItemId* self, const wxTreeItemId* other)
    {
        return *self != *other;
    }
...
PyDoc_STRVAR(doc_wxTreeItemId___neq__, "__neq__(other) -> bool");

extern "C" {static PyObject *meth_wxTreeItemId___neq__(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxTreeItemId___neq__(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = NULL;

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9", &sipSelf, sipType_wxTreeItemId, &sipCpp, sipType_wxTreeItemId, &other))
        {
            bool sipRes = 0;
            int sipIsErr = 0;
        ...
        PyErr_Clear();
        Py_BEGIN_ALLOW_THREADS
        sipRes = _wxTreeItemId___neq__(sipCpp, other);
        Py_END_ALLOW_THREADS
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_TreeItemId, sipName___neq__, NULL);
...
static PyMethodDef methods_wxTreeItemId[] = {
    ...
    {SIP_MLNAME_CAST(sipName___neq__), (PyCFunction)meth_wxTreeItemId___neq__, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeItemId___neq__)}
};
