 ...
 ::wxBitmap sipwxWizardPageSimple::GetBitmap() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[37]),sipPySelf,NULL,sipName_GetBitmap);

    if (!sipMeth)
        return  ::wxWizardPageSimple::GetBitmap();

    extern  ::wxBitmap sipVH__adv_50(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);

    return sipVH__adv_50(sipGILState, 0, sipPySelf, sipMeth);
}
 ...
 ::wxWizardPage* sipwxWizardPageSimple::GetNext() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[38]),sipPySelf,NULL,sipName_GetNext);
 ...
 ::wxWizardPage* sipwxWizardPageSimple::GetPrev() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[39]),sipPySelf,NULL,sipName_GetPrev);
