...
void sipwxHtmlWinTagHandler::SetParser( ::wxHtmlWinParser*parser)
{
    ...
    extern void sipVH__html_53(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxHtmlWinParser*);

    sipVH__html_53(sipGILState, 0, sipPySelf, sipMeth, parser);
}
...
bool sipwxHtmlWinTagHandler::HandleTag(const  ::wxHtmlTag& tag)
{
    ...
    extern bool sipVH__html_16(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxHtmlTag&);

    return sipVH__html_16(sipGILState, 0, sipPySelf, sipMeth, tag);
}
