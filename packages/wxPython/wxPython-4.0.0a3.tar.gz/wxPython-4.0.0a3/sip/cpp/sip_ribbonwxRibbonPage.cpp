...
sipVariableDef variables_wxRibbonPage[] = {
    {PropertyVariable, sipName_MajorAxis, &methods_wxRibbonPage[29], NULL, NULL, NULL},
    {PropertyVariable, sipName_Icon, &methods_wxRibbonPage[27], NULL, NULL, NULL},
};
