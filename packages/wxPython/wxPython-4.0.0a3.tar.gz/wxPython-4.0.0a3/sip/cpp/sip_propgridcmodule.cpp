...
wxString testPGVariantTypeName(const wxPGVariant& var)
{
 ...
 ::wxPropertyGrid* sipVH__propgrid_80(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
...
bool sipVH__propgrid_79(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int page)
{
    bool sipRes = 0;
 ...
 ::wxPropertyGridPage* sipVH__propgrid_78(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int index,const  ::wxString& label,const  ::wxBitmap& bmp, ::wxPropertyGridPage*pageObj)
{
...
void sipVH__propgrid_77(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxPGProperty*p)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "D", p, sipType_wxPGProperty, NULL);
}

 ::wxColour sipVH__propgrid_76(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int index)
{
     ::wxColour sipRes;
 ...
 ::wxString sipVH__propgrid_75(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, const  ::wxColour& col,int index,int argFlags)
{
     ::wxString sipRes;
...
bool sipVH__propgrid_74(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxString*resString)
{
    bool sipRes = 0;
...
void sipVH__propgrid_73(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::size_t first, ::size_t second)
{
...
void sipVH__propgrid_72(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int index)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "i", index);
}

bool sipVH__propgrid_71(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::size_t index,const  ::wxString& str)
{
    bool sipRes = 0;
...
bool sipVH__propgrid_70(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, const  ::wxString& str,int index)
{
    bool sipRes = 0;
 ...
 ::size_t sipVH__propgrid_69(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
     ::size_t sipRes;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "");
 ...
 ::wxString sipVH__propgrid_68(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::size_t index)
{
     ::wxString sipRes;
...
void sipVH__propgrid_67(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, const  ::wxPGVariant& value)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "N", new  ::wxPGVariant(value), sipType_wxPGVariant, NULL);
}

 ::wxPGArrayEditorDialog* sipVH__propgrid_66(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
...
bool sipVH__propgrid_65(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxPropertyGrid*propgrid, ::wxWindow*primary,const  ::wxChar*cbt)
{
    bool sipRes = 0;
...
bool sipVH__propgrid_64(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxWindow*parent, ::wxString& value)
{
    bool sipRes = 0;
...
void sipVH__propgrid_63(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, const  ::wxArrayString& arr, ::wxString*pString,const  ::wxUniChar& delimiter)
{
...
bool sipVH__propgrid_62(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxPropertyGrid*propgrid, ::wxString& value)
{
    bool sipRes = 0;
...
int sipVH__propgrid_61(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int value)
{
    int sipRes = 0;
...
bool sipVH__propgrid_60(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxPGVariant& variant,int number,int argFlags)
{
    bool sipRes = 0;
...
bool sipVH__propgrid_57(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxPGVariant& variant,const  ::wxString& text,int argFlags)
{
    bool sipRes = 0;
...
bool sipVH__propgrid_54(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, const  ::wxPGPropArgCls& id)
{
    bool sipRes = 0;
...
void sipVH__propgrid_52(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int pos,int splitterColumn,int flags)
{
