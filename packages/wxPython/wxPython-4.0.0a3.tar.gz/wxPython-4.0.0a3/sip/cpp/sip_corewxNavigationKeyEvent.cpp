...
static sipEnumMemberDef enummembers_wxNavigationKeyEvent[] = {
    {sipName_FromTab, static_cast<int>( ::wxNavigationKeyEvent::FromTab), 341},
    {sipName_IsBackward, static_cast<int>( ::wxNavigationKeyEvent::IsBackward), 341},
    {sipName_IsForward, static_cast<int>( ::wxNavigationKeyEvent::IsForward), 341},
    {sipName_WinChange, static_cast<int>( ::wxNavigationKeyEvent::WinChange), 341},
};
