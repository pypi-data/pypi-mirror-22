 ...
 ::wxEventCategory sipwxHtmlCellEvent::GetEventCategory() const
{
    ...
    extern  ::wxEventCategory sipVH__html_49(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);

    return sipVH__html_49(sipGILState, 0, sipPySelf, sipMeth);
}
 ...
 ::wxEvent* sipwxHtmlCellEvent::Clone() const
{
    ...
    extern  ::wxEvent* sipVH__html_48(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);

    return sipVH__html_48(sipGILState, 0, sipPySelf, sipMeth);
}
