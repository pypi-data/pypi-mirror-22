...
bool sipwxAnimation::LoadFile(const  ::wxString& name, ::wxAnimationType type)
{
    ...
    extern bool sipVH__adv_36(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxString&, ::wxAnimationType);

    return sipVH__adv_36(sipGILState, 0, sipPySelf, sipMeth, name, type);
}
...
bool sipwxAnimation::Load( ::wxInputStream& stream, ::wxAnimationType type)
{
    ...
    return sipVH__adv_35(sipGILState, 0, sipPySelf, sipMeth, stream, type);
}
 ...
 ::wxImage sipwxAnimation::GetFrame(uint i) const
{
    ...
    extern  ::wxImage sipVH__adv_33(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, uint);

    return sipVH__adv_33(sipGILState, 0, sipPySelf, sipMeth, i);
}
...
int sipwxAnimation::GetDelay(uint i) const
{
    ...
    extern int sipVH__adv_32(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, uint);

    return sipVH__adv_32(sipGILState, 0, sipPySelf, sipMeth, i);
}
...
static sipEncodedTypeDef supers_wxAnimation[] = {{37, 0, 1}};
