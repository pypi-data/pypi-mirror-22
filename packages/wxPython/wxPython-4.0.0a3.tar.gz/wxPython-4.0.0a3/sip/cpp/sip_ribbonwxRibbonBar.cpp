...
sipVariableDef variables_wxRibbonBar[] = {
    {PropertyVariable, sipName_PageCount, &methods_wxRibbonBar[33], NULL, NULL, NULL},
    {PropertyVariable, sipName_ActivePage, &methods_wxRibbonBar[27], &methods_wxRibbonBar[49], NULL, NULL},
};
