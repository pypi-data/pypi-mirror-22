 ...
 ::wxColour sipwxSystemColourProperty::GetColour(int index) const
{
    ...
    extern  ::wxColour sipVH__propgrid_76(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, int);

    return sipVH__propgrid_76(sipGILState, 0, sipPySelf, sipMeth, index);
}
 ...
 ::wxString sipwxSystemColourProperty::ColourToString(const  ::wxColour& col,int index,int argFlags) const
{
    ...
    extern  ::wxString sipVH__propgrid_75(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxColour&,int,int);

    return sipVH__propgrid_75(sipGILState, 0, sipPySelf, sipMeth, col, index, argFlags);
}
...
bool sipwxSystemColourProperty::IntToValue( ::wxPGVariant& variant,int number,int argFlags) const
{
    ...
    extern bool sipVH__propgrid_60(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxPGVariant&,int,int);

    return sipVH__propgrid_60(sipGILState, 0, sipPySelf, sipMeth, variant, number, argFlags);
}
...
int sipwxSystemColourProperty::GetIndexForValue(int value) const
{
    ...
    extern int sipVH__propgrid_61(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, int);

    return sipVH__propgrid_61(sipGILState, 0, sipPySelf, sipMeth, value);
}
