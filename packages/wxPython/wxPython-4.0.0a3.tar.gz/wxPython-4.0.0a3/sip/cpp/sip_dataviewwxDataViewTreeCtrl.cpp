 ...
 ::wxWindow* sipwxDataViewTreeCtrl::GetMainWindowOfCompositeControl()
{
    ...
    extern  ::wxWindow* sipVH__dataview_48(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);
...
void sipwxDataViewTreeCtrl::DoGetPosition(int*x,int*y) const
{
    ...
    sipVH__dataview_49(sipGILState, 0, sipPySelf, sipMeth, x, y);
}
...
void sipwxDataViewTreeCtrl::DoSetSize(int x,int y,int width,int height,int sizeFlags)
{
    ...
    extern void sipVH__dataview_50(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, int,int,int,int,int);

    sipVH__dataview_50(sipGILState, 0, sipPySelf, sipMeth, x, y, width, height, sizeFlags);
}
...
void sipwxDataViewTreeCtrl::DoSetSizeHints(int minW,int minH,int maxW,int maxH,int incW,int incH)
{
    ...
    extern void sipVH__dataview_52(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, int,int,int,int,int,int);

    sipVH__dataview_52(sipGILState, 0, sipPySelf, sipMeth, minW, minH, maxW, maxH, incW, incH);
}
...
void sipwxDataViewTreeCtrl::DoMoveWindow(int x,int y,int width,int height)
{
    ...
    extern void sipVH__dataview_53(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, int,int,int,int);

    sipVH__dataview_53(sipGILState, 0, sipPySelf, sipMeth, x, y, width, height);
}
...
void sipwxDataViewTreeCtrl::DoSetWindowVariant( ::wxWindowVariant variant)
{
    ...
    extern void sipVH__dataview_54(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxWindowVariant);

    sipVH__dataview_54(sipGILState, 0, sipPySelf, sipMeth, variant);
}
 ...
 ::wxBorder sipwxDataViewTreeCtrl::GetDefaultBorder() const
{
    ...
    extern  ::wxBorder sipVH__dataview_55(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);
