 ...
 ::wxString sipwxTipProvider::PreprocessTip(const  ::wxString& tip)
{
    ...
    extern  ::wxString sipVH__adv_28(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxString&);

    return sipVH__adv_28(sipGILState, 0, sipPySelf, sipMeth, tip);
}
