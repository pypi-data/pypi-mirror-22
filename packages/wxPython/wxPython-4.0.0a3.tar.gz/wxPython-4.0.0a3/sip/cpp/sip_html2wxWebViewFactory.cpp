 ...
 ::wxWebView* sipwxWebViewFactory::Create( ::wxWindow*parent, ::wxWindowID id,const  ::wxString& url,const  ::wxPoint& pos,const  ::wxSize& size,long style,const  ::wxString& name)
{
    ...
    extern  ::wxWebView* sipVH__html2_21(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxWindow*, ::wxWindowID,const  ::wxString&,const  ::wxPoint&,const  ::wxSize&,long,const  ::wxString&);

    return sipVH__html2_21(sipGILState, 0, sipPySelf, sipMeth, parent, id, url, pos, size, style, name);
}
 ...
 ::wxWebView* sipwxWebViewFactory::Create()
{
    ...
    extern  ::wxWebView* sipVH__html2_20(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);
