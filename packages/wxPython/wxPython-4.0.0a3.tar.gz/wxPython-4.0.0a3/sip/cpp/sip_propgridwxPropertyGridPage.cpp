...
void sipwxPropertyGridPage::RefreshProperty( ::wxPGProperty*p)
{
    ...
    extern void sipVH__propgrid_77(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxPGProperty*);

    sipVH__propgrid_77(sipGILState, 0, sipPySelf, sipMeth, p);
}
...
void sipwxPropertyGridPage::DoSetSplitterPosition(int pos,int splitterColumn,int flags)
{
    ...
    extern void sipVH__propgrid_52(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, int,int,int);
