...
void sipwxHtmlTagHandler::SetParser( ::wxHtmlParser*parser)
{
    ...
    extern void sipVH__html_17(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxHtmlParser*);

    sipVH__html_17(sipGILState, 0, sipPySelf, sipMeth, parser);
}
