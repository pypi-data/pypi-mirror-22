...
sipVariableDef variables_wxFileCtrl[] = {
    {PropertyVariable, sipName_Wildcard, &methods_wxFileCtrl[30], &methods_wxFileCtrl[44], NULL, NULL},
    {PropertyVariable, sipName_Paths, &methods_wxFileCtrl[29], NULL, NULL, NULL},
    {PropertyVariable, sipName_Path, &methods_wxFileCtrl[28], &methods_wxFileCtrl[43], NULL, NULL},
    {PropertyVariable, sipName_FilterIndex, &methods_wxFileCtrl[26], &methods_wxFileCtrl[42], NULL, NULL},
    {PropertyVariable, sipName_Filenames, &methods_wxFileCtrl[25], NULL, NULL, NULL},
    {PropertyVariable, sipName_Filename, &methods_wxFileCtrl[24], &methods_wxFileCtrl[41], NULL, NULL},
    {PropertyVariable, sipName_Directory, &methods_wxFileCtrl[23], &methods_wxFileCtrl[40], NULL, NULL},
};
