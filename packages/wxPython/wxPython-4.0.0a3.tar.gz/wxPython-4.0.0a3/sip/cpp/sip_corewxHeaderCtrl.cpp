...
sipVariableDef variables_wxHeaderCtrl[] = {
    {PropertyVariable, sipName_ColumnsOrder, &methods_wxHeaderCtrl[27], &methods_wxHeaderCtrl[45], NULL, NULL},
    {PropertyVariable, sipName_ColumnCount, &methods_wxHeaderCtrl[24], &methods_wxHeaderCtrl[44], NULL, NULL},
};
