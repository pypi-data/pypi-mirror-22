...
# GNU (default)
COMPILER_FLAGS = ["-O3", "-fopenmp", "-m64", "-march=native", "-fPIC", "-Wno-maybe-uninitialized", "-Wno-unused-function"]
LINKER_FLAGS = ["-lgomp"]
...
def setup_pepytools():
    ...
    setup(
        ...
        download_url = "https://github.com/andersx/qml/archive/0.2.7.tar.gz",
        url = __url__,
