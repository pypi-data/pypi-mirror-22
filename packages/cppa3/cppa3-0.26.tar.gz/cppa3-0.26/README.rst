...
Currently, five modules are provided:
...
This module provides two functions that convert version 2 documents to the current CPPA3 schema. The inputs to 
these functions are lxml.etree.Element or lxml.etree.ElementTree objects. The output is an lxml.etree.Element.

* *cpp23* converts a v2 CPP
* *cpa23* converts a v3 CPA
...
The current version of this module does not have complete coverage yet only the *cpa23* function has been tested.
...
v0.23  2017-05-10   Unreferenced certificates are not in CPA; bug in trust anchor checks; more tests for ebMS2.
