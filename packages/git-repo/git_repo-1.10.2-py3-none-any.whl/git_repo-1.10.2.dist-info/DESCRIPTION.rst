...
-  on Matrix:
   `#git-repo:matrix.org <https://riot.im/app/#/room/#git-repo:matrix.org>`__
-  on Gitter:
   `git-services/git-repo <https://gitter.im/git-services/git-repo>`__
...
sources <https://github.com/guyzmo/git-repo/blob/devel/git_repo/repo.py#L4,L35>`__).
...
-  [x] add support for handling gists (cf
   `#12 <https://github.com/guyzmo/git-repo/issues/12>`__, cf
...
-  [@jayvdb](https://github.com/jayvdb) —
   `commits <https://github.com/guyzmo/git-repo/commits/devel?author=jayvdb>`__
-  [@kounoike](https://github.com/kounoike) —
   `commits <https://github.com/guyzmo/git-repo/commits/devel?author=kounoike>`__
