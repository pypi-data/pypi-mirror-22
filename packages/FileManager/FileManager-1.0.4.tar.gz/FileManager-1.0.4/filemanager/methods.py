...
def done( elem ):
    ...
    linhas = arq.readlines()   # le linhas da running e exclui
    for i in range(len(linhas)-1):
        if(linhas[i+1]!=elem): # se for diff do elemento
            arq.append(linhas[i+1]) # add novamente
