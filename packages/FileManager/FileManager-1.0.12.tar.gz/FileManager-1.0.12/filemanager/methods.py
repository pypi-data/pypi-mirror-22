...
def initialize():
    ...
    try:
        ...
        print("Ocorreu um erro ao tentar criar pasta")
    # criando arquivo running.txt dentro de "data"
    f = open ('data/running.txt', 'w')
    f.close()
    # criando arquivo done.txt dentro de "data"
...
#inicializa já criando o que vai ser necessario
initialize()