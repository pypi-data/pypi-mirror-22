...
class Endpoints(object):
    ...
    def get_application_messages(self, **params):
        ...
        """
        return self.patch('user/application/%s/messages/' % params.get('application_id'), params=params)
    ...
    def get_application_message(self, **params):
        ...
        """
        return self.patch('user/application/%s/messages/%s/' % (params.get('application_id'), params.get('message_id')), params=params)
