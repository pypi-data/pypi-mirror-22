...
Most importance service of 'was' is making requests to HTTP, REST, RPC and several database engines. And this is mostly useful for fast Server Side Rendering.

The modules related theses features from aquests_.
...
- assets: Directory, Static file like css, js, images. This directory would be mounted for using
