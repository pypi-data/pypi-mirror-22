...
class Test():
    ...
    def test(self,):
        startTime = time.time()
        t = ExcutorMgr(5,"mgr",logable= True,timeout=10)
        
        t.execute(Job(self.test2,2,"job1xx"))
        t.execute(Job(self.test2,20,"job2xx"))
        
        t.execute(Job(self.test2,20,"job3xx"))
        t.execute(Job(self.test2,20,"job4xx"))
        t.execute(Job(self.test2,20,"job5xx"))
        t.execute(Job(self.test2,2,"job6xx"))
        t.execute(Job(self.test2,2,"job7xx"))
        time.sleep(1)
        print t.toString()
        time.sleep(15)

        t.execute(Job(self.test2,20,"job9xx"))
        t.execute(Job(self.test2,20,"job10xx"))
        t.execute(Job(self.test2,2,"job11xx"))
        t.execute(Job(self.test2,2,"job12xx"))
        t.execute(Job(self.test2,2,"job13xx"))
        t.execute(Job(self.test2,2,"job14xx"))
        # t.stop() 
        # t.wait()
