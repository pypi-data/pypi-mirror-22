...
class Current(module.Module):
    ...
    def __init__(self, *args):
        ...
        self.shared.ampd_server_properties.connect('notify::current-song', self.notify_opacity_cb)
        self.running_fader = None
    ...
    def __destroy_cb(self):
        if self.running_fader:
            self.running_fader.cancel()
    ...
    def notify_opacity_cb(self, *args):
        if self.running_fader:
            self.running_fader.cancel()
        self.running_fader = self.fader()
