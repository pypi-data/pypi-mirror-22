...
def run_instrumentations():
    ...
    if CONFIGURATION.enabled:
        ...
        if InstrumentationManager.initial_instrumentation_run is False:
            ...
            from tcell_agent.instrumentation import gunicorn_tcell # noqa
            from tcell_agent.instrumentation import django # noqa
            import tcell_agent.instrumentation.flask.app # noqa
            from tcell_agent.instrumentation import hooks # noqa
