...
from ppg_common.errors.pandora import PandoraHTTPError, PandoraHTTPErrors
...
def handle_response(func):
    def wrapper(self, *args, **kwargs):
        ...
        if 400 <= response.status_code < 500 and body and body.get(
            ...
            if 400 <= body.get('code') < 500:
                raise PandoraHTTPError(
                    PandoraHTTPErrors.error_map[body.get('code')])
