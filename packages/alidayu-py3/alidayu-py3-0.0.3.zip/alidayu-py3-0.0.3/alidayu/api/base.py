...
def sign(secret, parameters):
    ...
    if hasattr(parameters, "items"):
        ...
        parameters = "%s%s%s" % (secret,
                                 ...
                                 secret)
    return hashlib.md5(parameters.encode()).hexdigest().upper()
...
class RestApi(object):
    ...
    def __init__(self, domain='gw.api.taobao.com', port=80):
        ...
        if (alidayu.getDefaultAppInfo()):
            self.__app_key = alidayu.getDefaultAppInfo().appkey
            self.__secret = alidayu.getDefaultAppInfo().secret
    ...
    def set_app_info(self, appinfo):
        # =======================================================================
        # 设置请求的app信息
        # @param appinfo: import alidayu
        #                 appinfo alidayu.appinfo(appkey,secret)
        # =======================================================================
    ...
    def get_application_parameters(self):
        ...
        for key, value in self.__dict__.items():
            if not key.startswith("__") and key not in self.get_multipart_paras() and not key.startswith(
