    ...
    def get_credentials(self, cred_file='client_secret.json'):
        ...
        if not credentials or credentials.invalid:
            try:
                ...
                flow = client.flow_from_clientsecrets('/opt/python/run/venv/lib/python3.4/site-packages/pygsheet/' + cred_file, scope=['https://www.googleapis.com/auth/spreadsheets', 'https://www.googleapis.com/auth/drive'])
