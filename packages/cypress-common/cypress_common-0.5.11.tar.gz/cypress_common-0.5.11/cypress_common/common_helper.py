...
class CypressCommonHelper:
    ...
    def init_pchi():
        ...
        x = np.array([0.001, 0.200, 0.3275, 0.3862, 0.4200, 0.4658, 0.5500, 0.6500, 0.7, 1.0, 1.5, 1.80, 2.00])
        y = np.array([100.0, 99.0, 95.0000, 90.000, 88.000, 58.000, 55.000, 45.000, 0.3, 0.2, 0.1, 0.05, 0.01])
