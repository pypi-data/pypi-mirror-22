...
class CypressCache(CypressBase):
    ...
    def get_task_by_worker_id(self, worker_id):
        ...
        if self.is_key_exists(key):
            ...
            category_ids = task_hash_map["category_ids"]
    ...
    def set_topic_partition_lag(self, topic, partition, consumer_lag):
        """
        set consumer lag for given topic and partition
        :param topic: kafka topic
        :param partition: topic partition
        :param consumer_lag: consumer lag
        :return: 
        """
        return self.set_kv_to_hash(topic, partition, consumer_lag)

    def get_topic_consumer_lag(self, topic):
        """
        :param topic: 
        :return: 
        """
        return self.get_all_by_hash_name(topic)