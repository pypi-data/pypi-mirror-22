...
<success>True</success>
    ...
    def export_orders(self):
        from pcart_cart.models import Order
        # from pcart_messaging.html2text import html2text
        ...
        for order in queryset:
            ...
            orders.append(OrderedDict([
                ...
                ('customer', {
                    ...
                    'addresses': [{
                        'value': text_escape(order.get_shipping_info(plain_text=True)),
                        }],
                    'email': {
...
<success>True</success>
        ...
        queryset.update(export_status='processing')
