...
scp_cmd_multi_try(current_host='10.0.1.155', mode='put', username='you', keyfile='/home/quique/.ssh/bloomdev', local_file='/tmp/test', remote_file='/tmp/test', recursive=False, preserve_times=False, port=22, trys=2)
