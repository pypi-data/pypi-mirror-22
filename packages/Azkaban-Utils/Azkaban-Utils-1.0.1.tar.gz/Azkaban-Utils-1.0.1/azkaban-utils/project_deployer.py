...
def schedule(project):
	for sch in project.schedules:
		...
		azkUtil.execute_a_flow(project_name, flow_name, {})
		#azkUtil.cancel_a_flow_execution(project_name, 2179)
		#azkUtil.fetch_a_flow_execution(project_name, 2179)
		azkUtil.fetch_executions_of_a_flow(project_name, flow_name, 2)
