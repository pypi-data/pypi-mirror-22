...
class NeedsState(object):
  ...
  def __init__(self, curNeedLevel=(), curNeedBracket=(), partIsDamaged=(), curNeedsUnlockLevel=0, numStarsAwarded=0, numStarsForNextUnlock=0):
  ...
  def unpack_from(cls, reader):
    ...
    return cls(_curNeedLevel, _curNeedBracket, _partIsDamaged, _curNeedsUnlockLevel, _numStarsAwarded, _numStarsForNextUnlock)
  ...
  def __eq__(self, other):
    if type(self) is type(other):
      return (self._curNeedLevel == other._curNeedLevel and
        ...
        self._numStarsForNextUnlock == other._numStarsForNextUnlock)
    else:
      return NotImplemented
  ...
  def __str__(self):
    return '{type}(curNeedLevel={curNeedLevel}, curNeedBracket={curNeedBracket}, partIsDamaged={partIsDamaged}, curNeedsUnlockLevel={curNeedsUnlockLevel}, numStarsAwarded={numStarsAwarded}, numStarsForNextUnlock={numStarsForNextUnlock})'.format(
      type=type(self).__name__,
...
class AllNeedsMet(object):
  ...
  def unlockLevelCompleted(self, value):
    self._unlockLevelCompleted = msgbuffers.validate_integer(
      'AllNeedsMet.unlockLevelCompleted', value, -2147483648, 2147483647)
  ...
  def starsRequiredForNextUnlock(self, value):
    self._starsRequiredForNextUnlock = msgbuffers.validate_integer(
      'AllNeedsMet.starsRequiredForNextUnlock', value, -2147483648, 2147483647)
  ...
  @classmethod
  def unpack(cls, buffer):
    "Reads a new AllNeedsMet from the given buffer."
    reader = msgbuffers.BinaryReader(buffer)
    value = cls.unpack_from(reader)
    if reader.tell() != len(reader):
      raise msgbuffers.ReadError(
        ('AllNeedsMet.unpack received a buffer of length {length}, ' +
        'but only {position} bytes were read.').format(
        length=len(reader), position=reader.tell()))
    return value
  ...
  @classmethod
  def unpack_from(cls, reader):
    "Reads a new AllNeedsMet from the given BinaryReader."
  ...
  def pack(self):
    "Writes the current AllNeedsMet, returning bytes."
    writer = msgbuffers.BinaryWriter()
    self.pack_to(writer)
    return writer.dumps()

  def pack_to(self, writer):
    "Writes the current AllNeedsMet to the given BinaryWriter."
...
Anki.Cozmo.ExternalInterface.AllNeedsMet = AllNeedsMet
del AllNeedsMet
...
class MessageEngineToGame(object):
  ...
  class Tag(object):
    ...
    ObjectAvailable                 = 0xb  # Anki.Cozmo.ObjectAvailable
    ...
    ObjectUnavailable               = 0x28 # Anki.Cozmo.ExternalInterface.ObjectUnavailable
    FeatureToggles                  = 0x29 # Anki.Cozmo.ExternalInterface.FeatureToggles
    GoingToSleep                    = 0x2a # Anki.Cozmo.ExternalInterface.GoingToSleep
    EngineLoadingDataStatus         = 0x2b # Anki.Cozmo.ExternalInterface.EngineLoadingDataStatus
    CurrentCameraParams             = 0x2c # Anki.Cozmo.ExternalInterface.CurrentCameraParams
    PerRobotSettings                = 0x2d # Anki.Cozmo.ExternalInterface.PerRobotSettings
    RobotState                      = 0x2e # Anki.Cozmo.ExternalInterface.RobotState
    RobotDelocalized                = 0x2f # Anki.Cozmo.ExternalInterface.RobotDelocalized
    RobotPoked                      = 0x30 # Anki.Cozmo.ExternalInterface.RobotPoked
    RobotStopped                    = 0x31 # Anki.Cozmo.ExternalInterface.RobotStopped
    RobotOffTreadsStateChanged      = 0x32 # Anki.Cozmo.ExternalInterface.RobotOffTreadsStateChanged
    RobotCliffEventFinished         = 0x33 # Anki.Cozmo.ExternalInterface.RobotCliffEventFinished
    RobotOnChargerPlatformEvent     = 0x34 # Anki.Cozmo.ExternalInterface.RobotOnChargerPlatformEvent
    RobotHiccupsChanged             = 0x35 # Anki.Cozmo.ExternalInterface.RobotHiccupsChanged
    ...
    RobotDeletedFixedCustomObjects  = 0x46 # Anki.Cozmo.ExternalInterface.RobotDeletedFixedCustomObjects
    RobotDeletedCustomMarkerObjects = 0x47 # Anki.Cozmo.ExternalInterface.RobotDeletedCustomMarkerObjects
    ...
    LocatedObjectStates             = 0x4b # Anki.Cozmo.ExternalInterface.LocatedObjectStates
    ConnectedObjectStates           = 0x4c # Anki.Cozmo.ExternalInterface.ConnectedObjectStates
    RobotReadToolCode               = 0x4d # Anki.Cozmo.ExternalInterface.RobotReadToolCode
    FaceEnrollmentCompleted         = 0x4e # Anki.Cozmo.ExternalInterface.FaceEnrollmentCompleted
    RobotErasedEnrolledFace         = 0x4f # Anki.Cozmo.ExternalInterface.RobotErasedEnrolledFace
    RobotErasedAllEnrolledFaces     = 0x50 # Anki.Cozmo.ExternalInterface.RobotErasedAllEnrolledFaces
    RobotCompletedFactoryDotTest    = 0x51 # Anki.Cozmo.ExternalInterface.RobotCompletedFactoryDotTest
    RobotCompletedAction            = 0x52 # Anki.Cozmo.ExternalInterface.RobotCompletedAction
    BlockPickedUp                   = 0x53 # Anki.Cozmo.ExternalInterface.BlockPickedUp
    BlockPlaced                     = 0x54 # Anki.Cozmo.ExternalInterface.BlockPlaced
    AnimationAvailable              = 0x55 # Anki.Cozmo.ExternalInterface.AnimationAvailable
    AnimationGroupAvailable         = 0x56 # Anki.Cozmo.ExternalInterface.AnimationGroupAvailable
    AnimationAborted                = 0x57 # Anki.Cozmo.ExternalInterface.AnimationAborted
    AnimationEvent                  = 0x58 # Anki.Cozmo.ExternalInterface.AnimationEvent
    MoodState                       = 0x59 # Anki.Cozmo.ExternalInterface.MoodState
    NeedsState                      = 0x5a # Anki.Cozmo.ExternalInterface.NeedsState
    NeedsPauseState                 = 0x5b # Anki.Cozmo.ExternalInterface.NeedsPauseState
    AllNeedsMet                     = 0x5c # Anki.Cozmo.ExternalInterface.AllNeedsMet
    RequestSetUnlockResult          = 0x5d # Anki.Cozmo.ExternalInterface.RequestSetUnlockResult
    UnlockStatus                    = 0x5e # Anki.Cozmo.ExternalInterface.UnlockStatus
    UnlockedDefaults                = 0x5f # Anki.Cozmo.ExternalInterface.UnlockedDefaults
    InitDebugConsoleVarMessage      = 0x60 # Anki.Cozmo.ExternalInterface.InitDebugConsoleVarMessage
    JsonDasLogMessage               = 0x61 # Anki.Cozmo.ExternalInterface.JsonDasLogMessage
    JsonDasLogAllSentMessage        = 0x62 # Anki.Cozmo.ExternalInterface.JsonDasLogAllSentMessage
    VerifyDebugConsoleFuncMessage   = 0x63 # Anki.Cozmo.ExternalInterface.VerifyDebugConsoleFuncMessage
    VerifyDebugConsoleVarMessage    = 0x64 # Anki.Cozmo.ExternalInterface.VerifyDebugConsoleVarMessage
    DebugAppendConsoleLogLine       = 0x65 # Anki.Cozmo.ExternalInterface.DebugAppendConsoleLogLine
    LatencyMessage                  = 0x66 # Anki.Cozmo.ExternalInterface.LatencyMessage
    DeviceDataMessage               = 0x67 # Anki.Cozmo.ExternalInterface.DeviceDataMessage
    BlockTapFilterStatus            = 0x68 # Anki.Cozmo.ExternalInterface.BlockTapFilterStatus
    UpdateEngineState               = 0x69 # Anki.Cozmo.ExternalInterface.UpdateEngineState
    EngineErrorCodeMessage          = 0x6a # Anki.Cozmo.ExternalInterface.EngineErrorCodeMessage
    CubeLightsStateTransition       = 0x6b # Anki.Cozmo.ExternalInterface.CubeLightsStateTransition
    BlockPoolDataMessage            = 0x6c # Anki.Cozmo.ExternalInterface.BlockPoolDataMessage
    NVStorageOpResult               = 0x6d # Anki.Cozmo.ExternalInterface.NVStorageOpResult
    FirmwareUpdateProgress          = 0x6e # Anki.Cozmo.ExternalInterface.FirmwareUpdateProgress
    FirmwareUpdateComplete          = 0x6f # Anki.Cozmo.ExternalInterface.FirmwareUpdateComplete
    RequestGameStart                = 0x70 # Anki.Cozmo.ExternalInterface.RequestGameStart
    HardSparkEndedByEngine          = 0x71 # Anki.Cozmo.ExternalInterface.HardSparkEndedByEngine
    SdkConnectionStatus             = 0x72 # Anki.Cozmo.ExternalInterface.SdkConnectionStatus
    SdkStatus                       = 0x73 # Anki.Cozmo.ExternalInterface.SdkStatus
    BehaviorTransition              = 0x74 # Anki.Cozmo.ExternalInterface.BehaviorTransition
    ReactionTriggerTransition       = 0x75 # Anki.Cozmo.ExternalInterface.ReactionTriggerTransition
    RespondEnabledBehaviorList      = 0x76 # Anki.Cozmo.ExternalInterface.RespondEnabledBehaviorList
    BehaviorObjectiveAchieved       = 0x77 # Anki.Cozmo.ExternalInterface.BehaviorObjectiveAchieved
    BuildPyramidPreReqsChanged      = 0x78 # Anki.Cozmo.ExternalInterface.BuildPyramidPreReqsChanged
    OnboardingState                 = 0x79 # Anki.Cozmo.ExternalInterface.OnboardingState
    MemoryMapMessageBegin           = 0x7a # Anki.Cozmo.ExternalInterface.MemoryMapMessageBegin
    MemoryMapMessage                = 0x7b # Anki.Cozmo.ExternalInterface.MemoryMapMessage
    MemoryMapMessageEnd             = 0x7c # Anki.Cozmo.ExternalInterface.MemoryMapMessageEnd
    SupportInfo                     = 0x7d # Anki.Cozmo.ExternalInterface.SupportInfo
    EndOfMessage                    = 0x7e # Anki.Cozmo.ExternalInterface.EndOfMessage
  ...
  @property
  def AllNeedsMet(self):
    "Anki.Cozmo.ExternalInterface.AllNeedsMet AllNeedsMet union property."
    msgbuffers.safety_check_tag('AllNeedsMet', self._tag, self.Tag.AllNeedsMet, self._tags_by_value)
    return self._data

  @AllNeedsMet.setter
  def AllNeedsMet(self, value):
    self._data = msgbuffers.validate_object(
      'MessageEngineToGame.AllNeedsMet', value, Anki.Cozmo.ExternalInterface.AllNeedsMet)
    self._tag = self.Tag.AllNeedsMet
  ...
  _tags_by_name = dict(
    ...
    ObjectUnavailable=40,
    FeatureToggles=41,
    GoingToSleep=42,
    EngineLoadingDataStatus=43,
    CurrentCameraParams=44,
    PerRobotSettings=45,
    RobotState=46,
    RobotDelocalized=47,
    RobotPoked=48,
    RobotStopped=49,
    RobotOffTreadsStateChanged=50,
    RobotCliffEventFinished=51,
    RobotOnChargerPlatformEvent=52,
    RobotHiccupsChanged=53,
    ChargerEvent=54,
    ...
    RobotDeletedFixedCustomObjects=70,
    RobotDeletedCustomMarkerObjects=71,
    CreatedFixedCustomObject=72,
    DefinedCustomObject=73,
    RobotMarkedObjectPoseUnknown=74,
    LocatedObjectStates=75,
    ConnectedObjectStates=76,
    RobotReadToolCode=77,
    FaceEnrollmentCompleted=78,
    RobotErasedEnrolledFace=79,
    RobotErasedAllEnrolledFaces=80,
    RobotCompletedFactoryDotTest=81,
    RobotCompletedAction=82,
    BlockPickedUp=83,
    BlockPlaced=84,
    AnimationAvailable=85,
    AnimationGroupAvailable=86,
    AnimationAborted=87,
    AnimationEvent=88,
    MoodState=89,
    NeedsState=90,
    NeedsPauseState=91,
    AllNeedsMet=92,
    RequestSetUnlockResult=93,
    UnlockStatus=94,
    UnlockedDefaults=95,
    InitDebugConsoleVarMessage=96,
    JsonDasLogMessage=97,
    JsonDasLogAllSentMessage=98,
    VerifyDebugConsoleFuncMessage=99,
    VerifyDebugConsoleVarMessage=100,
    DebugAppendConsoleLogLine=101,
    LatencyMessage=102,
    DeviceDataMessage=103,
    BlockTapFilterStatus=104,
    UpdateEngineState=105,
    EngineErrorCodeMessage=106,
    CubeLightsStateTransition=107,
    BlockPoolDataMessage=108,
    NVStorageOpResult=109,
    FirmwareUpdateProgress=110,
    FirmwareUpdateComplete=111,
    RequestGameStart=112,
    HardSparkEndedByEngine=113,
    SdkConnectionStatus=114,
    SdkStatus=115,
    BehaviorTransition=116,
    ReactionTriggerTransition=117,
    RespondEnabledBehaviorList=118,
    BehaviorObjectiveAchieved=119,
    BuildPyramidPreReqsChanged=120,
    OnboardingState=121,
    MemoryMapMessageBegin=122,
    MemoryMapMessage=123,
    MemoryMapMessageEnd=124,
    SupportInfo=125,
    EndOfMessage=126,
  )
  ...
  _tags_by_value[11] = 'ObjectAvailable'
  ...
  _tags_by_value[40] = 'ObjectUnavailable'
  _tags_by_value[41] = 'FeatureToggles'
  _tags_by_value[42] = 'GoingToSleep'
  _tags_by_value[43] = 'EngineLoadingDataStatus'
  _tags_by_value[44] = 'CurrentCameraParams'
  _tags_by_value[45] = 'PerRobotSettings'
  _tags_by_value[46] = 'RobotState'
  _tags_by_value[47] = 'RobotDelocalized'
  _tags_by_value[48] = 'RobotPoked'
  _tags_by_value[49] = 'RobotStopped'
  _tags_by_value[50] = 'RobotOffTreadsStateChanged'
  _tags_by_value[51] = 'RobotCliffEventFinished'
  _tags_by_value[52] = 'RobotOnChargerPlatformEvent'
  _tags_by_value[53] = 'RobotHiccupsChanged'
  ...
  _tags_by_value[70] = 'RobotDeletedFixedCustomObjects'
  _tags_by_value[71] = 'RobotDeletedCustomMarkerObjects'
  ...
  _tags_by_value[75] = 'LocatedObjectStates'
  _tags_by_value[76] = 'ConnectedObjectStates'
  _tags_by_value[77] = 'RobotReadToolCode'
  _tags_by_value[78] = 'FaceEnrollmentCompleted'
  _tags_by_value[79] = 'RobotErasedEnrolledFace'
  _tags_by_value[80] = 'RobotErasedAllEnrolledFaces'
  _tags_by_value[81] = 'RobotCompletedFactoryDotTest'
  _tags_by_value[82] = 'RobotCompletedAction'
  _tags_by_value[83] = 'BlockPickedUp'
  _tags_by_value[84] = 'BlockPlaced'
  _tags_by_value[85] = 'AnimationAvailable'
  _tags_by_value[86] = 'AnimationGroupAvailable'
  _tags_by_value[87] = 'AnimationAborted'
  _tags_by_value[88] = 'AnimationEvent'
  _tags_by_value[89] = 'MoodState'
  _tags_by_value[90] = 'NeedsState'
  _tags_by_value[91] = 'NeedsPauseState'
  _tags_by_value[92] = 'AllNeedsMet'
  _tags_by_value[93] = 'RequestSetUnlockResult'
  _tags_by_value[94] = 'UnlockStatus'
  _tags_by_value[95] = 'UnlockedDefaults'
  _tags_by_value[96] = 'InitDebugConsoleVarMessage'
  _tags_by_value[97] = 'JsonDasLogMessage'
  _tags_by_value[98] = 'JsonDasLogAllSentMessage'
  _tags_by_value[99] = 'VerifyDebugConsoleFuncMessage'
  _tags_by_value[100] = 'VerifyDebugConsoleVarMessage'
  _tags_by_value[101] = 'DebugAppendConsoleLogLine'
  _tags_by_value[102] = 'LatencyMessage'
  _tags_by_value[103] = 'DeviceDataMessage'
  _tags_by_value[104] = 'BlockTapFilterStatus'
  _tags_by_value[105] = 'UpdateEngineState'
  _tags_by_value[106] = 'EngineErrorCodeMessage'
  _tags_by_value[107] = 'CubeLightsStateTransition'
  _tags_by_value[108] = 'BlockPoolDataMessage'
  _tags_by_value[109] = 'NVStorageOpResult'
  _tags_by_value[110] = 'FirmwareUpdateProgress'
  _tags_by_value[111] = 'FirmwareUpdateComplete'
  _tags_by_value[112] = 'RequestGameStart'
  _tags_by_value[113] = 'HardSparkEndedByEngine'
  _tags_by_value[114] = 'SdkConnectionStatus'
  _tags_by_value[115] = 'SdkStatus'
  _tags_by_value[116] = 'BehaviorTransition'
  _tags_by_value[117] = 'ReactionTriggerTransition'
  _tags_by_value[118] = 'RespondEnabledBehaviorList'
  _tags_by_value[119] = 'BehaviorObjectiveAchieved'
  _tags_by_value[120] = 'BuildPyramidPreReqsChanged'
  _tags_by_value[121] = 'OnboardingState'
  _tags_by_value[122] = 'MemoryMapMessageBegin'
  _tags_by_value[123] = 'MemoryMapMessage'
  _tags_by_value[124] = 'MemoryMapMessageEnd'
  _tags_by_value[125] = 'SupportInfo'
  _tags_by_value[126] = 'EndOfMessage'
  ...
  _tag_unpack_methods[11] = lambda reader: reader.read_object(Anki.Cozmo.ObjectAvailable.unpack_from)
  ...
  _tag_unpack_methods[40] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ObjectUnavailable.unpack_from)
  _tag_unpack_methods[41] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.FeatureToggles.unpack_from)
  _tag_unpack_methods[42] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.GoingToSleep.unpack_from)
  _tag_unpack_methods[43] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EngineLoadingDataStatus.unpack_from)
  _tag_unpack_methods[44] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.CurrentCameraParams.unpack_from)
  _tag_unpack_methods[45] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.PerRobotSettings.unpack_from)
  _tag_unpack_methods[46] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotState.unpack_from)
  _tag_unpack_methods[47] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotDelocalized.unpack_from)
  _tag_unpack_methods[48] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotPoked.unpack_from)
  _tag_unpack_methods[49] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotStopped.unpack_from)
  _tag_unpack_methods[50] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotOffTreadsStateChanged.unpack_from)
  _tag_unpack_methods[51] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotCliffEventFinished.unpack_from)
  _tag_unpack_methods[52] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotOnChargerPlatformEvent.unpack_from)
  _tag_unpack_methods[53] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotHiccupsChanged.unpack_from)
  ...
  _tag_unpack_methods[70] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotDeletedFixedCustomObjects.unpack_from)
  _tag_unpack_methods[71] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotDeletedCustomMarkerObjects.unpack_from)
  ...
  _tag_unpack_methods[75] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.LocatedObjectStates.unpack_from)
  _tag_unpack_methods[76] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ConnectedObjectStates.unpack_from)
  _tag_unpack_methods[77] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotReadToolCode.unpack_from)
  _tag_unpack_methods[78] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.FaceEnrollmentCompleted.unpack_from)
  _tag_unpack_methods[79] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotErasedEnrolledFace.unpack_from)
  _tag_unpack_methods[80] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotErasedAllEnrolledFaces.unpack_from)
  _tag_unpack_methods[81] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotCompletedFactoryDotTest.unpack_from)
  _tag_unpack_methods[82] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotCompletedAction.unpack_from)
  _tag_unpack_methods[83] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BlockPickedUp.unpack_from)
  _tag_unpack_methods[84] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BlockPlaced.unpack_from)
  _tag_unpack_methods[85] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.AnimationAvailable.unpack_from)
  _tag_unpack_methods[86] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.AnimationGroupAvailable.unpack_from)
  _tag_unpack_methods[87] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.AnimationAborted.unpack_from)
  _tag_unpack_methods[88] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.AnimationEvent.unpack_from)
  _tag_unpack_methods[89] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.MoodState.unpack_from)
  _tag_unpack_methods[90] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.NeedsState.unpack_from)
  _tag_unpack_methods[91] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.NeedsPauseState.unpack_from)
  _tag_unpack_methods[92] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.AllNeedsMet.unpack_from)
  _tag_unpack_methods[93] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestSetUnlockResult.unpack_from)
  _tag_unpack_methods[94] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.UnlockStatus.unpack_from)
  _tag_unpack_methods[95] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.UnlockedDefaults.unpack_from)
  _tag_unpack_methods[96] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.InitDebugConsoleVarMessage.unpack_from)
  _tag_unpack_methods[97] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.JsonDasLogMessage.unpack_from)
  _tag_unpack_methods[98] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.JsonDasLogAllSentMessage.unpack_from)
  _tag_unpack_methods[99] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.VerifyDebugConsoleFuncMessage.unpack_from)
  _tag_unpack_methods[100] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.VerifyDebugConsoleVarMessage.unpack_from)
  _tag_unpack_methods[101] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DebugAppendConsoleLogLine.unpack_from)
  _tag_unpack_methods[102] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.LatencyMessage.unpack_from)
  _tag_unpack_methods[103] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DeviceDataMessage.unpack_from)
  _tag_unpack_methods[104] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BlockTapFilterStatus.unpack_from)
  _tag_unpack_methods[105] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.UpdateEngineState.unpack_from)
  _tag_unpack_methods[106] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EngineErrorCodeMessage.unpack_from)
  _tag_unpack_methods[107] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.CubeLightsStateTransition.unpack_from)
  _tag_unpack_methods[108] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BlockPoolDataMessage.unpack_from)
  _tag_unpack_methods[109] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.NVStorageOpResult.unpack_from)
  _tag_unpack_methods[110] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.FirmwareUpdateProgress.unpack_from)
  _tag_unpack_methods[111] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.FirmwareUpdateComplete.unpack_from)
  _tag_unpack_methods[112] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestGameStart.unpack_from)
  _tag_unpack_methods[113] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.HardSparkEndedByEngine.unpack_from)
  _tag_unpack_methods[114] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SdkConnectionStatus.unpack_from)
  _tag_unpack_methods[115] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SdkStatus.unpack_from)
  _tag_unpack_methods[116] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BehaviorTransition.unpack_from)
  _tag_unpack_methods[117] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ReactionTriggerTransition.unpack_from)
  _tag_unpack_methods[118] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RespondEnabledBehaviorList.unpack_from)
  _tag_unpack_methods[119] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BehaviorObjectiveAchieved.unpack_from)
  _tag_unpack_methods[120] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BuildPyramidPreReqsChanged.unpack_from)
  _tag_unpack_methods[121] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.OnboardingState.unpack_from)
  _tag_unpack_methods[122] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.MemoryMapMessageBegin.unpack_from)
  _tag_unpack_methods[123] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.MemoryMapMessage.unpack_from)
  _tag_unpack_methods[124] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.MemoryMapMessageEnd.unpack_from)
  _tag_unpack_methods[125] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SupportInfo.unpack_from)
  _tag_unpack_methods[126] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EndOfMessage.unpack_from)
  ...
  _type_by_tag_value[11] = lambda : Anki.Cozmo.ObjectAvailable
  ...
  _type_by_tag_value[40] = lambda : Anki.Cozmo.ExternalInterface.ObjectUnavailable
  _type_by_tag_value[41] = lambda : Anki.Cozmo.ExternalInterface.FeatureToggles
  _type_by_tag_value[42] = lambda : Anki.Cozmo.ExternalInterface.GoingToSleep
  _type_by_tag_value[43] = lambda : Anki.Cozmo.ExternalInterface.EngineLoadingDataStatus
  _type_by_tag_value[44] = lambda : Anki.Cozmo.ExternalInterface.CurrentCameraParams
  _type_by_tag_value[45] = lambda : Anki.Cozmo.ExternalInterface.PerRobotSettings
  _type_by_tag_value[46] = lambda : Anki.Cozmo.ExternalInterface.RobotState
  _type_by_tag_value[47] = lambda : Anki.Cozmo.ExternalInterface.RobotDelocalized
  _type_by_tag_value[48] = lambda : Anki.Cozmo.ExternalInterface.RobotPoked
  _type_by_tag_value[49] = lambda : Anki.Cozmo.ExternalInterface.RobotStopped
  _type_by_tag_value[50] = lambda : Anki.Cozmo.ExternalInterface.RobotOffTreadsStateChanged
  _type_by_tag_value[51] = lambda : Anki.Cozmo.ExternalInterface.RobotCliffEventFinished
  _type_by_tag_value[52] = lambda : Anki.Cozmo.ExternalInterface.RobotOnChargerPlatformEvent
  _type_by_tag_value[53] = lambda : Anki.Cozmo.ExternalInterface.RobotHiccupsChanged
  ...
  _type_by_tag_value[70] = lambda : Anki.Cozmo.ExternalInterface.RobotDeletedFixedCustomObjects
  _type_by_tag_value[71] = lambda : Anki.Cozmo.ExternalInterface.RobotDeletedCustomMarkerObjects
  ...
  _type_by_tag_value[75] = lambda : Anki.Cozmo.ExternalInterface.LocatedObjectStates
  _type_by_tag_value[76] = lambda : Anki.Cozmo.ExternalInterface.ConnectedObjectStates
  _type_by_tag_value[77] = lambda : Anki.Cozmo.ExternalInterface.RobotReadToolCode
  _type_by_tag_value[78] = lambda : Anki.Cozmo.ExternalInterface.FaceEnrollmentCompleted
  _type_by_tag_value[79] = lambda : Anki.Cozmo.ExternalInterface.RobotErasedEnrolledFace
  _type_by_tag_value[80] = lambda : Anki.Cozmo.ExternalInterface.RobotErasedAllEnrolledFaces
  _type_by_tag_value[81] = lambda : Anki.Cozmo.ExternalInterface.RobotCompletedFactoryDotTest
  _type_by_tag_value[82] = lambda : Anki.Cozmo.ExternalInterface.RobotCompletedAction
  _type_by_tag_value[83] = lambda : Anki.Cozmo.ExternalInterface.BlockPickedUp
  _type_by_tag_value[84] = lambda : Anki.Cozmo.ExternalInterface.BlockPlaced
  _type_by_tag_value[85] = lambda : Anki.Cozmo.ExternalInterface.AnimationAvailable
  _type_by_tag_value[86] = lambda : Anki.Cozmo.ExternalInterface.AnimationGroupAvailable
  _type_by_tag_value[87] = lambda : Anki.Cozmo.ExternalInterface.AnimationAborted
  _type_by_tag_value[88] = lambda : Anki.Cozmo.ExternalInterface.AnimationEvent
  _type_by_tag_value[89] = lambda : Anki.Cozmo.ExternalInterface.MoodState
  _type_by_tag_value[90] = lambda : Anki.Cozmo.ExternalInterface.NeedsState
  _type_by_tag_value[91] = lambda : Anki.Cozmo.ExternalInterface.NeedsPauseState
  _type_by_tag_value[92] = lambda : Anki.Cozmo.ExternalInterface.AllNeedsMet
  _type_by_tag_value[93] = lambda : Anki.Cozmo.ExternalInterface.RequestSetUnlockResult
  _type_by_tag_value[94] = lambda : Anki.Cozmo.ExternalInterface.UnlockStatus
  _type_by_tag_value[95] = lambda : Anki.Cozmo.ExternalInterface.UnlockedDefaults
  _type_by_tag_value[96] = lambda : Anki.Cozmo.ExternalInterface.InitDebugConsoleVarMessage
  _type_by_tag_value[97] = lambda : Anki.Cozmo.ExternalInterface.JsonDasLogMessage
  _type_by_tag_value[98] = lambda : Anki.Cozmo.ExternalInterface.JsonDasLogAllSentMessage
  _type_by_tag_value[99] = lambda : Anki.Cozmo.ExternalInterface.VerifyDebugConsoleFuncMessage
  _type_by_tag_value[100] = lambda : Anki.Cozmo.ExternalInterface.VerifyDebugConsoleVarMessage
  _type_by_tag_value[101] = lambda : Anki.Cozmo.ExternalInterface.DebugAppendConsoleLogLine
  _type_by_tag_value[102] = lambda : Anki.Cozmo.ExternalInterface.LatencyMessage
  _type_by_tag_value[103] = lambda : Anki.Cozmo.ExternalInterface.DeviceDataMessage
  _type_by_tag_value[104] = lambda : Anki.Cozmo.ExternalInterface.BlockTapFilterStatus
  _type_by_tag_value[105] = lambda : Anki.Cozmo.ExternalInterface.UpdateEngineState
  _type_by_tag_value[106] = lambda : Anki.Cozmo.ExternalInterface.EngineErrorCodeMessage
  _type_by_tag_value[107] = lambda : Anki.Cozmo.ExternalInterface.CubeLightsStateTransition
  _type_by_tag_value[108] = lambda : Anki.Cozmo.ExternalInterface.BlockPoolDataMessage
  _type_by_tag_value[109] = lambda : Anki.Cozmo.ExternalInterface.NVStorageOpResult
  _type_by_tag_value[110] = lambda : Anki.Cozmo.ExternalInterface.FirmwareUpdateProgress
  _type_by_tag_value[111] = lambda : Anki.Cozmo.ExternalInterface.FirmwareUpdateComplete
  _type_by_tag_value[112] = lambda : Anki.Cozmo.ExternalInterface.RequestGameStart
  _type_by_tag_value[113] = lambda : Anki.Cozmo.ExternalInterface.HardSparkEndedByEngine
  _type_by_tag_value[114] = lambda : Anki.Cozmo.ExternalInterface.SdkConnectionStatus
  _type_by_tag_value[115] = lambda : Anki.Cozmo.ExternalInterface.SdkStatus
  _type_by_tag_value[116] = lambda : Anki.Cozmo.ExternalInterface.BehaviorTransition
  _type_by_tag_value[117] = lambda : Anki.Cozmo.ExternalInterface.ReactionTriggerTransition
  _type_by_tag_value[118] = lambda : Anki.Cozmo.ExternalInterface.RespondEnabledBehaviorList
  _type_by_tag_value[119] = lambda : Anki.Cozmo.ExternalInterface.BehaviorObjectiveAchieved
  _type_by_tag_value[120] = lambda : Anki.Cozmo.ExternalInterface.BuildPyramidPreReqsChanged
  _type_by_tag_value[121] = lambda : Anki.Cozmo.ExternalInterface.OnboardingState
  _type_by_tag_value[122] = lambda : Anki.Cozmo.ExternalInterface.MemoryMapMessageBegin
  _type_by_tag_value[123] = lambda : Anki.Cozmo.ExternalInterface.MemoryMapMessage
  _type_by_tag_value[124] = lambda : Anki.Cozmo.ExternalInterface.MemoryMapMessageEnd
  _type_by_tag_value[125] = lambda : Anki.Cozmo.ExternalInterface.SupportInfo
  _type_by_tag_value[126] = lambda : Anki.Cozmo.ExternalInterface.EndOfMessage
