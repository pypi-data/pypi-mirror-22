...
class RegisterNeedsActionCompleted(object):
  ...
  def __init__(self, actionCompleted=Anki.Cozmo.NeedsActionId.RepairHead):
...
class MessageGameToEngine(object):
  ...
  class Tag(object):
    ...
    DeleteCustomMarkerObjects               = 0x74 # Anki.Cozmo.ExternalInterface.DeleteCustomMarkerObjects
    DeleteFixedCustomObjects                = 0x75 # Anki.Cozmo.ExternalInterface.DeleteFixedCustomObjects
    UndefineAllCustomMarkerObjects          = 0x76 # Anki.Cozmo.ExternalInterface.UndefineAllCustomMarkerObjects
    ...
    VisionWhileMoving                       = 0x7b # Anki.Cozmo.ExternalInterface.VisionWhileMoving
    SetFaceToEnroll                         = 0x7c # Anki.Cozmo.ExternalInterface.SetFaceToEnroll
    CancelFaceEnrollment                    = 0x7d # Anki.Cozmo.ExternalInterface.CancelFaceEnrollment
    EraseEnrolledFaceByID                   = 0x7e # Anki.Cozmo.ExternalInterface.EraseEnrolledFaceByID
    EraseAllEnrolledFaces                   = 0x7f # Anki.Cozmo.ExternalInterface.EraseAllEnrolledFaces
    EnableVisionMode                        = 0x80 # Anki.Cozmo.ExternalInterface.EnableVisionMode
    UpdateEnrolledFaceByID                  = 0x81 # Anki.Cozmo.ExternalInterface.UpdateEnrolledFaceByID
    VisionRunMode                           = 0x82 # Anki.Cozmo.ExternalInterface.VisionRunMode
    SaveFaceAlbumToFile                     = 0x83 # Anki.Cozmo.ExternalInterface.SaveFaceAlbumToFile
    LoadFaceAlbumFromFile                   = 0x84 # Anki.Cozmo.ExternalInterface.LoadFaceAlbumFromFile
    SetMemoryMapRenderEnabled               = 0x85 # Anki.Cozmo.ExternalInterface.SetMemoryMapRenderEnabled
    SetMemoryMapBroadcastFrequency_sec      = 0x86 # Anki.Cozmo.ExternalInterface.SetMemoryMapBroadcastFrequency_sec
    ActivateBehaviorChooser                 = 0x87 # Anki.Cozmo.ExternalInterface.ActivateBehaviorChooser
    ExecuteBehaviorByExecutableType         = 0x88 # Anki.Cozmo.ExternalInterface.ExecuteBehaviorByExecutableType
    ExecuteBehaviorByName                   = 0x89 # Anki.Cozmo.ExternalInterface.ExecuteBehaviorByName
    SetLiftLoadTestAsRunnable               = 0x8a # Anki.Cozmo.ExternalInterface.SetLiftLoadTestAsRunnable
    BehaviorManagerMessage                  = 0x8b # Anki.Cozmo.ExternalInterface.BehaviorManagerMessage
    AbortPath                               = 0x8c # Anki.Cozmo.ExternalInterface.AbortPath
    AbortAll                                = 0x8d # Anki.Cozmo.ExternalInterface.AbortAll
    StartTestMode                           = 0x8e # Anki.Cozmo.ExternalInterface.StartTestMode
    RequestEnabledBehaviorList              = 0x8f # Anki.Cozmo.ExternalInterface.RequestEnabledBehaviorList
    DisableReactionsWithLock                = 0x90 # Anki.Cozmo.ExternalInterface.DisableReactionsWithLock
    RemoveDisableReactionsLock              = 0x91 # Anki.Cozmo.ExternalInterface.RemoveDisableReactionsLock
    DisableAllReactionsWithLock             = 0x92 # Anki.Cozmo.ExternalInterface.DisableAllReactionsWithLock
    SetDefaultHeadAndLiftState              = 0x93 # Anki.Cozmo.ExternalInterface.SetDefaultHeadAndLiftState
    RequestLocatedObjectStates              = 0x94 # Anki.Cozmo.ExternalInterface.RequestLocatedObjectStates
    RequestConnectedObjects                 = 0x95 # Anki.Cozmo.ExternalInterface.RequestConnectedObjects
    DrawPoseMarker                          = 0x96 # Anki.Cozmo.ExternalInterface.DrawPoseMarker
    ErasePoseMarker                         = 0x97 # Anki.Cozmo.ExternalInterface.ErasePoseMarker
    VisualizeQuad                           = 0x98 # Anki.Cozmo.ExternalInterface.VisualizeQuad
    EraseQuad                               = 0x99 # Anki.Cozmo.ExternalInterface.EraseQuad
    ReplayLastAnimation                     = 0x9a # Anki.Cozmo.ExternalInterface.ReplayLastAnimation
    SetIdleAnimation                        = 0x9b # Anki.Cozmo.ExternalInterface.SetIdleAnimation
    PushIdleAnimation                       = 0x9c # Anki.Cozmo.ExternalInterface.PushIdleAnimation
    PopIdleAnimation                        = 0x9d # Anki.Cozmo.ExternalInterface.PopIdleAnimation
    ReadFaceAnimationDir                    = 0x9e # Anki.Cozmo.ExternalInterface.ReadFaceAnimationDir
    ReadAnimationFile                       = 0x9f # Anki.Cozmo.ExternalInterface.ReadAnimationFile
    RequestAvailableAnimations              = 0xa0 # Anki.Cozmo.ExternalInterface.RequestAvailableAnimations
    RequestAvailableAnimationGroups         = 0xa1 # Anki.Cozmo.ExternalInterface.RequestAvailableAnimationGroups
    SetLiveIdleAnimationParameters          = 0xa2 # Anki.Cozmo.ExternalInterface.SetLiveIdleAnimationParameters
    PushDrivingAnimations                   = 0xa3 # Anki.Cozmo.ExternalInterface.PushDrivingAnimations
    PopDrivingAnimations                    = 0xa4 # Anki.Cozmo.ExternalInterface.PopDrivingAnimations
    SetHeadlight                            = 0xa5 # Anki.Cozmo.ExternalInterface.SetHeadlight
    SetActiveObjectLEDs                     = 0xa6 # Anki.Cozmo.ExternalInterface.SetActiveObjectLEDs
    SetAllActiveObjectLEDs                  = 0xa7 # Anki.Cozmo.ExternalInterface.SetAllActiveObjectLEDs
    SetBackpackLEDs                         = 0xa8 # Anki.Cozmo.ExternalInterface.SetBackpackLEDs
    EnableLightStates                       = 0xa9 # Anki.Cozmo.ExternalInterface.EnableLightStates
    EnableCubeSleep                         = 0xaa # Anki.Cozmo.ExternalInterface.EnableCubeSleep
    EnableCubeLightsStateTransitionMessages = 0xab # Anki.Cozmo.ExternalInterface.EnableCubeLightsStateTransitionMessages
    FlashCurrentLightsState                 = 0xac # Anki.Cozmo.ExternalInterface.FlashCurrentLightsState
    PlayCubeAnim                            = 0xad # Anki.Cozmo.ExternalInterface.PlayCubeAnim
    StopCubeAnim                            = 0xae # Anki.Cozmo.ExternalInterface.StopCubeAnim
    StreamObjectAccel                       = 0xaf # Anki.Cozmo.ExternalInterface.StreamObjectAccel
    TransitionToNextOnboardingState         = 0xb0 # Anki.Cozmo.ExternalInterface.TransitionToNextOnboardingState
    MoodMessage                             = 0xb1 # Anki.Cozmo.ExternalInterface.MoodMessage
    GetNeedsState                           = 0xb2 # Anki.Cozmo.ExternalInterface.GetNeedsState
    SetNeedsPauseState                      = 0xb3 # Anki.Cozmo.ExternalInterface.SetNeedsPauseState
    GetNeedsPauseState                      = 0xb4 # Anki.Cozmo.ExternalInterface.GetNeedsPauseState
    RegisterNeedsActionCompleted            = 0xb5 # Anki.Cozmo.ExternalInterface.RegisterNeedsActionCompleted
    ProgressionMessage                      = 0xb6 # Anki.Cozmo.ExternalInterface.ProgressionMessage
    RequestSetUnlock                        = 0xb7 # Anki.Cozmo.ExternalInterface.RequestSetUnlock
    RequestDeviceData                       = 0xb8 # Anki.Cozmo.ExternalInterface.RequestDeviceData
    SetDebugConsoleVarMessage               = 0xb9 # Anki.Cozmo.ExternalInterface.SetDebugConsoleVarMessage
    RunDebugConsoleFuncMessage              = 0xba # Anki.Cozmo.ExternalInterface.RunDebugConsoleFuncMessage
    GetDebugConsoleVarMessage               = 0xbb # Anki.Cozmo.ExternalInterface.GetDebugConsoleVarMessage
    GetAllDebugConsoleVarMessage            = 0xbc # Anki.Cozmo.ExternalInterface.GetAllDebugConsoleVarMessage
    GetJsonDasLogsMessage                   = 0xbd # Anki.Cozmo.ExternalInterface.GetJsonDasLogsMessage
    SetEnableSpeedChooser                   = 0xbe # Anki.Cozmo.ExternalInterface.SetEnableSpeedChooser
    BlockPoolEnabledMessage                 = 0xbf # Anki.Cozmo.ExternalInterface.BlockPoolEnabledMessage
    BlockSelectedMessage                    = 0xc0 # Anki.Cozmo.ExternalInterface.BlockSelectedMessage
    GetBlockPoolMessage                     = 0xc1 # Anki.Cozmo.ExternalInterface.GetBlockPoolMessage
    SendAvailableObjects                    = 0xc2 # Anki.Cozmo.ExternalInterface.SendAvailableObjects
    BlockPoolResetMessage                   = 0xc3 # Anki.Cozmo.ExternalInterface.BlockPoolResetMessage
    SaveCalibrationImage                    = 0xc4 # Anki.Cozmo.ExternalInterface.SaveCalibrationImage
    ClearCalibrationImages                  = 0xc5 # Anki.Cozmo.ExternalInterface.ClearCalibrationImages
    ComputeCameraCalibration                = 0xc6 # Anki.Cozmo.ExternalInterface.ComputeCameraCalibration
    ContinueFreeplayFromIdle                = 0xc7 # Anki.Cozmo.ExternalInterface.ContinueFreeplayFromIdle
    EnableDroneMode                         = 0xc8 # Anki.Cozmo.ExternalInterface.EnableDroneMode
    EnterSdkMode                            = 0xc9 # Anki.Cozmo.ExternalInterface.EnterSdkMode
    ExitSdkMode                             = 0xca # Anki.Cozmo.ExternalInterface.ExitSdkMode
    SetStopRobotOnSdkDisconnect             = 0xcb # Anki.Cozmo.ExternalInterface.SetStopRobotOnSdkDisconnect
    StopRobotForSdk                         = 0xcc # Anki.Cozmo.ExternalInterface.StopRobotForSdk
    SetShouldAutoConnectToCubesAtStart      = 0xcd # Anki.Cozmo.ExternalInterface.SetShouldAutoConnectToCubesAtStart
    SetShouldAutoDisconnectFromCubesAtEnd   = 0xce # Anki.Cozmo.ExternalInterface.SetShouldAutoDisconnectFromCubesAtEnd
    TransferFile                            = 0xcf # Anki.Cozmo.ExternalInterface.TransferFile
    NVStorageEraseEntry                     = 0xd0 # Anki.Cozmo.ExternalInterface.NVStorageEraseEntry
    NVStorageWipeAll                        = 0xd1 # Anki.Cozmo.ExternalInterface.NVStorageWipeAll
    NVStorageWriteEntry                     = 0xd2 # Anki.Cozmo.ExternalInterface.NVStorageWriteEntry
    NVStorageClearPartialPendingWriteEntry  = 0xd3 # Anki.Cozmo.ExternalInterface.NVStorageClearPartialPendingWriteEntry
    NVStorageReadEntry                      = 0xd4 # Anki.Cozmo.ExternalInterface.NVStorageReadEntry
    SetCameraSettings                       = 0xd5 # Anki.Cozmo.ExternalInterface.SetCameraSettings
    RequestRobotSettings                    = 0xd6 # Anki.Cozmo.ExternalInterface.RequestRobotSettings
  ...
  _tags_by_name = dict(
    ...
    DeleteCustomMarkerObjects=116,
    DeleteFixedCustomObjects=117,
    UndefineAllCustomMarkerObjects=118,
    CreateFixedCustomObject=119,
    DefineCustomBox=120,
    DefineCustomCube=121,
    DefineCustomWall=122,
    VisionWhileMoving=123,
    SetFaceToEnroll=124,
    CancelFaceEnrollment=125,
    EraseEnrolledFaceByID=126,
    EraseAllEnrolledFaces=127,
    EnableVisionMode=128,
    UpdateEnrolledFaceByID=129,
    VisionRunMode=130,
    SaveFaceAlbumToFile=131,
    LoadFaceAlbumFromFile=132,
    SetMemoryMapRenderEnabled=133,
    SetMemoryMapBroadcastFrequency_sec=134,
    ActivateBehaviorChooser=135,
    ExecuteBehaviorByExecutableType=136,
    ExecuteBehaviorByName=137,
    SetLiftLoadTestAsRunnable=138,
    BehaviorManagerMessage=139,
    AbortPath=140,
    AbortAll=141,
    StartTestMode=142,
    RequestEnabledBehaviorList=143,
    DisableReactionsWithLock=144,
    RemoveDisableReactionsLock=145,
    DisableAllReactionsWithLock=146,
    SetDefaultHeadAndLiftState=147,
    RequestLocatedObjectStates=148,
    RequestConnectedObjects=149,
    DrawPoseMarker=150,
    ErasePoseMarker=151,
    VisualizeQuad=152,
    EraseQuad=153,
    ReplayLastAnimation=154,
    SetIdleAnimation=155,
    PushIdleAnimation=156,
    PopIdleAnimation=157,
    ReadFaceAnimationDir=158,
    ReadAnimationFile=159,
    RequestAvailableAnimations=160,
    RequestAvailableAnimationGroups=161,
    SetLiveIdleAnimationParameters=162,
    PushDrivingAnimations=163,
    PopDrivingAnimations=164,
    SetHeadlight=165,
    SetActiveObjectLEDs=166,
    SetAllActiveObjectLEDs=167,
    SetBackpackLEDs=168,
    EnableLightStates=169,
    EnableCubeSleep=170,
    EnableCubeLightsStateTransitionMessages=171,
    FlashCurrentLightsState=172,
    PlayCubeAnim=173,
    StopCubeAnim=174,
    StreamObjectAccel=175,
    TransitionToNextOnboardingState=176,
    MoodMessage=177,
    GetNeedsState=178,
    SetNeedsPauseState=179,
    GetNeedsPauseState=180,
    RegisterNeedsActionCompleted=181,
    ProgressionMessage=182,
    RequestSetUnlock=183,
    RequestDeviceData=184,
    SetDebugConsoleVarMessage=185,
    RunDebugConsoleFuncMessage=186,
    GetDebugConsoleVarMessage=187,
    GetAllDebugConsoleVarMessage=188,
    GetJsonDasLogsMessage=189,
    SetEnableSpeedChooser=190,
    BlockPoolEnabledMessage=191,
    BlockSelectedMessage=192,
    GetBlockPoolMessage=193,
    SendAvailableObjects=194,
    BlockPoolResetMessage=195,
    SaveCalibrationImage=196,
    ClearCalibrationImages=197,
    ComputeCameraCalibration=198,
    ContinueFreeplayFromIdle=199,
    EnableDroneMode=200,
    EnterSdkMode=201,
    ExitSdkMode=202,
    SetStopRobotOnSdkDisconnect=203,
    StopRobotForSdk=204,
    SetShouldAutoConnectToCubesAtStart=205,
    SetShouldAutoDisconnectFromCubesAtEnd=206,
    TransferFile=207,
    NVStorageEraseEntry=208,
    NVStorageWipeAll=209,
    NVStorageWriteEntry=210,
    NVStorageClearPartialPendingWriteEntry=211,
    NVStorageReadEntry=212,
    SetCameraSettings=213,
    RequestRobotSettings=214,
  )
  ...
  _tags_by_value[116] = 'DeleteCustomMarkerObjects'
  _tags_by_value[117] = 'DeleteFixedCustomObjects'
  _tags_by_value[118] = 'UndefineAllCustomMarkerObjects'
  ...
  _tags_by_value[123] = 'VisionWhileMoving'
  _tags_by_value[124] = 'SetFaceToEnroll'
  _tags_by_value[125] = 'CancelFaceEnrollment'
  _tags_by_value[126] = 'EraseEnrolledFaceByID'
  _tags_by_value[127] = 'EraseAllEnrolledFaces'
  _tags_by_value[128] = 'EnableVisionMode'
  _tags_by_value[129] = 'UpdateEnrolledFaceByID'
  _tags_by_value[130] = 'VisionRunMode'
  _tags_by_value[131] = 'SaveFaceAlbumToFile'
  _tags_by_value[132] = 'LoadFaceAlbumFromFile'
  _tags_by_value[133] = 'SetMemoryMapRenderEnabled'
  _tags_by_value[134] = 'SetMemoryMapBroadcastFrequency_sec'
  _tags_by_value[135] = 'ActivateBehaviorChooser'
  _tags_by_value[136] = 'ExecuteBehaviorByExecutableType'
  _tags_by_value[137] = 'ExecuteBehaviorByName'
  _tags_by_value[138] = 'SetLiftLoadTestAsRunnable'
  _tags_by_value[139] = 'BehaviorManagerMessage'
  _tags_by_value[140] = 'AbortPath'
  _tags_by_value[141] = 'AbortAll'
  _tags_by_value[142] = 'StartTestMode'
  _tags_by_value[143] = 'RequestEnabledBehaviorList'
  _tags_by_value[144] = 'DisableReactionsWithLock'
  _tags_by_value[145] = 'RemoveDisableReactionsLock'
  _tags_by_value[146] = 'DisableAllReactionsWithLock'
  _tags_by_value[147] = 'SetDefaultHeadAndLiftState'
  _tags_by_value[148] = 'RequestLocatedObjectStates'
  _tags_by_value[149] = 'RequestConnectedObjects'
  _tags_by_value[150] = 'DrawPoseMarker'
  _tags_by_value[151] = 'ErasePoseMarker'
  _tags_by_value[152] = 'VisualizeQuad'
  _tags_by_value[153] = 'EraseQuad'
  _tags_by_value[154] = 'ReplayLastAnimation'
  _tags_by_value[155] = 'SetIdleAnimation'
  _tags_by_value[156] = 'PushIdleAnimation'
  _tags_by_value[157] = 'PopIdleAnimation'
  _tags_by_value[158] = 'ReadFaceAnimationDir'
  _tags_by_value[159] = 'ReadAnimationFile'
  _tags_by_value[160] = 'RequestAvailableAnimations'
  _tags_by_value[161] = 'RequestAvailableAnimationGroups'
  _tags_by_value[162] = 'SetLiveIdleAnimationParameters'
  _tags_by_value[163] = 'PushDrivingAnimations'
  _tags_by_value[164] = 'PopDrivingAnimations'
  _tags_by_value[165] = 'SetHeadlight'
  _tags_by_value[166] = 'SetActiveObjectLEDs'
  _tags_by_value[167] = 'SetAllActiveObjectLEDs'
  _tags_by_value[168] = 'SetBackpackLEDs'
  _tags_by_value[169] = 'EnableLightStates'
  _tags_by_value[170] = 'EnableCubeSleep'
  _tags_by_value[171] = 'EnableCubeLightsStateTransitionMessages'
  _tags_by_value[172] = 'FlashCurrentLightsState'
  _tags_by_value[173] = 'PlayCubeAnim'
  _tags_by_value[174] = 'StopCubeAnim'
  _tags_by_value[175] = 'StreamObjectAccel'
  _tags_by_value[176] = 'TransitionToNextOnboardingState'
  _tags_by_value[177] = 'MoodMessage'
  _tags_by_value[178] = 'GetNeedsState'
  _tags_by_value[179] = 'SetNeedsPauseState'
  _tags_by_value[180] = 'GetNeedsPauseState'
  _tags_by_value[181] = 'RegisterNeedsActionCompleted'
  _tags_by_value[182] = 'ProgressionMessage'
  _tags_by_value[183] = 'RequestSetUnlock'
  _tags_by_value[184] = 'RequestDeviceData'
  _tags_by_value[185] = 'SetDebugConsoleVarMessage'
  _tags_by_value[186] = 'RunDebugConsoleFuncMessage'
  _tags_by_value[187] = 'GetDebugConsoleVarMessage'
  _tags_by_value[188] = 'GetAllDebugConsoleVarMessage'
  _tags_by_value[189] = 'GetJsonDasLogsMessage'
  _tags_by_value[190] = 'SetEnableSpeedChooser'
  _tags_by_value[191] = 'BlockPoolEnabledMessage'
  _tags_by_value[192] = 'BlockSelectedMessage'
  _tags_by_value[193] = 'GetBlockPoolMessage'
  _tags_by_value[194] = 'SendAvailableObjects'
  _tags_by_value[195] = 'BlockPoolResetMessage'
  _tags_by_value[196] = 'SaveCalibrationImage'
  _tags_by_value[197] = 'ClearCalibrationImages'
  _tags_by_value[198] = 'ComputeCameraCalibration'
  _tags_by_value[199] = 'ContinueFreeplayFromIdle'
  _tags_by_value[200] = 'EnableDroneMode'
  _tags_by_value[201] = 'EnterSdkMode'
  _tags_by_value[202] = 'ExitSdkMode'
  _tags_by_value[203] = 'SetStopRobotOnSdkDisconnect'
  _tags_by_value[204] = 'StopRobotForSdk'
  _tags_by_value[205] = 'SetShouldAutoConnectToCubesAtStart'
  _tags_by_value[206] = 'SetShouldAutoDisconnectFromCubesAtEnd'
  _tags_by_value[207] = 'TransferFile'
  _tags_by_value[208] = 'NVStorageEraseEntry'
  _tags_by_value[209] = 'NVStorageWipeAll'
  _tags_by_value[210] = 'NVStorageWriteEntry'
  _tags_by_value[211] = 'NVStorageClearPartialPendingWriteEntry'
  _tags_by_value[212] = 'NVStorageReadEntry'
  _tags_by_value[213] = 'SetCameraSettings'
  _tags_by_value[214] = 'RequestRobotSettings'
  ...
  _tag_unpack_methods[116] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DeleteCustomMarkerObjects.unpack_from)
  _tag_unpack_methods[117] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DeleteFixedCustomObjects.unpack_from)
  _tag_unpack_methods[118] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.UndefineAllCustomMarkerObjects.unpack_from)
  ...
  _tag_unpack_methods[123] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.VisionWhileMoving.unpack_from)
  _tag_unpack_methods[124] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetFaceToEnroll.unpack_from)
  _tag_unpack_methods[125] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.CancelFaceEnrollment.unpack_from)
  _tag_unpack_methods[126] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EraseEnrolledFaceByID.unpack_from)
  _tag_unpack_methods[127] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EraseAllEnrolledFaces.unpack_from)
  _tag_unpack_methods[128] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EnableVisionMode.unpack_from)
  _tag_unpack_methods[129] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.UpdateEnrolledFaceByID.unpack_from)
  _tag_unpack_methods[130] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.VisionRunMode.unpack_from)
  _tag_unpack_methods[131] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SaveFaceAlbumToFile.unpack_from)
  _tag_unpack_methods[132] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.LoadFaceAlbumFromFile.unpack_from)
  _tag_unpack_methods[133] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetMemoryMapRenderEnabled.unpack_from)
  _tag_unpack_methods[134] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetMemoryMapBroadcastFrequency_sec.unpack_from)
  _tag_unpack_methods[135] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ActivateBehaviorChooser.unpack_from)
  _tag_unpack_methods[136] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ExecuteBehaviorByExecutableType.unpack_from)
  _tag_unpack_methods[137] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ExecuteBehaviorByName.unpack_from)
  _tag_unpack_methods[138] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetLiftLoadTestAsRunnable.unpack_from)
  _tag_unpack_methods[139] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BehaviorManagerMessage.unpack_from)
  _tag_unpack_methods[140] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.AbortPath.unpack_from)
  _tag_unpack_methods[141] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.AbortAll.unpack_from)
  _tag_unpack_methods[142] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.StartTestMode.unpack_from)
  _tag_unpack_methods[143] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestEnabledBehaviorList.unpack_from)
  _tag_unpack_methods[144] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DisableReactionsWithLock.unpack_from)
  _tag_unpack_methods[145] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RemoveDisableReactionsLock.unpack_from)
  _tag_unpack_methods[146] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DisableAllReactionsWithLock.unpack_from)
  _tag_unpack_methods[147] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetDefaultHeadAndLiftState.unpack_from)
  _tag_unpack_methods[148] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestLocatedObjectStates.unpack_from)
  _tag_unpack_methods[149] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestConnectedObjects.unpack_from)
  _tag_unpack_methods[150] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DrawPoseMarker.unpack_from)
  _tag_unpack_methods[151] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ErasePoseMarker.unpack_from)
  _tag_unpack_methods[152] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.VisualizeQuad.unpack_from)
  _tag_unpack_methods[153] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EraseQuad.unpack_from)
  _tag_unpack_methods[154] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ReplayLastAnimation.unpack_from)
  _tag_unpack_methods[155] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetIdleAnimation.unpack_from)
  _tag_unpack_methods[156] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.PushIdleAnimation.unpack_from)
  _tag_unpack_methods[157] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.PopIdleAnimation.unpack_from)
  _tag_unpack_methods[158] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ReadFaceAnimationDir.unpack_from)
  _tag_unpack_methods[159] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ReadAnimationFile.unpack_from)
  _tag_unpack_methods[160] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestAvailableAnimations.unpack_from)
  _tag_unpack_methods[161] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestAvailableAnimationGroups.unpack_from)
  _tag_unpack_methods[162] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetLiveIdleAnimationParameters.unpack_from)
  _tag_unpack_methods[163] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.PushDrivingAnimations.unpack_from)
  _tag_unpack_methods[164] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.PopDrivingAnimations.unpack_from)
  _tag_unpack_methods[165] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetHeadlight.unpack_from)
  _tag_unpack_methods[166] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetActiveObjectLEDs.unpack_from)
  _tag_unpack_methods[167] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetAllActiveObjectLEDs.unpack_from)
  _tag_unpack_methods[168] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetBackpackLEDs.unpack_from)
  _tag_unpack_methods[169] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EnableLightStates.unpack_from)
  _tag_unpack_methods[170] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EnableCubeSleep.unpack_from)
  _tag_unpack_methods[171] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EnableCubeLightsStateTransitionMessages.unpack_from)
  _tag_unpack_methods[172] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.FlashCurrentLightsState.unpack_from)
  _tag_unpack_methods[173] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.PlayCubeAnim.unpack_from)
  _tag_unpack_methods[174] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.StopCubeAnim.unpack_from)
  _tag_unpack_methods[175] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.StreamObjectAccel.unpack_from)
  _tag_unpack_methods[176] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.TransitionToNextOnboardingState.unpack_from)
  _tag_unpack_methods[177] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.MoodMessage.unpack_from)
  _tag_unpack_methods[178] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.GetNeedsState.unpack_from)
  _tag_unpack_methods[179] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetNeedsPauseState.unpack_from)
  _tag_unpack_methods[180] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.GetNeedsPauseState.unpack_from)
  _tag_unpack_methods[181] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RegisterNeedsActionCompleted.unpack_from)
  _tag_unpack_methods[182] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ProgressionMessage.unpack_from)
  _tag_unpack_methods[183] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestSetUnlock.unpack_from)
  _tag_unpack_methods[184] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestDeviceData.unpack_from)
  _tag_unpack_methods[185] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetDebugConsoleVarMessage.unpack_from)
  _tag_unpack_methods[186] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RunDebugConsoleFuncMessage.unpack_from)
  _tag_unpack_methods[187] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.GetDebugConsoleVarMessage.unpack_from)
  _tag_unpack_methods[188] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.GetAllDebugConsoleVarMessage.unpack_from)
  _tag_unpack_methods[189] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.GetJsonDasLogsMessage.unpack_from)
  _tag_unpack_methods[190] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetEnableSpeedChooser.unpack_from)
  _tag_unpack_methods[191] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BlockPoolEnabledMessage.unpack_from)
  _tag_unpack_methods[192] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BlockSelectedMessage.unpack_from)
  _tag_unpack_methods[193] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.GetBlockPoolMessage.unpack_from)
  _tag_unpack_methods[194] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SendAvailableObjects.unpack_from)
  _tag_unpack_methods[195] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BlockPoolResetMessage.unpack_from)
  _tag_unpack_methods[196] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SaveCalibrationImage.unpack_from)
  _tag_unpack_methods[197] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ClearCalibrationImages.unpack_from)
  _tag_unpack_methods[198] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ComputeCameraCalibration.unpack_from)
  _tag_unpack_methods[199] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ContinueFreeplayFromIdle.unpack_from)
  _tag_unpack_methods[200] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EnableDroneMode.unpack_from)
  _tag_unpack_methods[201] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EnterSdkMode.unpack_from)
  _tag_unpack_methods[202] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ExitSdkMode.unpack_from)
  _tag_unpack_methods[203] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetStopRobotOnSdkDisconnect.unpack_from)
  _tag_unpack_methods[204] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.StopRobotForSdk.unpack_from)
  _tag_unpack_methods[205] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetShouldAutoConnectToCubesAtStart.unpack_from)
  _tag_unpack_methods[206] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetShouldAutoDisconnectFromCubesAtEnd.unpack_from)
  _tag_unpack_methods[207] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.TransferFile.unpack_from)
  _tag_unpack_methods[208] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.NVStorageEraseEntry.unpack_from)
  _tag_unpack_methods[209] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.NVStorageWipeAll.unpack_from)
  _tag_unpack_methods[210] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.NVStorageWriteEntry.unpack_from)
  _tag_unpack_methods[211] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.NVStorageClearPartialPendingWriteEntry.unpack_from)
  _tag_unpack_methods[212] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.NVStorageReadEntry.unpack_from)
  _tag_unpack_methods[213] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetCameraSettings.unpack_from)
  _tag_unpack_methods[214] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestRobotSettings.unpack_from)
  ...
  _type_by_tag_value[116] = lambda : Anki.Cozmo.ExternalInterface.DeleteCustomMarkerObjects
  _type_by_tag_value[117] = lambda : Anki.Cozmo.ExternalInterface.DeleteFixedCustomObjects
  _type_by_tag_value[118] = lambda : Anki.Cozmo.ExternalInterface.UndefineAllCustomMarkerObjects
  ...
  _type_by_tag_value[123] = lambda : Anki.Cozmo.ExternalInterface.VisionWhileMoving
  _type_by_tag_value[124] = lambda : Anki.Cozmo.ExternalInterface.SetFaceToEnroll
  _type_by_tag_value[125] = lambda : Anki.Cozmo.ExternalInterface.CancelFaceEnrollment
  _type_by_tag_value[126] = lambda : Anki.Cozmo.ExternalInterface.EraseEnrolledFaceByID
  _type_by_tag_value[127] = lambda : Anki.Cozmo.ExternalInterface.EraseAllEnrolledFaces
  _type_by_tag_value[128] = lambda : Anki.Cozmo.ExternalInterface.EnableVisionMode
  _type_by_tag_value[129] = lambda : Anki.Cozmo.ExternalInterface.UpdateEnrolledFaceByID
  _type_by_tag_value[130] = lambda : Anki.Cozmo.ExternalInterface.VisionRunMode
  _type_by_tag_value[131] = lambda : Anki.Cozmo.ExternalInterface.SaveFaceAlbumToFile
  _type_by_tag_value[132] = lambda : Anki.Cozmo.ExternalInterface.LoadFaceAlbumFromFile
  _type_by_tag_value[133] = lambda : Anki.Cozmo.ExternalInterface.SetMemoryMapRenderEnabled
  _type_by_tag_value[134] = lambda : Anki.Cozmo.ExternalInterface.SetMemoryMapBroadcastFrequency_sec
  _type_by_tag_value[135] = lambda : Anki.Cozmo.ExternalInterface.ActivateBehaviorChooser
  _type_by_tag_value[136] = lambda : Anki.Cozmo.ExternalInterface.ExecuteBehaviorByExecutableType
  _type_by_tag_value[137] = lambda : Anki.Cozmo.ExternalInterface.ExecuteBehaviorByName
  _type_by_tag_value[138] = lambda : Anki.Cozmo.ExternalInterface.SetLiftLoadTestAsRunnable
  _type_by_tag_value[139] = lambda : Anki.Cozmo.ExternalInterface.BehaviorManagerMessage
  _type_by_tag_value[140] = lambda : Anki.Cozmo.ExternalInterface.AbortPath
  _type_by_tag_value[141] = lambda : Anki.Cozmo.ExternalInterface.AbortAll
  _type_by_tag_value[142] = lambda : Anki.Cozmo.ExternalInterface.StartTestMode
  _type_by_tag_value[143] = lambda : Anki.Cozmo.ExternalInterface.RequestEnabledBehaviorList
  _type_by_tag_value[144] = lambda : Anki.Cozmo.ExternalInterface.DisableReactionsWithLock
  _type_by_tag_value[145] = lambda : Anki.Cozmo.ExternalInterface.RemoveDisableReactionsLock
  _type_by_tag_value[146] = lambda : Anki.Cozmo.ExternalInterface.DisableAllReactionsWithLock
  _type_by_tag_value[147] = lambda : Anki.Cozmo.ExternalInterface.SetDefaultHeadAndLiftState
  _type_by_tag_value[148] = lambda : Anki.Cozmo.ExternalInterface.RequestLocatedObjectStates
  _type_by_tag_value[149] = lambda : Anki.Cozmo.ExternalInterface.RequestConnectedObjects
  _type_by_tag_value[150] = lambda : Anki.Cozmo.ExternalInterface.DrawPoseMarker
  _type_by_tag_value[151] = lambda : Anki.Cozmo.ExternalInterface.ErasePoseMarker
  _type_by_tag_value[152] = lambda : Anki.Cozmo.ExternalInterface.VisualizeQuad
  _type_by_tag_value[153] = lambda : Anki.Cozmo.ExternalInterface.EraseQuad
  _type_by_tag_value[154] = lambda : Anki.Cozmo.ExternalInterface.ReplayLastAnimation
  _type_by_tag_value[155] = lambda : Anki.Cozmo.ExternalInterface.SetIdleAnimation
  _type_by_tag_value[156] = lambda : Anki.Cozmo.ExternalInterface.PushIdleAnimation
  _type_by_tag_value[157] = lambda : Anki.Cozmo.ExternalInterface.PopIdleAnimation
  _type_by_tag_value[158] = lambda : Anki.Cozmo.ExternalInterface.ReadFaceAnimationDir
  _type_by_tag_value[159] = lambda : Anki.Cozmo.ExternalInterface.ReadAnimationFile
  _type_by_tag_value[160] = lambda : Anki.Cozmo.ExternalInterface.RequestAvailableAnimations
  _type_by_tag_value[161] = lambda : Anki.Cozmo.ExternalInterface.RequestAvailableAnimationGroups
  _type_by_tag_value[162] = lambda : Anki.Cozmo.ExternalInterface.SetLiveIdleAnimationParameters
  _type_by_tag_value[163] = lambda : Anki.Cozmo.ExternalInterface.PushDrivingAnimations
  _type_by_tag_value[164] = lambda : Anki.Cozmo.ExternalInterface.PopDrivingAnimations
  _type_by_tag_value[165] = lambda : Anki.Cozmo.ExternalInterface.SetHeadlight
  _type_by_tag_value[166] = lambda : Anki.Cozmo.ExternalInterface.SetActiveObjectLEDs
  _type_by_tag_value[167] = lambda : Anki.Cozmo.ExternalInterface.SetAllActiveObjectLEDs
  _type_by_tag_value[168] = lambda : Anki.Cozmo.ExternalInterface.SetBackpackLEDs
  _type_by_tag_value[169] = lambda : Anki.Cozmo.ExternalInterface.EnableLightStates
  _type_by_tag_value[170] = lambda : Anki.Cozmo.ExternalInterface.EnableCubeSleep
  _type_by_tag_value[171] = lambda : Anki.Cozmo.ExternalInterface.EnableCubeLightsStateTransitionMessages
  _type_by_tag_value[172] = lambda : Anki.Cozmo.ExternalInterface.FlashCurrentLightsState
  _type_by_tag_value[173] = lambda : Anki.Cozmo.ExternalInterface.PlayCubeAnim
  _type_by_tag_value[174] = lambda : Anki.Cozmo.ExternalInterface.StopCubeAnim
  _type_by_tag_value[175] = lambda : Anki.Cozmo.ExternalInterface.StreamObjectAccel
  _type_by_tag_value[176] = lambda : Anki.Cozmo.ExternalInterface.TransitionToNextOnboardingState
  _type_by_tag_value[177] = lambda : Anki.Cozmo.ExternalInterface.MoodMessage
  _type_by_tag_value[178] = lambda : Anki.Cozmo.ExternalInterface.GetNeedsState
  _type_by_tag_value[179] = lambda : Anki.Cozmo.ExternalInterface.SetNeedsPauseState
  _type_by_tag_value[180] = lambda : Anki.Cozmo.ExternalInterface.GetNeedsPauseState
  _type_by_tag_value[181] = lambda : Anki.Cozmo.ExternalInterface.RegisterNeedsActionCompleted
  _type_by_tag_value[182] = lambda : Anki.Cozmo.ExternalInterface.ProgressionMessage
  _type_by_tag_value[183] = lambda : Anki.Cozmo.ExternalInterface.RequestSetUnlock
  _type_by_tag_value[184] = lambda : Anki.Cozmo.ExternalInterface.RequestDeviceData
  _type_by_tag_value[185] = lambda : Anki.Cozmo.ExternalInterface.SetDebugConsoleVarMessage
  _type_by_tag_value[186] = lambda : Anki.Cozmo.ExternalInterface.RunDebugConsoleFuncMessage
  _type_by_tag_value[187] = lambda : Anki.Cozmo.ExternalInterface.GetDebugConsoleVarMessage
  _type_by_tag_value[188] = lambda : Anki.Cozmo.ExternalInterface.GetAllDebugConsoleVarMessage
  _type_by_tag_value[189] = lambda : Anki.Cozmo.ExternalInterface.GetJsonDasLogsMessage
  _type_by_tag_value[190] = lambda : Anki.Cozmo.ExternalInterface.SetEnableSpeedChooser
  _type_by_tag_value[191] = lambda : Anki.Cozmo.ExternalInterface.BlockPoolEnabledMessage
  _type_by_tag_value[192] = lambda : Anki.Cozmo.ExternalInterface.BlockSelectedMessage
  _type_by_tag_value[193] = lambda : Anki.Cozmo.ExternalInterface.GetBlockPoolMessage
  _type_by_tag_value[194] = lambda : Anki.Cozmo.ExternalInterface.SendAvailableObjects
  _type_by_tag_value[195] = lambda : Anki.Cozmo.ExternalInterface.BlockPoolResetMessage
  _type_by_tag_value[196] = lambda : Anki.Cozmo.ExternalInterface.SaveCalibrationImage
  _type_by_tag_value[197] = lambda : Anki.Cozmo.ExternalInterface.ClearCalibrationImages
  _type_by_tag_value[198] = lambda : Anki.Cozmo.ExternalInterface.ComputeCameraCalibration
  _type_by_tag_value[199] = lambda : Anki.Cozmo.ExternalInterface.ContinueFreeplayFromIdle
  _type_by_tag_value[200] = lambda : Anki.Cozmo.ExternalInterface.EnableDroneMode
  _type_by_tag_value[201] = lambda : Anki.Cozmo.ExternalInterface.EnterSdkMode
  _type_by_tag_value[202] = lambda : Anki.Cozmo.ExternalInterface.ExitSdkMode
  _type_by_tag_value[203] = lambda : Anki.Cozmo.ExternalInterface.SetStopRobotOnSdkDisconnect
  _type_by_tag_value[204] = lambda : Anki.Cozmo.ExternalInterface.StopRobotForSdk
  _type_by_tag_value[205] = lambda : Anki.Cozmo.ExternalInterface.SetShouldAutoConnectToCubesAtStart
  _type_by_tag_value[206] = lambda : Anki.Cozmo.ExternalInterface.SetShouldAutoDisconnectFromCubesAtEnd
  _type_by_tag_value[207] = lambda : Anki.Cozmo.ExternalInterface.TransferFile
  _type_by_tag_value[208] = lambda : Anki.Cozmo.ExternalInterface.NVStorageEraseEntry
  _type_by_tag_value[209] = lambda : Anki.Cozmo.ExternalInterface.NVStorageWipeAll
  _type_by_tag_value[210] = lambda : Anki.Cozmo.ExternalInterface.NVStorageWriteEntry
  _type_by_tag_value[211] = lambda : Anki.Cozmo.ExternalInterface.NVStorageClearPartialPendingWriteEntry
  _type_by_tag_value[212] = lambda : Anki.Cozmo.ExternalInterface.NVStorageReadEntry
  _type_by_tag_value[213] = lambda : Anki.Cozmo.ExternalInterface.SetCameraSettings
  _type_by_tag_value[214] = lambda : Anki.Cozmo.ExternalInterface.RequestRobotSettings
