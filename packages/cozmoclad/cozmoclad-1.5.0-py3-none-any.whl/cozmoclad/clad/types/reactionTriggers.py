...
Source: clad/types/reactionTriggers.clad
Full command line: ../tools/message-buffers/emitters/Python_emitter.py -C ./src/ -I ../robot/clad/src/ ../coretech/vision/clad/src/ ../coretech/common/clad/src/ -o ../generated/cladPython// clad/types/reactionTriggers.clad
"""
...
class AllTriggersConsidered(object):
  ...
  __slots__ = (
    ...
    '_robotShaken',                  # bool
    '_sparked',                      # bool
    '_stackOfCubesInitialDetection', # bool
  ...
  def doubleTapDetected(self):
    "bool doubleTapDetected struct property."
    return self._doubleTapDetected

  @doubleTapDetected.setter
  def doubleTapDetected(self, value):
    self._doubleTapDetected = msgbuffers.validate_bool(
      'AllTriggersConsidered.doubleTapDetected', value)
  ...
  @property
  def pyramidInitialDetection(self):
    "bool pyramidInitialDetection struct property."
    return self._pyramidInitialDetection

  @pyramidInitialDetection.setter
  def pyramidInitialDetection(self, value):
    self._pyramidInitialDetection = msgbuffers.validate_bool(
      'AllTriggersConsidered.pyramidInitialDetection', value)
  ...
  @property
  def stackOfCubesInitialDetection(self):
    "bool stackOfCubesInitialDetection struct property."
    return self._stackOfCubesInitialDetection

  @stackOfCubesInitialDetection.setter
  def stackOfCubesInitialDetection(self, value):
    self._stackOfCubesInitialDetection = msgbuffers.validate_bool(
      'AllTriggersConsidered.stackOfCubesInitialDetection', value)
  ...
  def __init__(self, cliffDetected, cubeMoved, doubleTapDetected, facePositionUpdated, fistBump, frustration, hiccup, motorCalibration, noPreDockPoses, objectPositionUpdated, placedOnCharger, petInitialDetection, pyramidInitialDetection, robotPickedUp, robotPlacedOnSlope, returnedToTreads, robotOnBack, robotOnFace, robotOnSide, robotShaken, sparked, stackOfCubesInitialDetection, unexpectedMovement, vc):
    self.cliffDetected = cliffDetected
    self.cubeMoved = cubeMoved
    self.doubleTapDetected = doubleTapDetected
    ...
    self.pyramidInitialDetection = pyramidInitialDetection
    ...
    self.stackOfCubesInitialDetection = stackOfCubesInitialDetection
  ...
  def unpack_from(cls, reader):
    ...
    _doubleTapDetected = bool(reader.read('b'))
    ...
    _pyramidInitialDetection = bool(reader.read('b'))
    ...
    _stackOfCubesInitialDetection = bool(reader.read('b'))
    _unexpectedMovement = bool(reader.read('b'))
    _vc = bool(reader.read('b'))
    return cls(_cliffDetected, _cubeMoved, _doubleTapDetected, _facePositionUpdated, _fistBump, _frustration, _hiccup, _motorCalibration, _noPreDockPoses, _objectPositionUpdated, _placedOnCharger, _petInitialDetection, _pyramidInitialDetection, _robotPickedUp, _robotPlacedOnSlope, _returnedToTreads, _robotOnBack, _robotOnFace, _robotOnSide, _robotShaken, _sparked, _stackOfCubesInitialDetection, _unexpectedMovement, _vc)
  ...
  def pack_to(self, writer):
    ...
    writer.write(int(self._doubleTapDetected), 'b')
    ...
    writer.write(int(self._pyramidInitialDetection), 'b')
    ...
    writer.write(int(self._stackOfCubesInitialDetection), 'b')
  ...
  def __eq__(self, other):
    if type(self) is type(other):
      return (self._cliffDetected == other._cliffDetected and
        ...
        self._doubleTapDetected == other._doubleTapDetected and
        ...
        self._pyramidInitialDetection == other._pyramidInitialDetection and
        ...
        self._stackOfCubesInitialDetection == other._stackOfCubesInitialDetection and
  ...
  def __len__(self):
    return (msgbuffers.size(self._cliffDetected, 'b') +
      ...
      msgbuffers.size(self._doubleTapDetected, 'b') +
      ...
      msgbuffers.size(self._pyramidInitialDetection, 'b') +
      ...
      msgbuffers.size(self._stackOfCubesInitialDetection, 'b') +
      msgbuffers.size(self._unexpectedMovement, 'b') +
      msgbuffers.size(self._vc, 'b'))

  def __str__(self):
    return '{type}(cliffDetected={cliffDetected}, cubeMoved={cubeMoved}, doubleTapDetected={doubleTapDetected}, facePositionUpdated={facePositionUpdated}, fistBump={fistBump}, frustration={frustration}, hiccup={hiccup}, motorCalibration={motorCalibration}, noPreDockPoses={noPreDockPoses}, objectPositionUpdated={objectPositionUpdated}, placedOnCharger={placedOnCharger}, petInitialDetection={petInitialDetection}, pyramidInitialDetection={pyramidInitialDetection}, robotPickedUp={robotPickedUp}, robotPlacedOnSlope={robotPlacedOnSlope}, returnedToTreads={returnedToTreads}, robotOnBack={robotOnBack}, robotOnFace={robotOnFace}, robotOnSide={robotOnSide}, robotShaken={robotShaken}, sparked={sparked}, stackOfCubesInitialDetection={stackOfCubesInitialDetection}, unexpectedMovement={unexpectedMovement}, vc={vc})'.format(
      type=type(self).__name__,
      cliffDetected=self._cliffDetected,
      cubeMoved=self._cubeMoved,
      doubleTapDetected=self._doubleTapDetected,
      ...
      pyramidInitialDetection=self._pyramidInitialDetection,
      ...
      stackOfCubesInitialDetection=self._stackOfCubesInitialDetection,
  ...
  def __repr__(self):
    return '{type}(cliffDetected={cliffDetected}, cubeMoved={cubeMoved}, doubleTapDetected={doubleTapDetected}, facePositionUpdated={facePositionUpdated}, fistBump={fistBump}, frustration={frustration}, hiccup={hiccup}, motorCalibration={motorCalibration}, noPreDockPoses={noPreDockPoses}, objectPositionUpdated={objectPositionUpdated}, placedOnCharger={placedOnCharger}, petInitialDetection={petInitialDetection}, pyramidInitialDetection={pyramidInitialDetection}, robotPickedUp={robotPickedUp}, robotPlacedOnSlope={robotPlacedOnSlope}, returnedToTreads={returnedToTreads}, robotOnBack={robotOnBack}, robotOnFace={robotOnFace}, robotOnSide={robotOnSide}, robotShaken={robotShaken}, sparked={sparked}, stackOfCubesInitialDetection={stackOfCubesInitialDetection}, unexpectedMovement={unexpectedMovement}, vc={vc})'.format(
      ...
      doubleTapDetected=repr(self._doubleTapDetected),
      ...
      pyramidInitialDetection=repr(self._pyramidInitialDetection),
      ...
      stackOfCubesInitialDetection=repr(self._stackOfCubesInitialDetection),
