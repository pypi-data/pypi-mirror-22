...
class MessageViz(object):
  ...
  class Tag(object):
    ...
    MemoryMapMessageDebugVizBegin = 15 # Anki.Cozmo.VizInterface.MemoryMapMessageDebugVizBegin
    MemoryMapMessageDebugViz      = 16 # Anki.Cozmo.VizInterface.MemoryMapMessageDebugViz
    MemoryMapMessageDebugVizEnd   = 17 # Anki.Cozmo.VizInterface.MemoryMapMessageDebugVizEnd
    CameraQuad                    = 18 # Anki.Cozmo.VizInterface.CameraQuad
    CameraRect                    = 19 # Anki.Cozmo.VizInterface.CameraRect
    CameraLine                    = 20 # Anki.Cozmo.VizInterface.CameraLine
    CameraOval                    = 21 # Anki.Cozmo.VizInterface.CameraOval
    CameraText                    = 22 # Anki.Cozmo.VizInterface.CameraText
    EraseObject                   = 23 # Anki.Cozmo.VizInterface.EraseObject
    EraseSegmentPrimitives        = 24 # Anki.Cozmo.VizInterface.EraseSegmentPrimitives
    EraseQuad                     = 25 # Anki.Cozmo.VizInterface.EraseQuad
    SetRobot                      = 26 # Anki.Cozmo.VizInterface.SetRobot
    AppendPathSegmentLine         = 27 # Anki.Cozmo.VizInterface.AppendPathSegmentLine
    AppendPathSegmentArc          = 28 # Anki.Cozmo.VizInterface.AppendPathSegmentArc
    SetPathColor                  = 29 # Anki.Cozmo.VizInterface.SetPathColor
    ErasePath                     = 30 # Anki.Cozmo.VizInterface.ErasePath
    DefineColor                   = 31 # Anki.Cozmo.VizInterface.DefineColor
    SetLabel                      = 32 # Anki.Cozmo.VizInterface.SetLabel
    DockingErrorSignal            = 33 # Anki.Cozmo.VizInterface.DockingErrorSignal
    CameraInfo                    = 34 # Anki.Cozmo.VizInterface.CameraInfo
    VisionMarker                  = 35 # Anki.Cozmo.VizInterface.VisionMarker
    ShowObjects                   = 36 # Anki.Cozmo.VizInterface.ShowObjects
    TrackerQuad                   = 37 # Anki.Cozmo.VizInterface.TrackerQuad
    FaceDetection                 = 38 # Anki.Cozmo.VizInterface.FaceDetection
    RobotMood                     = 39 # Anki.Cozmo.VizInterface.RobotMood
    RobotBehaviorSelectData       = 40 # Anki.Cozmo.VizInterface.RobotBehaviorSelectData
    NewBehaviorSelected           = 41 # Anki.Cozmo.VizInterface.NewBehaviorSelected
    StartRobotUpdate              = 42 # Anki.Cozmo.VizInterface.StartRobotUpdate
    EndRobotUpdate                = 43 # Anki.Cozmo.VizInterface.EndRobotUpdate
    SaveImages                    = 44 # Anki.Cozmo.VizInterface.SaveImages
    SaveState                     = 45 # Anki.Cozmo.VizInterface.SaveState
    ObjectConnectionState         = 46 # Anki.Cozmo.VizInterface.ObjectConnectionState
    ObjectMovingState             = 47 # Anki.Cozmo.VizInterface.ObjectMovingState
    ObjectUpAxisState             = 48 # Anki.Cozmo.VizInterface.ObjectUpAxisState
    ObjectAccelState              = 49 # Anki.Cozmo.VizInterface.ObjectAccelState
  ...
  _tags_by_name = dict(
    ...
    MemoryMapMessageDebugVizBegin=15,
    MemoryMapMessageDebugViz=16,
    MemoryMapMessageDebugVizEnd=17,
    CameraQuad=18,
    CameraRect=19,
    CameraLine=20,
    CameraOval=21,
    CameraText=22,
    EraseObject=23,
    EraseSegmentPrimitives=24,
    EraseQuad=25,
    SetRobot=26,
    AppendPathSegmentLine=27,
    AppendPathSegmentArc=28,
    SetPathColor=29,
    ErasePath=30,
    DefineColor=31,
    SetLabel=32,
    DockingErrorSignal=33,
    CameraInfo=34,
    VisionMarker=35,
    ShowObjects=36,
    TrackerQuad=37,
    FaceDetection=38,
    RobotMood=39,
    RobotBehaviorSelectData=40,
    NewBehaviorSelected=41,
    StartRobotUpdate=42,
    EndRobotUpdate=43,
    SaveImages=44,
    SaveState=45,
    ObjectConnectionState=46,
    ObjectMovingState=47,
    ObjectUpAxisState=48,
    ObjectAccelState=49,
  )
  ...
  _tags_by_value[15] = 'MemoryMapMessageDebugVizBegin'
  _tags_by_value[16] = 'MemoryMapMessageDebugViz'
  _tags_by_value[17] = 'MemoryMapMessageDebugVizEnd'
  _tags_by_value[18] = 'CameraQuad'
  _tags_by_value[19] = 'CameraRect'
  _tags_by_value[20] = 'CameraLine'
  _tags_by_value[21] = 'CameraOval'
  _tags_by_value[22] = 'CameraText'
  _tags_by_value[23] = 'EraseObject'
  _tags_by_value[24] = 'EraseSegmentPrimitives'
  _tags_by_value[25] = 'EraseQuad'
  _tags_by_value[26] = 'SetRobot'
  _tags_by_value[27] = 'AppendPathSegmentLine'
  _tags_by_value[28] = 'AppendPathSegmentArc'
  _tags_by_value[29] = 'SetPathColor'
  _tags_by_value[30] = 'ErasePath'
  _tags_by_value[31] = 'DefineColor'
  _tags_by_value[32] = 'SetLabel'
  _tags_by_value[33] = 'DockingErrorSignal'
  _tags_by_value[34] = 'CameraInfo'
  _tags_by_value[35] = 'VisionMarker'
  _tags_by_value[36] = 'ShowObjects'
  _tags_by_value[37] = 'TrackerQuad'
  _tags_by_value[38] = 'FaceDetection'
  _tags_by_value[39] = 'RobotMood'
  _tags_by_value[40] = 'RobotBehaviorSelectData'
  _tags_by_value[41] = 'NewBehaviorSelected'
  _tags_by_value[42] = 'StartRobotUpdate'
  _tags_by_value[43] = 'EndRobotUpdate'
  _tags_by_value[44] = 'SaveImages'
  _tags_by_value[45] = 'SaveState'
  _tags_by_value[46] = 'ObjectConnectionState'
  _tags_by_value[47] = 'ObjectMovingState'
  _tags_by_value[48] = 'ObjectUpAxisState'
  _tags_by_value[49] = 'ObjectAccelState'
  ...
  _tag_unpack_methods[15] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.MemoryMapMessageDebugVizBegin.unpack_from)
  _tag_unpack_methods[16] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.MemoryMapMessageDebugViz.unpack_from)
  _tag_unpack_methods[17] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.MemoryMapMessageDebugVizEnd.unpack_from)
  _tag_unpack_methods[18] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.CameraQuad.unpack_from)
  _tag_unpack_methods[19] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.CameraRect.unpack_from)
  _tag_unpack_methods[20] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.CameraLine.unpack_from)
  _tag_unpack_methods[21] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.CameraOval.unpack_from)
  _tag_unpack_methods[22] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.CameraText.unpack_from)
  _tag_unpack_methods[23] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.EraseObject.unpack_from)
  _tag_unpack_methods[24] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.EraseSegmentPrimitives.unpack_from)
  _tag_unpack_methods[25] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.EraseQuad.unpack_from)
  _tag_unpack_methods[26] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.SetRobot.unpack_from)
  _tag_unpack_methods[27] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.AppendPathSegmentLine.unpack_from)
  _tag_unpack_methods[28] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.AppendPathSegmentArc.unpack_from)
  _tag_unpack_methods[29] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.SetPathColor.unpack_from)
  _tag_unpack_methods[30] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.ErasePath.unpack_from)
  _tag_unpack_methods[31] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.DefineColor.unpack_from)
  _tag_unpack_methods[32] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.SetLabel.unpack_from)
  _tag_unpack_methods[33] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.DockingErrorSignal.unpack_from)
  _tag_unpack_methods[34] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.CameraInfo.unpack_from)
  _tag_unpack_methods[35] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.VisionMarker.unpack_from)
  _tag_unpack_methods[36] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.ShowObjects.unpack_from)
  _tag_unpack_methods[37] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.TrackerQuad.unpack_from)
  _tag_unpack_methods[38] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.FaceDetection.unpack_from)
  _tag_unpack_methods[39] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.RobotMood.unpack_from)
  _tag_unpack_methods[40] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.RobotBehaviorSelectData.unpack_from)
  _tag_unpack_methods[41] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.NewBehaviorSelected.unpack_from)
  _tag_unpack_methods[42] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.StartRobotUpdate.unpack_from)
  _tag_unpack_methods[43] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.EndRobotUpdate.unpack_from)
  _tag_unpack_methods[44] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.SaveImages.unpack_from)
  _tag_unpack_methods[45] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.SaveState.unpack_from)
  _tag_unpack_methods[46] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.ObjectConnectionState.unpack_from)
  _tag_unpack_methods[47] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.ObjectMovingState.unpack_from)
  _tag_unpack_methods[48] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.ObjectUpAxisState.unpack_from)
  _tag_unpack_methods[49] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.ObjectAccelState.unpack_from)
  ...
  _type_by_tag_value[15] = lambda : Anki.Cozmo.VizInterface.MemoryMapMessageDebugVizBegin
  _type_by_tag_value[16] = lambda : Anki.Cozmo.VizInterface.MemoryMapMessageDebugViz
  _type_by_tag_value[17] = lambda : Anki.Cozmo.VizInterface.MemoryMapMessageDebugVizEnd
  _type_by_tag_value[18] = lambda : Anki.Cozmo.VizInterface.CameraQuad
  _type_by_tag_value[19] = lambda : Anki.Cozmo.VizInterface.CameraRect
  _type_by_tag_value[20] = lambda : Anki.Cozmo.VizInterface.CameraLine
  _type_by_tag_value[21] = lambda : Anki.Cozmo.VizInterface.CameraOval
  _type_by_tag_value[22] = lambda : Anki.Cozmo.VizInterface.CameraText
  _type_by_tag_value[23] = lambda : Anki.Cozmo.VizInterface.EraseObject
  _type_by_tag_value[24] = lambda : Anki.Cozmo.VizInterface.EraseSegmentPrimitives
  _type_by_tag_value[25] = lambda : Anki.Cozmo.VizInterface.EraseQuad
  _type_by_tag_value[26] = lambda : Anki.Cozmo.VizInterface.SetRobot
  _type_by_tag_value[27] = lambda : Anki.Cozmo.VizInterface.AppendPathSegmentLine
  _type_by_tag_value[28] = lambda : Anki.Cozmo.VizInterface.AppendPathSegmentArc
  _type_by_tag_value[29] = lambda : Anki.Cozmo.VizInterface.SetPathColor
  _type_by_tag_value[30] = lambda : Anki.Cozmo.VizInterface.ErasePath
  _type_by_tag_value[31] = lambda : Anki.Cozmo.VizInterface.DefineColor
  _type_by_tag_value[32] = lambda : Anki.Cozmo.VizInterface.SetLabel
  _type_by_tag_value[33] = lambda : Anki.Cozmo.VizInterface.DockingErrorSignal
  _type_by_tag_value[34] = lambda : Anki.Cozmo.VizInterface.CameraInfo
  _type_by_tag_value[35] = lambda : Anki.Cozmo.VizInterface.VisionMarker
  _type_by_tag_value[36] = lambda : Anki.Cozmo.VizInterface.ShowObjects
  _type_by_tag_value[37] = lambda : Anki.Cozmo.VizInterface.TrackerQuad
  _type_by_tag_value[38] = lambda : Anki.Cozmo.VizInterface.FaceDetection
  _type_by_tag_value[39] = lambda : Anki.Cozmo.VizInterface.RobotMood
  _type_by_tag_value[40] = lambda : Anki.Cozmo.VizInterface.RobotBehaviorSelectData
  _type_by_tag_value[41] = lambda : Anki.Cozmo.VizInterface.NewBehaviorSelected
  _type_by_tag_value[42] = lambda : Anki.Cozmo.VizInterface.StartRobotUpdate
  _type_by_tag_value[43] = lambda : Anki.Cozmo.VizInterface.EndRobotUpdate
  _type_by_tag_value[44] = lambda : Anki.Cozmo.VizInterface.SaveImages
  _type_by_tag_value[45] = lambda : Anki.Cozmo.VizInterface.SaveState
  _type_by_tag_value[46] = lambda : Anki.Cozmo.VizInterface.ObjectConnectionState
  _type_by_tag_value[47] = lambda : Anki.Cozmo.VizInterface.ObjectMovingState
  _type_by_tag_value[48] = lambda : Anki.Cozmo.VizInterface.ObjectUpAxisState
  _type_by_tag_value[49] = lambda : Anki.Cozmo.VizInterface.ObjectAccelState
