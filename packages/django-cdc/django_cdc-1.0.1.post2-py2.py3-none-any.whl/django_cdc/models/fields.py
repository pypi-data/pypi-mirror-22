...
from django_cdc import registration
...
try:
    ...
    add_introspection_rules(rules, ['^django_cdc\.models\.fields\.LastUserField'])
    add_introspection_rules(rules, ['^django_cdc\.models\.fields\.CreatingUserField'])
    add_introspection_rules([], ['^django_cdc\.models\.fields\.LastSessionKeyField'])
    add_introspection_rules([], ['^django_cdc\.models\.fields\.CreatingSessionKeyField'])
except ImportError:
    pass