...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for ct in get_models():
            if type(ct._default_manager) is DjangoCDCManager and ServiceType.LAMBDA_KINESIS in ct._default_manager.services:
                        lambda_fn_names.append(common_utils.get_function_name(ct._meta.db_table))
