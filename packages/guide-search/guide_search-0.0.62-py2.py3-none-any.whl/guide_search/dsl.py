...
class Dsl(object):
    ...
    def ui_query(self, search):
        ...
        if search['free_text']:
            and_filter = [{"multi_match": {"query": search['free_text'], "type": "cross_fields", "fields": search['fields'],
                                       "operator": "and"}}]
        ...
        for phrase in search['exact_phrases']:
            exact_filter = {"multi_match": {"query": phrase, "type": "phrase", "fields": search['fields']}}
