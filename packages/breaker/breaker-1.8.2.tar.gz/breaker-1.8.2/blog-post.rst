...
To connect and download maps between MJDs 57382. and 57384. with a false alarm rate lower limit of 1e-3 Hz:

.. code-block:: bash 
 
    > breaker listen 1e-3 57382. 57384.
...
.. code-block:: bash 
    ...
    > breaker listen 1e-3 15
    
To connect in daemon mode:

.. code-block:: bash 

    > breaker listen -d 1e-3
    NEW GRAVITATIONAL WAVE EVENT FOUND ...
        GraceDB ID: G211117
    NEW MAP FOUND FOR GW EVENT G211117 ...
        Downloading LALInference_skymap.fits.gz
