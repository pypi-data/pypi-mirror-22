...
__version__ = '$Id: 061a6dc819a7799d611eb8b626e821070672b02b $'
...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'be-tarask', 'zh-yue', 'ht', 'ml', 'bn', 'jv', 'ast', 'lb', 'mr',
            'af', 'sco', 'pnb', 'is', 'cv', 'ga', 'ba', 'fy', 'sw', 'my',
            'lmo', 'an', 'yo', 'ne', 'gu', 'io', 'nds', 'pa', 'scn', 'bpy',
            'ku', 'als', 'bar', 'kn', 'su', 'ia', 'qu', 'ckb', 'mn', 'azb',
            'arz', 'bat-smg', 'wa', 'nap', 'gd', 'bug', 'yi', 'am', 'map-bms',
            'si', 'or', 'fo', 'mzn', 'li', 'hsb', 'sah', 'sa', 'vec', 'mai',
            'ilo', 'os', 'mrj', 'xmf', 'hif', 'mhr', 'roa-tara', 'bh', 'eml',
            'pam', 'ps', 'diq', 'sd', 'nso', 'hak', 'se', 'mi', 'nah', 'bcl',
            'nds-nl', 'gan', 'zh-classical', 'glk', 'vls', 'rue', 'wuu', 'bo',
            'szl', 'sc', 'fiu-vro', 'co', 'vep', 'lrc', 'crh', 'tk', 'kv',
            'csb', 'km', 'gv', 'frr', 'as', 'lad', 'so', 'zea', 'cdo', 'ace',
            'ay', 'udm', 'lez', 'kw', 'stq', 'myv', 'ie', 'nrm', 'pcd', 'koi',
            'rm', 'ug', 'gom', 'lij', 'mt', 'nv', 'fur', 'gn', 'dsb',
            'cbk-zam', 'dv', 'ext', 'ang', 'kab', 'mwl', 'ksh', 'ln', 'gag',
            'sn', 'frp', 'pag', 'pi', 'av', 'olo', 'xal', 'pfl', 'krc', 'haw',
            'bxr', 'kaa', 'rw', 'pdc', 'pap', 'bjn', 'lo', 'to', 'nov', 'kl',
