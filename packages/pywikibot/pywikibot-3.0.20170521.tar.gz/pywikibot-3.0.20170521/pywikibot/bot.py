...
__version__ = '$Id: f78be24f092a763eb18d9eeff7ba1d38396ea0f9 $'
...
def handle_args(args=None, do_help=True):
    ...
    if config.verbose_output:
        ...
        # replacement with `$Id: f78be24f092a763eb18d9eeff7ba1d38396ea0f9 $`
        # or `$Id: f78be24f092a763eb18d9eeff7ba1d38396ea0f9 $`.
        m = re.search(r"\$Id"
