...
def downVideoGUI():
    ...
    def vidolM3U8DRM():
        ...
        text_cmd = """ -strict -2 -vf drawtext="fontfile=/usr/share/fonts/truetype/ttf-khmeros-core/KhmerOS.ttf: text='AcFun@daleloogn':fontcolor=white:fontsize=60:box=1:boxcolor=black@0.5: boxborderw=5:x=10: y=10" """
        ffmpeg_cmd = 'ffmpeg -ss 00:01:00 -i "' + M3U8 + '" ' + text_cmd + ' -c copy -bsf:a aac_adtstoasc -y DRM.mp4'
    ...
    def vidolM3U8WHD():
        M3U8 = M3U8_link_contend_gif.get()
        ffmpeg_cmd = 'ffmpeg -ss 00:01:00 -i "' + M3U8 + '" -c copy -bsf:a aac_adtstoasc -y WHD.mp4'
        print ffmpeg_cmd
        info_entry.insert(1.0, '\nM3U8下载\n', 'a')
        info_entry.insert(1.0, ffmpeg_cmd, 'a')
        os.system(ffmpeg_cmd)
    ...
    info_entry = Text(root, width=50, height=3, )
