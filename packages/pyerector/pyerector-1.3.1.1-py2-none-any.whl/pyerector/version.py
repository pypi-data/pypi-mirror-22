...
retrieve using this interface."""
    def __init__(self):
        V['pyerector.release.version'] = '14dcddaa7ad7'
        V['pyerector.release.branch'] = 'default'
        V['pyerector.release.tags'] = '1.3.1.1'
        V['pyerector.release.product'] = 'pyerector'
        V['pyerector.release.number'] = '1.3.1.1'
...
HG_VERSION = '14dcddaa7ad7'
HG_BRANCH = 'default'
HG_TAGS = '1.3.1.1'
RELEASE_PRODUCT = 'pyerector'
RELEASE_NUMBER = '1.3.1.1'
