...
# Copyright Nicola Musatti 2011 - 2017
...
.. IMPORTANT::
   Nxpy is a personal project and, while I use a good part of its contents on an almost daily basis,
   my use cases are too specific to guarantee that everything works as expected.
