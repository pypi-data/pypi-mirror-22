...
{
      15,     0,    -1,    -1,    17,    -1,    18,    -1,    18,    17,
      -1,    16,    -1,    16,    17,    -1,    34,    -1,    34,    27,
      -1,    17,    20,    -1,    20,    -1,    23,    -1,    -1,    23,
      19,    21,    -1,    22,    21,    -1,    22,    -1,    21,    23,
      -1,    23,    -1,     3,    -1,     3,    27,    -1,    25,    -1,
      32,    -1,    24,    25,    -1,    25,    -1,    26,    -1,    28,
      -1,     6,    34,    -1,     6,    34,    27,    -1,    34,    -1,
      27,    34,    -1,    -1,     7,    29,    30,    31,    -1,    30,
       6,    -1,     6,    -1,    31,    34,    -1,    34,    -1,    -1,
       4,    33,    24,     5,    -1,    35,    -1,    37,    -1,    36,
      -1,     9,    -1,     8,    -1,    10,    -1,    11,    -1,    13,
      -1,    12,    -1
};
...
#line 171 "cif_grammar.y"
    {
            if( isset_fix_errors( cif_cc ) ||
                ...
                char buf[strlen((yyvsp[(1) - (2)].s))+strlen(value_scalar(typed_value_value( (yyvsp[(2) - (2)].typed_value) )))+2];
                strcpy( buf, (yyvsp[(1) - (2)].s) );
                buf[strlen((yyvsp[(1) - (2)].s))] = '_';
                int i;
                for( i = 0; i < strlen(value_scalar(typed_value_value( (yyvsp[(2) - (2)].typed_value) ))); i++ ) {
                    if( value_scalar(typed_value_value( (yyvsp[(2) - (2)].typed_value) ))[i] != ' ' ) {
                        buf[strlen((yyvsp[(1) - (2)].s))+1+i] = value_scalar(typed_value_value( (yyvsp[(2) - (2)].typed_value) ))[i];
                    } else {
                        buf[strlen((yyvsp[(1) - (2)].s))+1+i] = '_';
                    } 
                }
                buf[strlen((yyvsp[(1) - (2)].s))+strlen(value_scalar(typed_value_value( (yyvsp[(2) - (2)].typed_value) )))+1] = '\0';
...
#line 232 "cif_grammar.y"
    {
                ...
                if( isset_fix_errors( cif_cc ) ||
                    ...
                    char *buf = mallocx(strlen(value_scalar(typed_value_value( (yyvsp[(2) - (3)].typed_value) )))+
                                        strlen(value_scalar(typed_value_value( (yyvsp[(3) - (3)].typed_value) )))+2,px);
                    buf = strcpy( buf, value_scalar(typed_value_value( (yyvsp[(2) - (3)].typed_value) )) );
                    buf = strcat( buf, " \0" );
                    buf = strcat( buf, value_scalar(typed_value_value( (yyvsp[(3) - (3)].typed_value) )) );
...
#line 274 "cif_grammar.y"
    {
            char *buf = mallocx( strlen(value_scalar(typed_value_value( (yyvsp[(1) - (2)].typed_value) ))) +
                                 strlen(value_scalar(typed_value_value( (yyvsp[(2) - (2)].typed_value) ))) + 2, px );
            buf = strcpy( buf, value_scalar( typed_value_value( (yyvsp[(1) - (2)].typed_value) ) ) );
            buf = strcat( buf, " \0" );
            buf = strcat( buf, value_scalar( typed_value_value( (yyvsp[(2) - (2)].typed_value) ) ) );
            (yyval.typed_value) = new_typed_value( typed_value_line( (yyvsp[(1) - (2)].typed_value) ),
                                  typed_value_pos( (yyvsp[(1) - (2)].typed_value) ),
                                  strdupx( typed_value_content((yyvsp[(1) - (2)].typed_value)), px ),
