...
static const yytype_uint8 yyprhs[] =
{
      ...
      21,    24,    26,    28,    29,    33,    36,    38,    41,    43,
      45,    48,    50,    52,    55,    57,    59,    61,    64,    68,
      70,    73,    74,    79,    82,    84,    87,    89,    90,    95,
      98,   100,   102,   104,   106,   108,   110,   112,   114,   116,
     118,   120,   122,   124,   126,   128,   130,   134,   137,   141,
     144,   149
};
...
{
      22,     0,    -1,    -1,    24,    -1,    25,    -1,    25,    24,
      -1,    23,    -1,    23,    24,    -1,    41,    -1,    41,    34,
      -1,    24,    27,    -1,    27,    -1,    30,    -1,    -1,    30,
      26,    28,    -1,    29,    28,    -1,    29,    -1,    28,    30,
      -1,    30,    -1,     3,    -1,     3,    34,    -1,    32,    -1,
      39,    -1,    31,    32,    -1,    32,    -1,    33,    -1,    35,
      -1,     6,    41,    -1,     6,    41,    34,    -1,    41,    -1,
      34,    41,    -1,    -1,     7,    36,    37,    38,    -1,    37,
       6,    -1,     6,    -1,    38,    41,    -1,    41,    -1,    -1,
       4,    40,    31,     5,    -1,     4,     5,    -1,    42,    -1,
      47,    -1,    46,    -1,    48,    -1,    49,    -1,    43,    -1,
      10,    -1,    44,    -1,    45,    -1,     9,    -1,     8,    -1,
      12,    -1,    11,    -1,    13,    -1,    15,    -1,    14,    -1,
      17,    34,    18,    -1,    17,    18,    -1,    19,    50,    20,
      -1,    19,    20,    -1,    50,    43,    16,    41,    -1,    43,
      16,    41,    -1
};
...
static const yytype_uint16 yyrline[] =
{
     ...
     180,   219,   220,   225,   226,   230,   231,   235,   243,   292,
     298,   309,   308,   337,   348,   362,   370,   382,   381,   391,
     396,   397,   398,   399,   400,   404,   405,   412,   413,   417,
     421,   428,   432,   439,   492,   496,   503,   507,   514,   518,
     525,   542
};
#endif
...
#line 86 "cif2_grammar.y"
    {
            if( isset_fix_errors( cif_cc ) ||
                isset_fix_data_header( cif_cc ) ) {
                    print_message( cif_cc, "WARNING", "stray CIF values at the "
                                   ...
                                   typed_value_line( (yyvsp[(1) - (1)].typed_value) ), -1, px );
            } else {
            ...
            delete_typed_value( (yyvsp[(1) - (1)].typed_value) );
        }
    break;
...
#line 101 "cif2_grammar.y"
    {
            if( isset_fix_errors( cif_cc ) ||
                isset_fix_data_header( cif_cc ) ) {
                    print_message( cif_cc, "WARNING", "stray CIF values at the "
                                   "beginning of the input file", "",
                                   typed_value_line( (yyvsp[(1) - (2)].typed_value) ), -1, px );
            } else {
                    print_message( cif_cc, "ERROR", "stray CIF values at the "
                                   "beginning of the input file", "",
                                   typed_value_line( (yyvsp[(1) - (2)].typed_value) ), -1, px );
            ...
            delete_typed_value( (yyvsp[(1) - (2)].typed_value) );
            delete_typed_value( (yyvsp[(2) - (2)].typed_value) );
        }
    break;
...
#line 176 "cif2_grammar.y"
    {
            cif_start_datablock( cif_compiler_cif( cif_cc ), (yyvsp[(1) - (1)].s), px );
            freex( (yyvsp[(1) - (1)].s) );
        }
    break;
...
#line 181 "cif2_grammar.y"
    {
            CIFLIST *list = value_list( typed_value_value( (yyvsp[(2) - (2)].typed_value) ) );
            ...
            if( (isset_fix_errors( cif_cc ) ||
                ...
                char buf[strlen((yyvsp[(1) - (2)].s))+strlen(data_list)+2];
                strcpy( buf, (yyvsp[(1) - (2)].s) );
                buf[strlen((yyvsp[(1) - (2)].s))] = '_';
                buf[strlen((yyvsp[(1) - (2)].s))+1] = '\0';
                strcat( buf, data_list );
                buf[strlen((yyvsp[(1) - (2)].s))+strlen(data_list)+1] = '\0';
                ...
                if( isset_fix_errors( cif_cc ) ||
                    ...
                    yywarning_token( cif_cc, "the dataname apparently had spaces "
                                     ...
                                     typed_value_line( (yyvsp[(2) - (2)].typed_value) ), -1, px );
                }
            } else {
                cif_start_datablock( cif_compiler_cif( cif_cc ), (yyvsp[(1) - (2)].s), px );
                yyerror_token( cif_cc, "incorrect CIF syntax",
                               typed_value_line( (yyvsp[(2) - (2)].typed_value) ),
                               typed_value_pos( (yyvsp[(2) - (2)].typed_value) ) + 1,
                               typed_value_content( (yyvsp[(2) - (2)].typed_value) ), px );
            }
            freex( (yyvsp[(1) - (2)].s) );
            delete_typed_value( (yyvsp[(2) - (2)].typed_value) );
        }
...
/* Line 1806 of yacc.c  */
#line 236 "cif2_grammar.y"
    {
            assert_datablock_exists( cif_cc, px );
            add_tag_value( cif_cc, (yyvsp[(1) - (2)].s), (yyvsp[(2) - (2)].typed_value), px );
            freex( (yyvsp[(1) - (2)].s) );
            typed_value_detach_value( (yyvsp[(2) - (2)].typed_value) ); // protecting v from free()ing
            delete_typed_value( (yyvsp[(2) - (2)].typed_value) );
        }
    break;
...
/* Line 1806 of yacc.c  */
#line 244 "cif2_grammar.y"
    {
                assert_datablock_exists( cif_cc, px );
                CIFLIST *list = value_list( typed_value_value( (yyvsp[(3) - (3)].typed_value) ) );
                list_unshift( list, typed_value_value( (yyvsp[(2) - (3)].typed_value) ), px );
                typed_value_detach_value( (yyvsp[(2) - (3)].typed_value) );
                ...
                if( list_contains_list_or_table( list ) ) {
                    yyerror_token( cif_cc, "incorrect CIF syntax",
                                   typed_value_line( (yyvsp[(2) - (3)].typed_value) ),
                                   typed_value_pos( (yyvsp[(2) - (3)].typed_value) ) + 1,
                                   typed_value_content( (yyvsp[(2) - (3)].typed_value) ), px );
                } else if( isset_fix_errors( cif_cc ) ||
                            isset_fix_string_quotes( cif_cc ) ) {
                    yywarning_token( cif_cc, "string with spaces without quotes -- fixed",
                                     typed_value_line( (yyvsp[(2) - (3)].typed_value) ), -1, px );
                    ...
                    typed_value *tv = new_typed_value( typed_value_line( (yyvsp[(3) - (3)].typed_value) ),
                                                        typed_value_pos( (yyvsp[(3) - (3)].typed_value) ),
                                                        typed_value_content( (yyvsp[(3) - (3)].typed_value) ),
                                                        new_value_from_scalar( buf, tag_type, px ) );
                    add_tag_value( cif_cc, (yyvsp[(1) - (3)].s), tv, px );
                    typed_value_detach_value( tv ); // preventing v from free()'ing
                    delete_typed_value( tv );
                    typed_value_detach_content( (yyvsp[(3) - (3)].typed_value) ); // preventing from free()ing
                    typed_value_detach_value( (yyvsp[(3) - (3)].typed_value) );   // repeatedly
                } else {
                    yyerror_token( cif_cc, "incorrect CIF syntax",
                                   typed_value_line( (yyvsp[(3) - (3)].typed_value) ),
                                   typed_value_pos( (yyvsp[(3) - (3)].typed_value) ) + 1,
                                   typed_value_content( (yyvsp[(3) - (3)].typed_value) ), px );
                }
                freex( (yyvsp[(1) - (3)].s) );
                delete_typed_value( (yyvsp[(2) - (3)].typed_value) );
                delete_typed_value( (yyvsp[(3) - (3)].typed_value) );
            }
    break;
...
/* Line 1806 of yacc.c  */
#line 293 "cif2_grammar.y"
    {
            CIFLIST *list = new_list( px );
            list_push( list, typed_value_value( (yyvsp[(1) - (1)].typed_value) ), px );
            typed_value_set_value( (yyvsp[(1) - (1)].typed_value), new_value_from_list( list, px ) );
        }
    break;
...
/* Line 1806 of yacc.c  */
#line 299 "cif2_grammar.y"
    {
            list_push( value_list( typed_value_value( (yyvsp[(1) - (2)].typed_value) ) ),
                       typed_value_value( (yyvsp[(2) - (2)].typed_value) ), px );
            typed_value_detach_value( (yyvsp[(2) - (2)].typed_value) ); /* protecting v from free'ing */
            delete_typed_value( (yyvsp[(2) - (2)].typed_value) );
        }
    break;
...
/* Line 1806 of yacc.c  */
#line 338 "cif2_grammar.y"
    {
            size_t tag_nr = cif_tag_index( cif_compiler_cif( cif_cc ), (yyvsp[(2) - (2)].s) );
            if( tag_nr != -1 ) {
                yyerror_token( cif_cc, cxprintf( "tag %s appears more than once", (yyvsp[(2) - (2)].s) ),
                               cif2_flex_current_line_number(), -1, NULL, px );
            }
            cif_compiler_increase_loop_tags( cif_cc );
            cif_insert_cifvalue( cif_compiler_cif( cif_cc ), (yyvsp[(2) - (2)].s), NULL, px );
            freex( (yyvsp[(2) - (2)].s) );
        }
    break;
...
/* Line 1806 of yacc.c  */
#line 349 "cif2_grammar.y"
    {
            size_t tag_nr = cif_tag_index( cif_compiler_cif( cif_cc ), (yyvsp[(1) - (1)].s) );
            if( tag_nr != -1 ) {
                yyerror_token( cif_cc, cxprintf( "tag %s appears more than once", (yyvsp[(1) - (1)].s) ),
                               cif2_flex_current_line_number(), -1, NULL, px );
            }
            cif_compiler_increase_loop_tags( cif_cc );
            cif_insert_cifvalue( cif_compiler_cif( cif_cc ), (yyvsp[(1) - (1)].s), NULL, px );
            freex( (yyvsp[(1) - (1)].s) );
        }
    break;
...
/* Line 1806 of yacc.c  */
#line 371 "cif2_grammar.y"
    {
            cif_compiler_increase_loop_values( cif_cc );
            cif_push_loop_cifvalue( cif_compiler_cif( cif_cc ),
                                    typed_value_value( (yyvsp[(1) - (1)].typed_value) ), px );
            typed_value_detach_value( (yyvsp[(1) - (1)].typed_value) ); /* protecting v from free'ing */
            delete_typed_value( (yyvsp[(1) - (1)].typed_value) );
        }
    break;
...
/* Line 1806 of yacc.c  */
#line 382 "cif2_grammar.y"
    {
            cif_start_save_frame( cif_compiler_cif( cif_cc ), /* name = */ (yyvsp[(1) - (1)].s), px );
            freex( (yyvsp[(1) - (1)].s) );
        }
    break;
...
/* Line 1806 of yacc.c  */
#line 406 "cif2_grammar.y"
    {
            (yyval.typed_value) = typed_value_from_value( new_value_from_scalar( (yyvsp[(1) - (1)].s), CIF_UQSTRING, px ), px );
        }
    break;
...
/* Line 1806 of yacc.c  */
#line 418 "cif2_grammar.y"
    {
            (yyval.typed_value) = typed_value_from_value( new_value_from_scalar( (yyvsp[(1) - (1)].s), CIF_SQSTRING, px ), px );
        }
    break;
...
/* Line 1806 of yacc.c  */
#line 422 "cif2_grammar.y"
    {
            (yyval.typed_value) = typed_value_from_value( new_value_from_scalar( (yyvsp[(1) - (1)].s), CIF_DQSTRING, px ), px );
        }
    break;
...
/* Line 1806 of yacc.c  */
#line 429 "cif2_grammar.y"
    {
            (yyval.typed_value) = typed_value_from_value( new_value_from_scalar( (yyvsp[(1) - (1)].s), CIF_SQ3STRING, px ), px );
        }
    break;
...
/* Line 1806 of yacc.c  */
#line 433 "cif2_grammar.y"
    {
            (yyval.typed_value) = typed_value_from_value( new_value_from_scalar( (yyvsp[(1) - (1)].s), CIF_DQ3STRING, px ), px );
        }
    break;
...
/* Line 1806 of yacc.c  */
#line 440 "cif2_grammar.y"
    {
          char *text = (yyvsp[(1) - (1)].s);
...
/* Line 1806 of yacc.c  */
#line 493 "cif2_grammar.y"
    {
            (yyval.typed_value) = typed_value_from_value( new_value_from_scalar( (yyvsp[(1) - (1)].s), CIF_FLOAT, px ), px );
        }
    break;
...
/* Line 1806 of yacc.c  */
#line 497 "cif2_grammar.y"
    {
            (yyval.typed_value) = typed_value_from_value( new_value_from_scalar( (yyvsp[(1) - (1)].s), CIF_INT, px ), px );
        }
    break;
...
/* Line 1806 of yacc.c  */
#line 504 "cif2_grammar.y"
    {
        (yyval.typed_value) = (yyvsp[(2) - (3)].typed_value);
    }
    break;
...
/* Line 1806 of yacc.c  */
#line 527 "cif2_grammar.y"
    {
        if( table_get( value_table( typed_value_value( (yyvsp[(1) - (4)].typed_value) ) ),
                       value_scalar( typed_value_value( (yyvsp[(2) - (4)].typed_value) ) ) ) != NULL ) {
            yyerror_token( cif_cc, cxprintf( "key '%s' appears more than once "
                                     "in the same table",
                                      value_scalar( typed_value_value( (yyvsp[(2) - (4)].typed_value) ) ) ),
                           typed_value_line( (yyvsp[(2) - (4)].typed_value) ), -1, NULL, px );
        }
        table_add( value_table( typed_value_value( (yyvsp[(1) - (4)].typed_value) ) ),
                   value_scalar( typed_value_value( (yyvsp[(2) - (4)].typed_value) ) ),
                   typed_value_value( (yyvsp[(4) - (4)].typed_value) ), px );
        typed_value_detach_value( (yyvsp[(4) - (4)].typed_value) ); // protecting from free()ing
        delete_typed_value( (yyvsp[(2) - (4)].typed_value) );
        delete_typed_value( (yyvsp[(4) - (4)].typed_value) );
    }
    break;
...
/* Line 1806 of yacc.c  */
#line 543 "cif2_grammar.y"
    {
        (yyval.typed_value) = new_typed_value( typed_value_line( (yyvsp[(1) - (3)].typed_value) ), typed_value_pos( (yyvsp[(1) - (3)].typed_value) ),
                              strdupx( typed_value_content( (yyvsp[(1) - (3)].typed_value) ), px ),
        ...
        table_add( value_table( typed_value_value( (yyval.typed_value) ) ),
                   value_scalar( typed_value_value( (yyvsp[(1) - (3)].typed_value) ) ),
                   typed_value_value( (yyvsp[(3) - (3)].typed_value) ), px );
        typed_value_detach_value( (yyvsp[(3) - (3)].typed_value) ); // protecting from free()ing
        delete_typed_value( (yyvsp[(1) - (3)].typed_value) );
        delete_typed_value( (yyvsp[(3) - (3)].typed_value) );
    }
    break;
