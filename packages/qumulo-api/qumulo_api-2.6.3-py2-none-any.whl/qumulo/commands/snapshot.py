...
#
#     DESCRIPTION = "Get the approximate amount of space for each snapshot " \
#                   "that would be reclaimed if that snapshot were deleted."
#
#     @staticmethod
#     def options(parser):
#         parser.add_argument("-i", "--id", type=int, required=False,
#             help="If set, will return capacity usage of the snapshot with " \
#             "the specified id. If omitted, will return capcity usage of " \
#             "all snapshots.")
#
#     @staticmethod
#     def main(conninfo, credentials, args):
