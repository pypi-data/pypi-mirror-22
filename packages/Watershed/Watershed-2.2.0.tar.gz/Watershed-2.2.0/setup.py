...
setup(name='Watershed',
      ...
      url='https://engineering.purdue.edu/kak/distWatershed/Watershed-2.2.0.html',
      download_url='https://engineering.purdue.edu/kak/distWatershed/Watershed-2.2.0.tar.gz',
