...
class Reflector(object):
    ...
    def __init__(self, model):
        try:
            ...
            list_authorized = [value for key, value in self.__class__.__dict__.items()
                               if key[:9] == "REFLECTOR"]
    ...
    def convert_letter(self, letter_in):
...
#     rotor3 = Reflector(Reflector.REFLECTOR_A)
#     rotor2 = Reflector(Reflector.REFLECTOR_A)
#     rotor1 = Reflector(Reflector.REFLECTOR_A)
