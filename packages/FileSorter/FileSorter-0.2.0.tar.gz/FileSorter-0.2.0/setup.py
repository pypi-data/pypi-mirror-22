...
setup(
    ...
    description='A Python file sorter by common data types',
    long_description=long_description,

    # The project's main homepage.
    url='https://github.com/migetman9/file_sort',
    ...
    data_files=[('file_sort_data', ['data/extensions.json'])],
