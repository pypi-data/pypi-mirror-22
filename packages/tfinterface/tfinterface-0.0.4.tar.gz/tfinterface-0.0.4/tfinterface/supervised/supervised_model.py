...
* `update : Tensor` -
    ...
    def get_all_summaries(self):
        ...
        if summaries:
            return self.merge([standard, summaries])
        else:
            return standard


    def get_standard_summaries(self):
        return tf.summary.merge([tf.summary.scalar("loss_summary", self.loss), tf.summary.scalar("score_summary", self.score_tensor)])
...
#         self.update = self._optimizer(learning_rate).minimize(self.loss, global_step=self.inputs.global_step)
#
#
...
#     if not hasattr(self, "loss_summary"):
#         self.loss_summary = tf.summary.scalar("loss_summary", self.loss)
#
#     if not hasattr(self, "score_summary"):
#         self.score_summary = tf.summary.scalar("score_summary", self.score_tensor)
#
#
#     summaries = tf.summary.merge([self.loss_summary, self.score_summary])
#
#     if not hasattr(self, "summaries"):
#         self.summaries = summaries
#     else:
#         self.summaries = tf.summary.merge([self.summaries, summaries])
