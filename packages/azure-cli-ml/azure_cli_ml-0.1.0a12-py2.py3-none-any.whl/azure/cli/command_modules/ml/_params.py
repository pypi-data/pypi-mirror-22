...
register_cli_argument('ml service create realtime', 'target_runtime', options_list=('-r',), default='spark-py',
                      help='Runtime of the web service. Valid runtimes are {}'.format('|'.join(Constants.supported_runtimes)), required=False)
...
register_cli_argument('ml service create realtime', 'num_replicas', options_list=('-z',), type=int,
                      default=1, required=False, help='Number of replicas for a Kubernetes service.')
register_cli_argument('ml service scale realtime', 'num_replicas', options_list=('-z',), type=int,
