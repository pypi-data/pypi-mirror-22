...
short_description = 'GNU Embedded ABI on ARM Linux'

# android-src-vendor ?
# android-headers ?
mandatory_binaries = {
    'arm-linux-gnu-ld': 'gcc-arm-none-eabi',
    }
...
languages = {
    'C' : {'arm-linux-gnu-gcc': 'gcc-arm-none-eabi'},
    'C++' : {'arm-linux-gnu-g++': 'gcc-arm-none-eabi'}
    }
...
def prepare(prefix):
    ...
    try:
        ...
        return False
    gcc_libs = subprocess.check_output(['arm-linux-gnu-gcc', '-print-file-name='], universal_newlines=True)
