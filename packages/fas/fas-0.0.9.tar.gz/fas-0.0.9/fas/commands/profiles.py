...
class Profiles(Command):
    ...
    def create(self, name, username=None, password=None, token=None, host=None, port=None,
               protocol=None, certificate=None, update_if_exist=False):
        ...
        if len(self._config.faaspot.profiles) == 1:
