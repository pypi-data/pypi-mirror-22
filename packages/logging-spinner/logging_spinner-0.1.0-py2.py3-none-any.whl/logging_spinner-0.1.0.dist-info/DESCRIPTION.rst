...
.. image:: https://raw.githubusercontent.com/dahlia/logging-spinner/0.1.0/sample.gif
   :alt: Demo session
...
See also `sample.py <https://raw.githubusercontent.com/dahlia/logging-spinner/0.1.0/sample.py>`_ code.
