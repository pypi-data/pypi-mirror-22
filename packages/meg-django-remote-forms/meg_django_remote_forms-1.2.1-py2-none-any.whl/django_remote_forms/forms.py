...
class RemoteForm(object):
    ...
    def as_dict(self):
        ...
        initial_data = {}
        custom_module_dotted_path = getattr(settings, 'REMOTE_FORMS_FIELDS', None)
