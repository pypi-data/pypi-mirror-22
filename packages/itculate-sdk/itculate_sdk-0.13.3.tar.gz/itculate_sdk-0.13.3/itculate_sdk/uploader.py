...
class Payload(object):
    """
    A payload represents the data within a single upload to the ITculate Rest API (or agent).
    ...
    For other types of data (like timeseries, dictionary, ...), we can join all in a single Rest API POST (a
    single 'global' payload).
