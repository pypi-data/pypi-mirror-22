...
class Thermostat(EcobeeObject):
   ...
   """
    __slots__ = ['_identifier', '_name', '_thermostat_rev', '_is_registered', '_model_number', '_brand', '_features',
                 '_last_modified', '_thermostat_time', '_utc_time', '_alerts', '_reminders', '_settings', '_runtime',
                 '_extended_runtime', '_electricity', '_devices', '_location', '_technician', '_utility', '_management',
                 '_weather', '_events', '_program', '_house_details', '_oem_cfg', '_equipment_status',
                 '_notification_settings', '_privacy', '_version', '_security_settings', '_remote_sensors']
    ...
    attribute_name_map = {'identifier': 'identifier', 'name': 'name', 'thermostat_rev': 'thermostatRev',
                          ...
                          'alerts': 'alerts', 'reminders': 'reminders', 'settings': 'settings', 'runtime': 'runtime',
                          ...
                          'weather': 'weather', 'events': 'events', 'program': 'program',
    ...
    attribute_type_map = {'identifier': 'six.text_type', 'name': 'six.text_type', 'thermostat_rev': 'six.text_type',
                          ...
                          'thermostat_time': 'six.text_type', 'utc_time': 'six.text_type', 'alerts': 'List[Alert]',
                          'reminders': 'List[ThermostatReminder2]', 'settings': 'Settings', 'runtime': 'Runtime',
                          'extended_runtime': 'ExtendedRuntime', 'electricity': 'Electricity',
                          'devices': 'List[Device]', 'location': 'Location', 'technician': 'Technician',
                          'utility': 'Utility', 'management': 'Management', 'weather': 'Weather',
                          'events': 'List[Event]', 'program': 'Program', 'house_details': 'HouseDetails',
                          'oem_cfg': 'ThermostatOemCfg', 'equipment_status': 'six.text_type',
                          'notification_settings': 'NotificationSettings', 'privacy': 'ThermostatPrivacy',
                          'version': 'Version', 'security_settings': 'SecuritySettings',
                          'remote_sensors': 'List[RemoteSensor]'}

    def __init__(self, identifier=None, name=None, thermostat_rev=None, is_registered=None, model_number=None,
                 brand=None, features=None, last_modified=None, thermostat_time=None, utc_time=None, alerts=None,
                 reminders=None, settings=None, runtime=None, extended_runtime=None, electricity=None, devices=None,
                 location=None, technician=None, utility=None, management=None, weather=None, events=None, program=None,
                 house_details=None, oem_cfg=None, equipment_status=None, notification_settings=None, privacy=None,
                 version=None, security_settings=None, remote_sensors=None):
        """
