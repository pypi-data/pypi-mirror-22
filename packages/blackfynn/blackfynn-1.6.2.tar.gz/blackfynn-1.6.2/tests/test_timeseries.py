...
def test_timeseries_annotations(client, timeseries):
    ...
    # Add another layer
    layer2 = timeseries.insert_layer(name="test_layer2", description="test_description2")
    ...
    annot2 = TimeSeriesAnnotation(label = 'test_label2', channel_ids = channel_ids,start = timeseries.channels[0].start+1*1e6,end=timeseries.channels[0].start+2*1e6)
    layer1.add_annotations(annot2)
