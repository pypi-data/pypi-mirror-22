...
from .account_manager_client import AccountManagerServices
...
def get_token_info(token):
    ...
    if not token_info:
        ...
        account_manager_client = AccountManagerServices()
...
class AMOAuth2TokenInfo(object):
    ...
    @cached_property
    def user(self):
        if self._token_info['username'] is None:
            return None
    ...
    @property
    def is_service(self):
        return self._token_info['service']

    @property
    def is_active(self):
        return self._token_info['active']
