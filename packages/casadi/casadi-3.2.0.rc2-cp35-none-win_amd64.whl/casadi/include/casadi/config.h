...
#define CASADI_VERSION_STRING "3.2.0-rc2"
#define CASADI_GIT_REVISION "d865caa562ae54c5829e9637fba61873e427a8dc"  // NOLINT(whitespace/line_length)
#define CASADI_GIT_DESCRIBE "3.2.0-rc1-2.d865caa56"  // NOLINT(whitespace/line_length)
