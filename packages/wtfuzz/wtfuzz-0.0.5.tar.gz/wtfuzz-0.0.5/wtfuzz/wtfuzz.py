...
class Fuzzer(object):
    ...
    def _load_tests(self):
        ...
        if self.args.f:
            ...
            for root, dirs, filenames in os.walk('{}/wtfuzz'.format(self.path)):
                print(filenames)
                break
                for filename in filenames:
                    print('{}/assets/lists/{}'.format(self.path, filename))
                    self.tests.extend([line.strip() for line in open('{}/assets/lists/{}'.format(self.path, filename), 'r')])
