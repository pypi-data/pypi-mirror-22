...
class Configuration(object):
    ...
    def __init__(self):
        ...
        self.oauth2_url = "https://localhost/api/v1"
        # Default api client
        ...
        # Logging Settings
        self.logger = {}
        self.logger["package_logger"] = logging.getLogger("ddots_client")
    ...
    def get_oauth2_token(self, client_id, client_secret):
            """
            Gets OAuth2 token client_credentials grant
            """
            self.oauth = {
    ...
    def refresh_oauth2_token(self):
        """
        Refreshes oauth2 token with refresh_token
        """
        self._fetch_token()

    def _fetch_token(self):
        """
        Fetch OAuth2 token using the credentials from class variables
        """
        token = self.oauth['session'].fetch_token(
