...
class BaseProblem(object):
    ...
    def __init__(self, id=None, title=None):
        """
        BaseProblem - a model defined in Swagger
    ...
    def id(self):
        """
        Gets the id of this BaseProblem.

        :return: The id of this BaseProblem.
        :rtype: int
        """
        return self._id
    ...
    def id(self, id):
        """
        Sets the id of this BaseProblem.

        :param id: The id of this BaseProblem.
        :type: int
        """
    ...
    def title(self):
        """
        Gets the title of this BaseProblem.

        :return: The title of this BaseProblem.
        :rtype: str
        """
        return self._title
    ...
    def title(self, title):
        """
        Sets the title of this BaseProblem.

        :param title: The title of this BaseProblem.
        :type: str
        """
        if title is None:
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, BaseProblem):
            return False
