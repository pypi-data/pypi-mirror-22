...
class DetailedTeamMembers(object):
    """
    NOTE: This class is auto generated by the swagger code generator program.
    Do not edit the class manually.
    """
    def __init__(self, is_leader=None, user=None):
        """
        DetailedTeamMembers - a model defined in Swagger
    ...
    def is_leader(self):
        """
        Gets the is_leader of this DetailedTeamMembers.

        :return: The is_leader of this DetailedTeamMembers.
        :rtype: bool
        """
    ...
    def is_leader(self, is_leader):
        """
        Sets the is_leader of this DetailedTeamMembers.

        :param is_leader: The is_leader of this DetailedTeamMembers.
        :type: bool
        """
    ...
    def user(self):
        """
        Gets the user of this DetailedTeamMembers.

        :return: The user of this DetailedTeamMembers.
    ...
    def user(self, user):
        """
        Sets the user of this DetailedTeamMembers.

        :param user: The user of this DetailedTeamMembers.
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, DetailedTeamMembers):
            return False
