...
class Body4(object):
    ...
    def op(self):
        """
        Gets the op of this Body4.

        :return: The op of this Body4.
        :rtype: str
        """
        return self._op
    ...
    def op(self, op):
        """
        Sets the op of this Body4.

        :param op: The op of this Body4.
        :type: str
        """
        allowed_values = ["test", "add", "remove", "replace"]
    ...
    def path(self):
        """
        Gets the path of this Body4.

        :return: The path of this Body4.
        :rtype: str
        """
        return self._path
    ...
    def path(self, path):
        """
        Sets the path of this Body4.

        :param path: The path of this Body4.
        :type: str
        """
        allowed_values = ["/current_password", "/first_name", "/middle_name", "/last_name", "/password", "/email", "/is_active", "/is_regular_user", "/is_admin"]
    ...
    def value(self):
        """
        Gets the value of this Body4.

        :return: The value of this Body4.
        :rtype: str
        """
        return self._value
    ...
    def value(self, value):
        ...
        :param value: The value of this Body4.
        :type: str
        """
