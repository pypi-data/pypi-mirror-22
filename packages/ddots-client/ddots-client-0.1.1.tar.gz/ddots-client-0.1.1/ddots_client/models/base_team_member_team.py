...
class BaseTeamMemberTeam(object):
    """
    ...
    def __init__(self, id=None, title=None):
        """
        BaseTeamMemberTeam - a model defined in Swagger
    ...
    def id(self):
        """
        Gets the id of this BaseTeamMemberTeam.

        :return: The id of this BaseTeamMemberTeam.
        :rtype: int
        """
        return self._id
    ...
    def id(self, id):
        """
        Sets the id of this BaseTeamMemberTeam.

        :param id: The id of this BaseTeamMemberTeam.
        :type: int
        """
    ...
    def title(self):
        """
        Gets the title of this BaseTeamMemberTeam.

        :return: The title of this BaseTeamMemberTeam.
        :rtype: str
        """
        return self._title
    ...
    def title(self, title):
        """
        Sets the title of this BaseTeamMemberTeam.

        :param title: The title of this BaseTeamMemberTeam.
        :type: str
        """
        if title is None:
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, BaseTeamMemberTeam):
            return False
