...
class HTTPError404(object):
    ...
    def __init__(self, message=None, status=404):
        """
        HTTPError404 - a model defined in Swagger
    ...
    def message(self):
        """
        Gets the message of this HTTPError404.

        :return: The message of this HTTPError404.
        :rtype: str
        """
    ...
    def message(self, message):
        """
        Sets the message of this HTTPError404.

        :param message: The message of this HTTPError404.
        :type: str
        """
    ...
    def status(self):
        """
        Gets the status of this HTTPError404.

        :return: The status of this HTTPError404.
        :rtype: int
        """
        return self._status
    ...
    def status(self, status):
        """
        Sets the status of this HTTPError404.

        :param status: The status of this HTTPError404.
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, HTTPError404):
            return False
