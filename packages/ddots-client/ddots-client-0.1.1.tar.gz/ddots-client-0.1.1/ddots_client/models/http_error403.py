...
class HTTPError403(object):
    ...
    def __init__(self, message=None, status=403):
        """
        HTTPError403 - a model defined in Swagger
    ...
    def message(self):
        """
        Gets the message of this HTTPError403.

        :return: The message of this HTTPError403.
        :rtype: str
        """
    ...
    def message(self, message):
        """
        Sets the message of this HTTPError403.

        :param message: The message of this HTTPError403.
        :type: str
        """
    ...
    def status(self):
        """
        Gets the status of this HTTPError403.

        :return: The status of this HTTPError403.
        :rtype: int
        """
        return self._status
    ...
    def status(self, status):
        """
        Sets the status of this HTTPError403.

        :param status: The status of this HTTPError403.
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, HTTPError403):
            return False
