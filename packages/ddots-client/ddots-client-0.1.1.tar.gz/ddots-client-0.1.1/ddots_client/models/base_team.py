...
class BaseTeam(object):
    ...
    def __init__(self, id=None, title=None):
        """
        BaseTeam - a model defined in Swagger
    ...
    def id(self):
        """
        Gets the id of this BaseTeam.

        :return: The id of this BaseTeam.
        :rtype: int
        """
        return self._id
    ...
    def id(self, id):
        """
        Sets the id of this BaseTeam.

        :param id: The id of this BaseTeam.
        :type: int
        """
    ...
    def title(self):
        """
        Gets the title of this BaseTeam.

        :return: The title of this BaseTeam.
        :rtype: str
        """
        return self._title
    ...
    def title(self, title):
        """
        Sets the title of this BaseTeam.

        :param title: The title of this BaseTeam.
        :type: str
        """
        if title is None:
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, BaseTeam):
            return False
