...
class HTTPError422(object):
    ...
    def __init__(self, message=None, status=422):
        """
        HTTPError422 - a model defined in Swagger
    ...
    def message(self):
        """
        Gets the message of this HTTPError422.

        :return: The message of this HTTPError422.
        :rtype: str
        """
    ...
    def message(self, message):
        """
        Sets the message of this HTTPError422.

        :param message: The message of this HTTPError422.
        :type: str
        """
    ...
    def status(self):
        """
        Gets the status of this HTTPError422.

        :return: The status of this HTTPError422.
        :rtype: int
        """
        return self._status
    ...
    def status(self, status):
        """
        Sets the status of this HTTPError422.

        :param status: The status of this HTTPError422.
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, HTTPError422):
            return False
