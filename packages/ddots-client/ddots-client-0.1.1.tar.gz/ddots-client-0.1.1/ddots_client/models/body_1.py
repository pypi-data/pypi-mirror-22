...
class Body1(object):
    ...
    def op(self):
        """
        Gets the op of this Body1.

        :return: The op of this Body1.
        :rtype: str
        """
        return self._op
    ...
    def op(self, op):
        """
        Sets the op of this Body1.

        :param op: The op of this Body1.
        :type: str
        """
    ...
    def path(self):
        """
        Gets the path of this Body1.

        :return: The path of this Body1.
        :rtype: str
        """
        return self._path
    ...
    def path(self, path):
        """
        Sets the path of this Body1.

        :param path: The path of this Body1.
        :type: str
        """
        allowed_values = ["/title", "/version", "/compiler_docker_image_name", "/executor_docker_image_name"]
    ...
    def value(self):
        """
        Gets the value of this Body1.

        :return: The value of this Body1.
        :rtype: str
        """
        return self._value
    ...
    def value(self, value):
        ...
        :param value: The value of this Body1.
        :type: str
        """
