...
from ddots_client.models.solution_source_code_schema import SolutionSourceCodeSchema


class TestSolutionSourceCodeSchema(unittest.TestCase):
    """ SolutionSourceCodeSchema unit test stubs """
    ...
    def testSolutionSourceCodeSchema(self):
        """
        Test SolutionSourceCodeSchema
        """
        model = ddots_client.models.solution_source_code_schema.SolutionSourceCodeSchema()
