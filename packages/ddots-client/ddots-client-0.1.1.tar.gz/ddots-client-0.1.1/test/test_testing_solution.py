...
from ddots_client.models.testing_solution import TestingSolution


class TestTestingSolution(unittest.TestCase):
    """ TestingSolution unit test stubs """
    ...
    def testTestingSolution(self):
        """
        Test TestingSolution
        """
        model = ddots_client.models.testing_solution.TestingSolution()
