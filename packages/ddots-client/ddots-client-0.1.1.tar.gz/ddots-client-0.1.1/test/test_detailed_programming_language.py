...
from ddots_client.models.detailed_programming_language import DetailedProgrammingLanguage


class TestDetailedProgrammingLanguage(unittest.TestCase):
    """ DetailedProgrammingLanguage unit test stubs """
    ...
    def testDetailedProgrammingLanguage(self):
        """
        Test DetailedProgrammingLanguage
        """
        model = ddots_client.models.detailed_programming_language.DetailedProgrammingLanguage()
