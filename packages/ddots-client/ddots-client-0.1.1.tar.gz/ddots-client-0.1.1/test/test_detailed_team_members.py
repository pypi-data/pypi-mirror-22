...
from ddots_client.models.detailed_team_members import DetailedTeamMembers


class TestDetailedTeamMembers(unittest.TestCase):
    """ DetailedTeamMembers unit test stubs """
    ...
    def testDetailedTeamMembers(self):
        """
        Test DetailedTeamMembers
        """
        model = ddots_client.models.detailed_team_members.DetailedTeamMembers()
