...
from ddots_client.models.base_solution_problem import BaseSolutionProblem


class TestBaseSolutionProblem(unittest.TestCase):
    """ BaseSolutionProblem unit test stubs """
    ...
    def testBaseSolutionProblem(self):
        """
        Test BaseSolutionProblem
        """
        model = ddots_client.models.base_solution_problem.BaseSolutionProblem()
