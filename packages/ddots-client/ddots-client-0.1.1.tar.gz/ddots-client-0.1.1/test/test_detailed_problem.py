...
from ddots_client.models.detailed_problem import DetailedProblem


class TestDetailedProblem(unittest.TestCase):
    """ DetailedProblem unit test stubs """
    ...
    def testDetailedProblem(self):
        """
        Test DetailedProblem
        """
        model = ddots_client.models.detailed_problem.DetailedProblem()
