...
from ddots_client.models.user_signup_form import UserSignupForm


class TestUserSignupForm(unittest.TestCase):
    """ UserSignupForm unit test stubs """
    ...
    def testUserSignupForm(self):
        """
        Test UserSignupForm
        """
        model = ddots_client.models.user_signup_form.UserSignupForm()
