...
from ddots_client.models.detailed_solution import DetailedSolution


class TestDetailedSolution(unittest.TestCase):
    """ DetailedSolution unit test stubs """
    ...
    def testDetailedSolution(self):
        """
        Test DetailedSolution
        """
        model = ddots_client.models.detailed_solution.DetailedSolution()
