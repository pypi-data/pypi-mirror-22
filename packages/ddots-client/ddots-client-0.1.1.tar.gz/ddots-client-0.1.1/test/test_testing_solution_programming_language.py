...
from ddots_client.models.testing_solution_programming_language import TestingSolutionProgrammingLanguage


class TestTestingSolutionProgrammingLanguage(unittest.TestCase):
    """ TestingSolutionProgrammingLanguage unit test stubs """
    ...
    def testTestingSolutionProgrammingLanguage(self):
        """
        Test TestingSolutionProgrammingLanguage
        """
        model = ddots_client.models.testing_solution_programming_language.TestingSolutionProgrammingLanguage()
