...
from ddots_client.models.detailed_solution_testing_report import DetailedSolutionTestingReport


class TestDetailedSolutionTestingReport(unittest.TestCase):
    """ DetailedSolutionTestingReport unit test stubs """
    ...
    def testDetailedSolutionTestingReport(self):
        """
        Test DetailedSolutionTestingReport
        """
        model = ddots_client.models.detailed_solution_testing_report.DetailedSolutionTestingReport()
