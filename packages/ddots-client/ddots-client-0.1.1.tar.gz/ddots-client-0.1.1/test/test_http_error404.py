...
from ddots_client.models.http_error404 import HTTPError404


class TestHTTPError404(unittest.TestCase):
    """ HTTPError404 unit test stubs """
    ...
    def testHTTPError404(self):
        ...
        Test HTTPError404
        """
        model = ddots_client.models.http_error404.HTTPError404()
