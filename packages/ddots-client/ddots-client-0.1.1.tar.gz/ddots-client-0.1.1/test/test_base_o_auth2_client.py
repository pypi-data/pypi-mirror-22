...
from ddots_client.models.base_o_auth2_client import BaseOAuth2Client


class TestBaseOAuth2Client(unittest.TestCase):
    """ BaseOAuth2Client unit test stubs """
    ...
    def testBaseOAuth2Client(self):
        """
        Test BaseOAuth2Client
        """
        model = ddots_client.models.base_o_auth2_client.BaseOAuth2Client()
