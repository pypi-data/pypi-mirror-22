...
from ddots_client.models.http_error401 import HTTPError401


class TestHTTPError401(unittest.TestCase):
    """ HTTPError401 unit test stubs """
    ...
    def testHTTPError401(self):
        ...
        Test HTTPError401
        """
        model = ddots_client.models.http_error401.HTTPError401()
