...
from ddots_client.models.base_team_member import BaseTeamMember


class TestBaseTeamMember(unittest.TestCase):
    """ BaseTeamMember unit test stubs """
    ...
    def testBaseTeamMember(self):
        """
        Test BaseTeamMember
        """
        model = ddots_client.models.base_team_member.BaseTeamMember()
