...
from ddots_client.models.base_team_member_team import BaseTeamMemberTeam


class TestBaseTeamMemberTeam(unittest.TestCase):
    """ BaseTeamMemberTeam unit test stubs """
    ...
    def testBaseTeamMemberTeam(self):
        """
        Test BaseTeamMemberTeam
        """
        model = ddots_client.models.base_team_member_team.BaseTeamMemberTeam()
