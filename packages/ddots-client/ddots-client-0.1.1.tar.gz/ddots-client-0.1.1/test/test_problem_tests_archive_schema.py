...
from ddots_client.models.problem_tests_archive_schema import ProblemTestsArchiveSchema


class TestProblemTestsArchiveSchema(unittest.TestCase):
    """ ProblemTestsArchiveSchema unit test stubs """
    ...
    def testProblemTestsArchiveSchema(self):
        """
        Test ProblemTestsArchiveSchema
        """
        model = ddots_client.models.problem_tests_archive_schema.ProblemTestsArchiveSchema()
