...
from ddots_client.models.base_solution import BaseSolution


class TestBaseSolution(unittest.TestCase):
    """ BaseSolution unit test stubs """
    ...
    def testBaseSolution(self):
        """
        Test BaseSolution
        """
        model = ddots_client.models.base_solution.BaseSolution()
