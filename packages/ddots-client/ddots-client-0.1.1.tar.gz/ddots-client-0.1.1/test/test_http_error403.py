...
from ddots_client.models.http_error403 import HTTPError403


class TestHTTPError403(unittest.TestCase):
    """ HTTPError403 unit test stubs """
    ...
    def testHTTPError403(self):
        ...
        Test HTTPError403
        """
        model = ddots_client.models.http_error403.HTTPError403()
