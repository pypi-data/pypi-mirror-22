...
from ddots_client.models.base_programming_language import BaseProgrammingLanguage


class TestBaseProgrammingLanguage(unittest.TestCase):
    """ BaseProgrammingLanguage unit test stubs """
    ...
    def testBaseProgrammingLanguage(self):
        """
        Test BaseProgrammingLanguage
        """
        model = ddots_client.models.base_programming_language.BaseProgrammingLanguage()
