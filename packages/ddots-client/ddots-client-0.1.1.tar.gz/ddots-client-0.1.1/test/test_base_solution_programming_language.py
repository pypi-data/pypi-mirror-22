...
from ddots_client.models.base_solution_programming_language import BaseSolutionProgrammingLanguage


class TestBaseSolutionProgrammingLanguage(unittest.TestCase):
    """ BaseSolutionProgrammingLanguage unit test stubs """
    ...
    def testBaseSolutionProgrammingLanguage(self):
        """
        Test BaseSolutionProgrammingLanguage
        """
        model = ddots_client.models.base_solution_programming_language.BaseSolutionProgrammingLanguage()
