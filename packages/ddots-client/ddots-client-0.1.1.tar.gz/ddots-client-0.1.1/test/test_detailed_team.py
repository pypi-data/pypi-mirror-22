...
from ddots_client.models.detailed_team import DetailedTeam


class TestDetailedTeam(unittest.TestCase):
    """ DetailedTeam unit test stubs """
    ...
    def testDetailedTeam(self):
        """
        Test DetailedTeam
        """
        model = ddots_client.models.detailed_team.DetailedTeam()
