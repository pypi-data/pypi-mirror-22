...
from ddots_client.models.base_solution_author import BaseSolutionAuthor


class TestBaseSolutionAuthor(unittest.TestCase):
    """ BaseSolutionAuthor unit test stubs """
    ...
    def testBaseSolutionAuthor(self):
        """
        Test BaseSolutionAuthor
        """
        model = ddots_client.models.base_solution_author.BaseSolutionAuthor()
