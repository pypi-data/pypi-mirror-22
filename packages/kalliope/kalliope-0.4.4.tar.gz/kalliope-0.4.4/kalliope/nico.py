...
if settings.rpi_settings:
    print settings.rpi_settings.pin_mute_button
    print settings.rpi_settings.pin_led_started
    print settings.rpi_settings.pin_led_muted
    print settings.rpi_settings.pin_led_talking
    print settings.rpi_settings.pin_led_listening
