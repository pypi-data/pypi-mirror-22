...
class ClientProtocol(ws_sheets_server.protocol.Protocol):

    def packet_received(self, packet):
        logger.debug('packet received: %', repr(packet))
        packet(self)
...
class BookProtocol(ws_sheets_server.protocol.Protocol):
    """
    ...
    def __init__(self, loop):
        ...
        self.callback_on_write = callbacks.Callbacks()
