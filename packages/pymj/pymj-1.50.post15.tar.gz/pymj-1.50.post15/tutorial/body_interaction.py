...
"""
from pymj import load_model_from_xml, MjSim, MjViewer
import math
...
<mujoco>
    ...
    <worldbody>
        <body name="robot" pos="0 0 1.2">
            ...
            <joint axis="0 1 0" damping="0.1" name="robot:slide1" pos="0 0 0" type="slide"/>
            <joint axis="0 0 1" damping="1" name="robot:slide2" pos="0 0 0" type="slide"/>
        ...
        <body name="cylinder" pos="0.8 0 0.2">
    ...
    <actuator>
        <motor gear="2000.0" joint="robot:slide0"/>
        <motor gear="2000.0" joint="robot:slide1"/>
    </actuator>
</mujoco>
"""
...
t = 0
while True:
    sim.data.ctrl[0] = math.cos(t / 10.) / 100.
    sim.data.ctrl[1] = math.sin(t / 10.) / 100.
    t += 1
    sim.step()
    viewer.render()
