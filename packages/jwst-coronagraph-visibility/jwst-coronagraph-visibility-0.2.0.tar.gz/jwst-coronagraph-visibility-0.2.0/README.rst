...
`Download for Mac (24 MB) <https://github.com/spacetelescope/jwst_coronagraph_visibility/releases/download/v0.2.0/jwst_visibility_calculator_macos.zip>`_ | `Download Python source <https://github.com/spacetelescope/jwst_coronagraph_visibility/archive/v0.2.0.zip>`_
