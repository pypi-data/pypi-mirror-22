...
__copyright__ = "Copyright 2016 - 2017, Northbridge Development Konrad & Schneider GbR"
...
setup(
    ...
    license='MIT License',
    description='Dynamic registration between django apps.',
    long_description=long_description,
    url='http://github.com/NB-Dev/django-appregistration',
