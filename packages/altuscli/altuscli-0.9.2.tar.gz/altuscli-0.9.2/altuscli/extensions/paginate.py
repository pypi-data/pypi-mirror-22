...
from altuscli import model
from altuscli import xform_name
from altuscli.arguments import BaseCLIArgument
...
def unify_paging_params(operation_model, argument_table):
    ...
    argument_table[STARTING_TOKEN_ARG_NAME] = \
        PageArgument(argument_table,
                     STARTING_TOKEN_ARG_NAME,
                     STARTING_TOKEN_HELP,
                     parse_type='string',
                     serialized_name='StartingToken')
    argument_table[PAGE_SIZE_ARG_NAME] = \
        PageArgument(argument_table,
                     PAGE_SIZE_ARG_NAME,
                     PAGE_SIZE_HELP,
                     parse_type='integer',
                     serialized_name='PageSize')
    argument_table[MAX_ITEMS_ARG_NAME] = \
        PageArgument(argument_table,
                     MAX_ITEMS_ARG_NAME,
                     MAX_ITEMS_HELP,
                     parse_type='integer',
