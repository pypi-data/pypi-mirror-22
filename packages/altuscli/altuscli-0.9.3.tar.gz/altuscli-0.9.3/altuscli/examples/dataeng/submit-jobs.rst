...
**3. To submit YARN jobs to a cluster**

- Command::

    altus dataeng submit-jobs --cluster-name cluster-name --jobs name="My YARN Job 1",yarnJob='{mainClass=org.myorg.Main, jars=s3a://path/to/jar.jar}' name="My YARN Job 2",yarnJob='{mainClass=org.myorg.Main, jars=s3a://path/to/jar.jar}'
...
- Required yarnJob fields::

    mainClass, jars

- Optional yarnJob fields::
