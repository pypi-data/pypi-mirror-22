...
and their info:>", end=' ')
    ...
    if re.search(r"delay", content):
        ...
        print("please input your delay time between every two requests:")
        #默认1s间隔
        delaytime = get_input_intime("1", 5)
        update_config_file_key_value(config_file_abs_path, 'default', 'delay', "'" + delaytime + "'")
