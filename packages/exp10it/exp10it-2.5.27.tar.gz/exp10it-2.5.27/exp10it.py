...
def single_risk_scan(target):
    ...
    delay= eval(get_key_value_from_config_file(config_file_abs_path, 'default', 'delay'))
...
and their info:>", end=' ')
    ...
    if re.search(r"forcevpn",content):
        ...
        print("input 0 if you want to make the program works basing on vpn connected(can visit google)\n\
input 1 if you want to make the program works without vpn connected\n\
