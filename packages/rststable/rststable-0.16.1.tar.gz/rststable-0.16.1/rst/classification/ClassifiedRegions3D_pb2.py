...
_CLASSIFIEDREGIONS3D.fields_by_name['regions'].message_type = rst.classification.ClassifiedRegion3D_pb2._CLASSIFIEDREGION3D
DESCRIPTOR.message_types_by_name['ClassifiedRegions3D'] = _CLASSIFIEDREGIONS3D

class ClassifiedRegions3D(_message.Message):
...
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), 'B\027ClassifiedRegions3DType')
