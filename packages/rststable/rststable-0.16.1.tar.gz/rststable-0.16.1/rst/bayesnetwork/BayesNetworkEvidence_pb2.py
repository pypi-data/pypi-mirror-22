...
import rst.bayesnetwork.BayesNetwork_pb2
...
_BAYESNETWORKEVIDENCE.fields_by_name['network'].message_type = rst.bayesnetwork.BayesNetwork_pb2._BAYESNETWORK
_BAYESNETWORKEVIDENCE.fields_by_name['time'].message_type = rst.timing.Timestamp_pb2._TIMESTAMP
...
class BayesNetworkEvidence(_message.Message):
  __metaclass__ = _reflection.GeneratedProtocolMessageType

  class VariableState(_message.Message):
    __metaclass__ = _reflection.GeneratedProtocolMessageType
...
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), 'B\030BayesNetworkEvidenceType')
