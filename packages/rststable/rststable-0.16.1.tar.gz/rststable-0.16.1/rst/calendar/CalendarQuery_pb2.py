...
_CALENDARQUERY.fields_by_name['start_time'].message_type = rst.calendar.DateTime_pb2._DATETIME
_CALENDARQUERY.fields_by_name['end_time'].message_type = rst.calendar.DateTime_pb2._DATETIME
DESCRIPTOR.message_types_by_name['CalendarQuery'] = _CALENDARQUERY

class CalendarQuery(_message.Message):
...
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), 'B\021CalendarQueryType')
