...
import rst.calendar.RecurrenceRule_pb2
...
_RECURRENCE.fields_by_name['recurrence_dates'].message_type = rst.calendar.DateTime_pb2._DATETIME
_RECURRENCE.fields_by_name['recurrence_rules'].message_type = rst.calendar.RecurrenceRule_pb2._RECURRENCERULE
_RECURRENCE.fields_by_name['exclude_dates'].message_type = rst.calendar.DateTime_pb2._DATETIME
_RECURRENCE.fields_by_name['exclude_rules'].message_type = rst.calendar.RecurrenceRule_pb2._RECURRENCERULE
...
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), 'B\016RecurrenceType')
