...
_POSTURE3DFLOATCOLLECTION.fields_by_name['element'].message_type = rst.kinematics.Posture3DFloat_pb2._POSTURE3DFLOAT
DESCRIPTOR.message_types_by_name['Posture3DFloatCollection'] = _POSTURE3DFLOATCOLLECTION

class Posture3DFloatCollection(_message.Message):
...
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), 'B\034Posture3DFloatCollectionType')
