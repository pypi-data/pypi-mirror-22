...
_LOCATEDFACECOLLECTION.fields_by_name['element'].message_type = rst.vision.LocatedFace_pb2._LOCATEDFACE
DESCRIPTOR.message_types_by_name['LocatedFaceCollection'] = _LOCATEDFACECOLLECTION

class LocatedFaceCollection(_message.Message):
...
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), 'B\031LocatedFaceCollectionType')
