...
import rst.dialog.SpeechHypothesis_pb2
...
_SPEECHHYPOTHESES.fields_by_name['best_result'].message_type = rst.dialog.SpeechHypothesis_pb2._SPEECHHYPOTHESIS
_SPEECHHYPOTHESES.fields_by_name['further_results'].message_type = rst.dialog.SpeechHypothesis_pb2._SPEECHHYPOTHESIS
DESCRIPTOR.message_types_by_name['SpeechHypotheses'] = _SPEECHHYPOTHESES

class SpeechHypotheses(_message.Message):
...
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), 'B\024SpeechHypothesesType')
