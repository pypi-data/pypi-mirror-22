...
_STATE.fields_by_name['info'].message_type = rst.tracking.TrackingInfo_pb2._TRACKINGINFO
...
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), 'B\tStateType')
_STATE.fields_by_name['aspect'].has_options = True
_STATE.fields_by_name['aspect']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\020\001')
