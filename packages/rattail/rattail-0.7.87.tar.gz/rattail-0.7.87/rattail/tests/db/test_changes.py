...
class TestChangeRecorder(DataTestCase):
    ...
    def test_record_rattail_change(self):
        ...
        self.assertFalse(recorder.record_rattail_change(self.session, model.Batch()))
        self.assertFalse(recorder.record_rattail_change(self.session, model.BatchColumn()))
        self.assertFalse(recorder.record_rattail_change(self.session, model.BatchRow()))
