...
class CropFaces:
  ...
  def __init__(self, zoom='AUTO', output=None):
    ...
    dirxml = os.path.dirname(__file__)
    self.cascade = cv2.CascadeClassifier(os.path.join(dirxml, "haarcascade_frontalface_alt.xml"))

    #self.cascade = cv2.CascadeClassifier(os.path.join(dirxml, "haarcascade_eye.xml))
    #self.cascade = cv2.CascadeClassifier(os.path.join(dirxml, "haarcascade_frontalface_alt.xml"))
    #self.cascade = cv2.CascadeClassifier(os.path.join(dirxml, "haarcascade_frontalface_alt2.xml"))
    #self.cascade = cv2.CascadeClassifier(os.path.join(dirxml, "haarcascade_frontalface_default.xml"))
    #self.cascade = cv2.CascadeClassifier(os.path.join(dirxml, "haarcascade_profileface.xml"))

    #self.cascade = cv2.CascadeClassifier(os.path.join(dirxml, "haarcascade_upperbody.xml"))

    #####################self.cascade = cv2.CascadeClassifier(os.path.join(dirxml, "haarcascade_frontalface_alt_tree.xml"))

    #self.cascade = cv2.CascadeClassifier(os.path.join(dirxml, "frontalFace10/haarcascade_frontalface_alt_tree.xml"))
    #self.cascade = cv2.CascadeClassifier(os.path.join(dirxml, "frontalFace10/HS.xml"))
    #self.cascade = cv2.CascadeClassifier(os.path.join(dirxml, "frontalFace10/parojosG.xml"))
    #self.cascade = cv2.CascadeClassifier(os.path.join(dirxml, "frontalFace10/parojos.xml"))
    #self.cascade = cv2.CascadeClassifier(os.path.join(dirxml, "frontalFace10/Mouth.xml"))

    #self.cascade = cv2.CascadeClassifier(os.path.join(dirxml, "2haarcascade_frontalface_alt.xml"))
    #self.cascade = cv2.CascadeClassifier(os.path.join(dirxml, "2haarcascade_frontalface_alt2.xml"))
    #self.cascade = cv2.CascadeClassifier(os.path.join(dirxml, "2haarcascade_frontalface_alt_tree.xml"))
    #self.cascade = cv2.CascadeClassifier(os.path.join(dirxml, "2haarcascade_frontalface_default.xml"))
    #self.cascade = cv2.CascadeClassifier(os.path.join(dirxml, "HS.xml"))
    #self.cascade = cv2.CascadeClassifier(os.path.join(dirxml, "parojosG.xml"))


    #self.cascade = cv2.CascadeClassifier(os.path.join(dirxml, "frontalFace10/frontalEyes35x16.xml"))


    #self.cascade = cv2.CascadeClassifier(os.path.join(dirxml, "frontalFace10/ojoD.xml"))
