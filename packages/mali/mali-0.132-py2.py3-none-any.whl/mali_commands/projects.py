...
from .commons import add_to_data_if_not_none, create_validate_length, output_result
...
def list_projects(ctx, outputformat):
    ...
    output_result(ctx, result, ['project_id', 'display_name', 'description', 'token', 'org'])
