...
class TestAuth(BaseTest):
    client_id = 'client_id_' + BaseTest.some_random_shit()
    auth0 = 'auth0_auth_' + BaseTest.some_random_shit()
    access_token = 'access_token_' + BaseTest.some_random_shit()
    refresh_token = 'refresh_token_' + BaseTest.some_random_shit()
    id_token = 'id_token_' + BaseTest.some_random_shit()
    ...
    def test_pixy_flow(self, make_server, webbrowser_open, auth0_oauth_token):
        ...
        redirect_url = 'http://localhost:%s/admin/auth/init' % port
