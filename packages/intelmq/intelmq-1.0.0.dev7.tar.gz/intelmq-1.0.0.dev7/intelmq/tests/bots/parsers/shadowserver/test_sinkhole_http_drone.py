...
EVENTS = [{'__type': 'Event',
           ...
           'destination.port': 80,
           'extra': '{"http_host": "198.51.100.67", "naics": 541690, "sic": 874899, '
                    '"url": "GET /search?q=1349 HTTP/1.0", "user_agent": "Mozilla/4.0 '
          ...
          {'__type': 'Event',
           ...
           'destination.port': 80,
           'extra': '{"naics": 518210, "os.name": "Windows", "os.version": "7 or 8", '
                    '"sic": 737415, "url": '
                    '"\\\\x16\\\\x03\\\\x01\\\\x00z\\\\x01\\\\x00\\\\x00v\\\\x03\\\\x01Y\\\\x10?\\\\x08?;??B???]?|i?H?t??.:?\\\\x07b?????\\\\x00\\\\x00\\\\x1c?\\\\x14?\\\\x13\\\\x009\\\\x003\\\\x005\\\\x00/?"}',
           'feed.name': 'ShadowServer Sinkhole HTTP drone',
