...
setup(
    ...
    description='Pure Python implementation of discrete random variables',
    long_description=long_description,

    # The project's main homepage.
    url='https://gitlab.com/TC01/python-discrete',
    ...
    classifiers=[
		...
		# This probably supports Python 3.
    ...
    keywords='discrete random probability',
