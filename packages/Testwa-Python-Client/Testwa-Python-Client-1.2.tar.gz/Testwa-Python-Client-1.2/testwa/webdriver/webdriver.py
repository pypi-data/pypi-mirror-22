...
class WebDriver(webdriver.Remote):
    ...
    def find_element_by_name(self, name):
        body = {'using': By.ACCESSIBILITY_ID, 'value': id, 'mode': 'byName'}
        return self.execute(SeleniumCommand.FIND_ELEMENT, body)

    def find_elements_by_name(self, name):
        body = {'using': By.ACCESSIBILITY_ID, 'value': id, 'mode': 'byName'}
        return self.execute(SeleniumCommand.FIND_ELEMENTS, body)
