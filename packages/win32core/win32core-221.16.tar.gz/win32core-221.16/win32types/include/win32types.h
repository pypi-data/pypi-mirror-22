...
// don't require a custom built win32types DLL.
#ifdef FREEZE_PYWINTYPES
	/* The win32types module is being included in a frozen .EXE/.DLL */
#	define PYWINTYPES_EXPORT
#else
#	ifdef BUILD_PYWINTYPES
		/* We are building win32typesxx.dll */
#		define PYWINTYPES_EXPORT __declspec(dllexport)
#else
		/* This module uses win32typesxx.dll */
#		define PYWINTYPES_EXPORT __declspec(dllimport)
#		if defined(_MSC_VER)
#			if defined(DEBUG) || defined(_DEBUG)
#				pragma comment(lib,"win32types_d.lib")
#			else
#				pragma comment(lib,"win32types.lib")
#			endif // DEBUG/_DEBUG
#		endif // _MSC_VER
...
// win32types.__future_datatime__, but for now this is defined purely at build
// time.
#if (PY_VERSION_HEX >= 0x03000000)
