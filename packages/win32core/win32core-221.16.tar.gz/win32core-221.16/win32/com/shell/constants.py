...
ICategorizer_Methods = [
    "GetDescription", "GetCategory", "GetCategoryInfo", "CompareCategory"
]
ICategoryProvider_Methods = [
    "CanCategorizeOnSCID", "GetDefaultCategory", "GetCategoryForSCID",
    "EnumCategories", "GetCategoryName", "CreateCategory"
]
IContextMenu_Methods = [
    "QueryContextMenu", "InvokeCommand", "GetCommandString"
]
IExplorerCommand_Methods = [
    "GetTitle", "GetIcon", "GetToolTip", "GetCanonicalName", "GetState",
