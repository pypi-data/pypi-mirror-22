...
%module _win32security // An interface to the win32 security API's
...
%init %{
	...
	*/
    ...
    for (PyMethodDef *pmd = _win32securityMethods;pmd->ml_name;pmd++)
...
BOOL PyWinObject_AsSEC_WINNT_AUTH_IDENTITY(PyObject *obAuthData, PSEC_WINNT_AUTH_IDENTITY_W pAuthData)
{
	...
	// "string or unicode or None" - use win32types which auto-encodes as mbcs.
