...
py_get_clipboard_sequence_number(PyObject *self, PyObject *args)
{
  ...
  if (hmod)
    pfnGetClipboardSequenceNumber = (PFNGetClipboardSequenceNumber)GetProcAddress(hmod, "GetClipboardSequenceNumber");
...
PYWIN_MODULE_INIT_FUNC(_win32clipboard)
{
  PYWIN_MODULE_INIT_PREPARE(_win32clipboard, clipboard_functions,
