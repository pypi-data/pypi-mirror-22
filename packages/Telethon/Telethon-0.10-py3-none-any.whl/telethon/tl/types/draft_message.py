...
class DraftMessage(MTProtoRequest):
    ...
    draftMessage#fd8e711f flags:# no_webpage:flags.1?true reply_to_msg_id:flags.0?int message:string entities:flags.3?Vector<MessageEntity> date:date = DraftMessage"""
    ...
    def __repr__(self):
        return 'draftMessage#fd8e711f flags:# no_webpage:flags.1?true reply_to_msg_id:flags.0?int message:string entities:flags.3?Vector<MessageEntity> date:date = DraftMessage'
