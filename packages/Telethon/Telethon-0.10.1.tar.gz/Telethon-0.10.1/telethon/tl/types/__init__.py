...
from .input_media_uploaded_thumb_document import InputMediaUploadedThumbDocument
...
from .channel_participant_moderator import ChannelParticipantModerator
from .channel_participant_editor import ChannelParticipantEditor
from .channel_participant_kicked import ChannelParticipantKicked
...
from .channel_role_empty import ChannelRoleEmpty
from .channel_role_moderator import ChannelRoleModerator
from .channel_role_editor import ChannelRoleEditor
...
from . import account, contacts, auth, messages, help, channels, storage, phone, photos, updates, upload, payments
