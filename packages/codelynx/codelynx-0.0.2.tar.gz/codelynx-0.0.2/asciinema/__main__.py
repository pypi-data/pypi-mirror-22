...
def rec_command(args, config):
    ...
    print('config config: %s' % config.config.__dict__)
...
def main():
    ...
    parser.add_argument('--version',
                        action='version', version='asciinema %s' % __version__)
    ...
    print('--- after parse ---')
    print(args.func)
    print(inspect.getsource(args.func))
    ...
    if hasattr(args, 'func'):
        ...
        # print('---args---')
        # print('args: %s' % args)
        # print('args func: %s' % args.func.__dict__)
        # for ar in args:
        #     print(ar)
        command = args.func(args, cfg)
        print('command: %s' % command.__dict__)
        print('command api: %s' % command.api.__dict__)
        print('command recorder: %s' % command.recorder.__dict__)
        print( inspect.getsource(command.recorder.pty_recorder))
        print('------------')
