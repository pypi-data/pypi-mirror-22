...
def parser(*args, **kwargs):
    ...
    _parser.add_argument('--use-internal-token',
        dest='use_internal_token',
        action='store_true',
        help=("When present, diax will use the internal token that is stored in the credentials file"),
    )
