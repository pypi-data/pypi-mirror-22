...
def filter_slug_to_tags(collection, filter_chunks):
    ...
    normalized_f_tags = normalize_filter_tags(collection, vendors, prices, filter_tags, get_property_slugs())
...
def normalize_filter_tags(collection, vendors, prices=(None, None), tags=[], cached_value_slugs=[]):
    result = []
