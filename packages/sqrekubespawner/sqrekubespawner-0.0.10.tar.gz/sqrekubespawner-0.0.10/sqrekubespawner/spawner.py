...
from sqrekubespawner.utils import request_maker, k8s_url
from sqrekubespawner.objects import make_pod_spec, make_pvc_spec
from sqrekubespawner.traitlets import Callable
...
class SQREKubeSpawner(Spawner):
    ...
    singleuser_init_containers = List(
        ...
        #container-v1-core.
        which follows spec at https://kubernetes.io/docs/api-reference/v1.6/
        ...
        - name: init-iptables
          ...
          command: ["iptables", "-A", "OUTPUT", "-p", "tcp",
              "--dport", "80", "-d", "169.254.169.254", "-j", "DROP"]
          securityContext:
            capabilities:
              add:
              - NET_ADMIN
