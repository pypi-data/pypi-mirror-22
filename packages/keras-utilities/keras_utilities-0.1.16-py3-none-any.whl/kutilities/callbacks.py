...
class PlottingCallback(Callback):
    def __init__(self, benchmarks=None, grid_ranges=None, width=4, height=4):
        ...
        # todo:make dir if not exits
        models = len(glob.glob(os.path.join(os.getcwd(), 'results', "model*.png")))
        self.plot_fname = os.path.join(os.getcwd(),'results', 'model_{}.png'.format(models + 1))
