...
setup_defaults = {  
   'name'        : 'fc_simesh',
   'description' : 'The fc_simesh package contains the siMesh class which allows to use simplices meshes generated from gmsh (in dimension 2 or 3) or an hypercube triangulation (in any dimension). A particular care was taken to the graphics representations of meshes and datas on meshes',
   'version'     : '0.0.3',
...
setup(name=setup_defaults['name'],
      ...
      install_requires=['fc_tools >= 0.0.8','fc_hypermesh >= 0.0.3','fc_oogmsh >= 0.0.2'],#,'mayavi >= 4.5.0'],
      package_data={
